/**
 * @file GeneralizedModeResult.cxx
 * @brief Implementation de GeneralizedModeResult
...
GeneralizedModeResultPtr ForwardGeneralizedModeResultPtr::getPointer() {
    if ( !_isSet )
        throw std::runtime_error( "No pointer set" );
    return _ptr;
};

bool ForwardGeneralizedModeResultPtr::isSet() const { return _isSet; };

void ForwardGeneralizedModeResultPtr::setPointer( const GeneralizedModeResultPtr &ptr ) {
    _ptr = ptr;
    _isSet = true;
};
