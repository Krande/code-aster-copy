...
void exportResultToPython() {
    ...
    MaterialFieldPtr ( Result::*c1 )() = &Result::getMaterialField;
    MaterialFieldPtr ( Result::*c2 )( int ) = &Result::getMaterialField;

    ModelPtr ( Result::*c3 )()  = &Result::getModel;
    ModelPtr ( Result::*c4 )( int )  = &Result::getModel;

    ElementaryCharacteristicsPtr ( Result::*c5 )()  = &Result::getElementaryCharacteristics;
...
Arguments:
    ...
    rank (int):  rank where to save time value
        ...
        .def( "appendMaterialFieldOnAllRanks", &Result::appendMaterialFieldOnAllRanks, R"(
...
Arguments:
    mater (MaterialField): material field to set.
        ...
        .def( "addMaterialField", &Result::addMaterialField, R"(
...
Arguments:
    ...
    rank (int): rank to set
        ...
        .def( "addListOfLoads", &Result::addListOfLoads, R"(
...
Arguments:
    ...
    rank (int): rank to set
        ...
        .def( "appendModelOnAllRanks", &Result::appendModelOnAllRanks, R"(
...
Arguments:
    model (Model): model to set.
        ...
        .def( "addModel", &Result::addModel, R"(
...
Arguments:
    ...
    rank (int): rank to set
        ...
        .def( "appendElementaryCharacteristicsOnAllRanks",
            &Result::appendElementaryCharacteristicsOnAllRanks, R"(
...
Arguments:
    cara_elem (ElementaryCharacteristics): elementary characterictics to set.
              ...
              ( py::arg( "self" ), py::arg( "mater" ) ) )
        .def( "addElementaryCharacteristics", &Result::addElementaryCharacteristics, R"(
...
Arguments:
    ...
    rank (int): rank to set
        ...
        .def( "listFields", &Result::listFields, R"(
