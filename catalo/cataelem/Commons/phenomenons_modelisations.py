...
phen.add('2D_FLUIDE#1', Modelisation(dim=(2,2), code='2FL',
    attrs=(
        (AT.TYPMOD,'PLAN'),
        (AT.FLUIDE,'OUI'),
...
phen.add('2D_FLUIDE#2', Modelisation(dim=(2,2), code='2FP',
    attrs=(
        (AT.TYPMOD,'PLAN'),
        (AT.FLUIDE,'OUI'),
...
phen.add('2D_FLUI_PESA#1', Modelisation(dim=(2,2), code='2FP',
    attrs=(
        (AT.TYPMOD,'PLAN'),
        (AT.FLUIDE,'OUI'),
        (AT.PESA,'OUI'),
...
phen.add('2D_FLUI_STRU#1', Modelisation(dim=(1,2), code='FS2',
    attrs=(
        (AT.TYPMOD,'PLAN'),
        (AT.FLUIDE,'OUI'),
        (AT.FSI,'OUI'),
...
phen.add('2D_FLUI_STRU#2', Modelisation(dim=(1,2), code='FP2',
    attrs=(
        (AT.TYPMOD,'PLAN'),
        (AT.FLUIDE,'OUI'),
        (AT.FSI,'OUI'),
...
phen.add('3D_FLUIDE#1', Modelisation(dim=(3,3), code='3FL',
    attrs=(
        (AT.TYPMOD,'3D'),
        (AT.FLUIDE,'OUI'),
        (AT.FORMULATION,'FSI_UPPHI'),
...
phen.add('3D_FLUIDE#2', Modelisation(dim=(3,3), code='3FP',
    attrs=(
        (AT.TYPMOD,'3D'),
        (AT.FLUIDE,'OUI'),
        (AT.FORMULATION,'FSI_UP'),
...
phen.add('AXIS_FLUIDE#1', Modelisation(dim=(2,2), code='AXF',
    attrs=(
        (AT.TYPMOD,'AXIS'),
        (AT.FLUIDE,'OUI'),
        (AT.AXIS,'OUI'),
...
phen.add('AXIS_FLUIDE#2', Modelisation(dim=(2,2), code='AX2',
    attrs=(
        (AT.TYPMOD,'AXIS'),
        (AT.FLUIDE,'OUI'),
        (AT.AXIS,'OUI'),
...
phen.add('AXIS_FLUI_STRU#2', Modelisation(dim=(1,2), code='FS2',
    attrs=(
        (AT.TYPMOD,'AXIS'),
        (AT.FLUIDE,'OUI'),
        (AT.AXIS,'OUI'),
...
phen.add('FLUI_STRU#1', Modelisation(dim=(3,3), code='FLS',
    attrs=(
        (AT.TYPMOD,'3D'),
        (AT.FLUIDE,'OUI'),
        (AT.FSI,'OUI'),
...
phen.add('FLUI_STRU#2', Modelisation(dim=(3,3), code='FLP',
    attrs=(
        (AT.TYPMOD,'3D'),
        (AT.FLUIDE,'OUI'),
        (AT.FSI,'OUI'),
