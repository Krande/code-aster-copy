    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, LC.E200NEUT), (OP.CALC_G_XFEM.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_G_XFEM.PPINTER, LC.E120NEUT), (OP.CALC_G_XFEM.PPINTTO, E33NEUTR),
                     (OP.CALC_G_XFEM.PPMILTO, LC.E198NEUT), (SP.PPRESSR, EPRESNO),
        ...
        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, LC.E200NEUT), (OP.CALC_G_XFEM_F.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_G_XFEM_F.PHEAVTO, LC.E32NEUTI), (OP.CALC_G_XFEM_F.PLONCHA, LC.E10NEUTI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_XFEM_F.PPINTER, LC.E120NEUT),
                     (OP.CALC_G_XFEM_F.PPINTTO, E33NEUTR), (OP.CALC_G_XFEM_F.PPMILTO, LC.E198NEUT),
        ...
        OP.CALC_K_G_XFEM(te=297,
            para_in=((OP.CALC_K_G_XFEM.PAINTER, LC.E200NEUT), (OP.CALC_K_G_XFEM.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_K_G_XFEM.PHEAVTO, LC.E32NEUTI), (OP.CALC_K_G_XFEM.PLONCHA, LC.E10NEUTI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_K_G_XFEM.PPINTER, LC.E120NEUT),
                     (OP.CALC_K_G_XFEM.PPINTTO, E33NEUTR), (OP.CALC_K_G_XFEM.PPMILTO, LC.E198NEUT),
        ...
        OP.CALC_K_G_XFEM_F(te=297,
            para_in=((OP.CALC_K_G_XFEM_F.PAINTER, LC.E200NEUT), (OP.CALC_K_G_XFEM_F.PBASECO, LC.E360NEUT),
                     ...
                     (SP.PCOURB, LC.G27NEUTR), (SP.PDEPLAR, DDL_MECA),
                     (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
                     (OP.CALC_K_G_XFEM_F.PHEAVTO, LC.E32NEUTI), (OP.CALC_K_G_XFEM_F.PLONCHA, LC.E10NEUTI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_K_G_XFEM_F.PPINTER, LC.E120NEUT),
                     (OP.CALC_K_G_XFEM_F.PPINTTO, E33NEUTR), (OP.CALC_K_G_XFEM_F.PPMILTO, LC.E198NEUT),
        ...
        OP.ENEL_ELEM(te=565,
            para_in=((OP.ENEL_ELEM.PCNSETO, LC.E320NEUI), (OP.ENEL_ELEM.PCOMPOR, LC.CCOMPOR),
        ...
        OP.FULL_MECA(te=539,
            para_in=((OP.FULL_MECA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.FULL_MECA.PCNSETO, LC.E320NEUI),
        ...
        OP.RAPH_MECA(te=539,
            para_in=((OP.RAPH_MECA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.RAPH_MECA.PCNSETO, LC.E320NEUI),
        ...
        OP.RIGI_MECA_TANG(te=539,
            para_in=((OP.RIGI_MECA_TANG.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.RIGI_MECA_TANG.PCNSETO, LC.E320NEUI),
