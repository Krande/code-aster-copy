...
from cataelem.Elements.meca_d_plan_hho333 import MECA_DPQ9_HHO333
from cataelem.Tools.base_objects import ElrefeLoc, SetOfNodes

# ------------------------------------------------------------


class MECA_AXQ9_HHO333(MECA_DPQ9_HHO333):
...
class MECA_AXT7_HHO333(MECA_AXQ9_HHO333):
    """Please document this element"""
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR7,
            gauss=("RIGI=FPG13", "FPG1=FPG1", "MTGA=FPG13", "MASS=FPG13"),
            mater=("RIGI", "FPG1", "MTGA", "MASS"),
        ),
    )
