...
DDL_THER = LocatedComponents(
    phys=PHY.TEMP_R, type="ELNO", diff=True, components=(("EN1", ("HHO_FT[5]",)), ("EN2", ()))
)

CHHOBS = LocatedComponents(
    phys=PHY.N3600R, type="ELNO", diff=True, components=(("EN1", ("X[15]",)), ("EN2", ()))
)
...
# --------------------------------------------------------------------------------------------------
class THER_AX_HHO4_F(THER_2D_HHO4_F):
    """Thermics - Skin element HHO_QUAD - AXIS - SEG"""

    elrefe = (ElrefeLoc(MT.SE3, gauss=("RIGI=FPG6",), mater=("RIGI",)),)
