...
class MECA_HEXA20(Element):
    ...
    elrefe =(
            ElrefeLoc(MT.H20, gauss = ('RIGI=FPG27','FPG1=FPG1','MASS=FPG27','NOEU=NOEU','ARLQ_1=FPG27','MTGA=FPG27',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
    ...
    calculs = (
        ...
        OP.CALC_G(te=222,
            para_in=((SP.PACCELE, DDL_MECA), (OP.CALC_G.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PVITESS, DDL_MECA),
                     (OP.CALC_G.PDEG, LC.E1NEUTI),(OP.CALC_G.PLAG, LC.E3NEUTR)
                     ),
        ...
        OP.CALC_G_F(te=222,
            para_in=((SP.PACCELE, DDL_MECA), (OP.CALC_G_F.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PVITESS, DDL_MECA), (OP.CALC_G_F.PDEG, LC.E1NEUTI),
        ...
        OP.CALC_K_G(te=222,
            para_in=((OP.CALC_K_G.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PSIGINR, ECONTNO), (OP.CALC_K_G.PTHETAR, LC.ETHETA),
                     (OP.CALC_K_G.PVARCPR, LC.ZVARCPG), (SP.PVARCRR, LC.ZVARCPG),
                     (OP.CALC_K_G.PDEG, LC.E1NEUTI),(OP.CALC_K_G.PLAG, LC.E3NEUTR)),
            para_out=((SP.PGTHETA, NEWTHETA), ),
        ),
        ...
        OP.CALC_K_G_F(te=222,
            para_in=((OP.CALC_K_G_F.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_F.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PPULPRO, LC.CFREQR), (SP.PROTATR, LC.CROTATR),
                     (SP.PSIGINR, ECONTNO), (SP.PTEMPSR, CTEMPSR),
                     (OP.CALC_K_G_F.PTHETAR, LC.ETHETA), (OP.CALC_K_G_F.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_K_G_F.PDEG, LC.E1NEUTI),
                     (OP.CALC_K_G_F.PLAG, LC.E3NEUTR)),
            para_out=((SP.PGTHETA, NEWTHETA), ),
        ),

        OP.CALC_K_G_XFEM(te=295,
            para_in=((OP.CALC_K_G_XFEM.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_XFEM.PCOMPOR, LC.CCOMPOR),
        ...
        OP.CALC_K_G_XFEM_F(te=295,
            para_in=((OP.CALC_K_G_XFEM_F.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PCOURB, LC.G27NEUTR), (SP.PDEPINR, DDL_MECA),
                     (SP.PDEPLAR, DDL_MECA), (SP.PEPSINF, CEPSINF),
                     (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
                     ...
                     (SP.PPULPRO, LC.CFREQR), (SP.PROTATR, LC.CROTATR),
                     (SP.PSIGINR, ECONTNO), (SP.PTEMPSR, CTEMPSR),
                     (SP.PTHETAR, DDL_MECA), (OP.CALC_K_G_XFEM_F.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), ),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),
        ...
        OP.ENDO_ELGA(te=512,
            para_in=((OP.ENDO_ELGA.PCOMPOR, LC.CCOMPOR), (SP.PCONTGP, ECONTPG),
        ...
        OP.TOU_INI_ELEM(te=99,
            para_out=((OP.TOU_INI_ELEM.PGEOM_R, LC.CGEOM3D), (OP.TOU_INI_ELEM.PNEUT_I, LC.CNEUTI3)),
        ),
...
class MECA_HEXA27(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.H27, gauss = ('RIGI=FPG27','FPG1=FPG1','MASS=FPG27','NOEU=NOEU','MTGA=FPG27',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
...
class MECA_HEXA8(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.HE8, gauss = ('RIGI=FPG8','FPG1=FPG1','MASS=FPG8','NOEU=NOEU','ARLQ_1=FPG8','MTGA=FPG8',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
...
class MECA_HEXS20(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.H20, gauss = ('RIGI=FPG8','FPG1=FPG1','MASS=FPG27','NOEU=NOEU','MTGA=FPG8',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9','NOEU=NOEU',),),
        )
...
class MECA_PENTA15(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.P15, gauss = ('RIGI=FPG21','FPG1=FPG1','MASS=FPG21','NOEU=NOEU','ARLQ_1=FPG21','MTGA=FPG21',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9','NOEU=NOEU',),),
...
class MECA_PENTA18(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.P18, gauss = ('RIGI=FPG21','FPG1=FPG1','MASS=FPG21','NOEU=NOEU','MTGA=FPG21',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.QU9, gauss = ('RIGI=FPG9','MASS=FPG9','NOEU=NOEU',),),
            ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','MASS=FPG6','NOEU=NOEU',),),
        )
...
class MECA_PENTA6(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.PE6, gauss = ('RIGI=FPG6','FPG1=FPG1','MASS=FPG6','NOEU=NOEU','ARLQ_1=FPG6','MTGA=FPG6',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG4','NOEU=NOEU',),),
...
class MECA_PYRAM5(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.PY5, gauss = ('RIGI=FPG5','FPG1=FPG1','MASS=FPG5','NOEU=NOEU','MTGA=FPG5',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG4','NOEU=NOEU',),),
            ElrefeLoc(MT.TR3, gauss = ('RIGI=COT3','MASS=COT3','NOEU=NOEU',),),
        )
...
class MECA_TETRA10(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.T10, gauss = ('RIGI=FPG5','FPG1=FPG1','MASS=FPG15','NOEU=NOEU','ARLQ_1=FPG5','MTGA=FPG5',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','MASS=FPG6','NOEU=NOEU',),),
        )
...
class MECA_TETRS10(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.T10, gauss = ('RIGI=FPG4','FPG1=FPG1','MASS=FPG15','NOEU=NOEU','MTGA=FPG4',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','MASS=FPG6','NOEU=NOEU',),),
        )
...
class MECA_TETRA4(MECA_HEXA20):
    ...
    elrefe =(
            ElrefeLoc(MT.TE4, gauss = ('RIGI=FPG1','FPG1=FPG1','MASS=FPG4','NOEU=NOEU','ARLQ_1=FPG1','MTGA=FPG1',), mater=('RIGI','MASS','NOEU','FPG1','MTGA',),),
            ElrefeLoc(MT.TR3, gauss = ('RIGI=COT3','MASS=COT3','NOEU=NOEU',),),
        )
