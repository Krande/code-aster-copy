...
class MECA_DPQ9_HHO222(Element):
    ...
    elrefe = (
        ElrefeLoc(MT.QU9, gauss=('RIGI=FPG9', 'FPG1=FPG1',
                  'MTGA=FPG9',), mater=('RIGI', 'FPG1', 'MTGA',),),
...
class MECA_DPT7_HHO222(MECA_DPQ9_HHO222):
    ...
    elrefe = (
        ElrefeLoc(MT.TR7, gauss=('RIGI=FPG6', 'FPG1=FPG1',
                  'MTGA=FPG6',), mater=('RIGI', 'FPG1', 'MTGA',),),
        ElrefeLoc(MT.SE3, gauss=('RIGI=FPG1',),),
    )
    calculs = (
