...
class HM_HEXA20M_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20, gauss=("RIGI=FPG8", "MASS=FPG27", "XFEM=XFEM480", "FPG1=FPG1"), mater=("XFEM",)
        ),
...
class HM_PENTA15M_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15, gauss=("RIGI=FPG6", "MASS=FPG21", "XFEM=XFEM240", "FPG1=FPG1"), mater=("XFEM",)
        ),
...
class HM_TETRA10M_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10, gauss=("RIGI=FPG4", "MASS=FPG15", "XFEM=XFEM90", "FPG1=FPG1"), mater=("XFEM",)
        ),
...
class HM_HEXA20D_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20,
            gauss=("RIGI=NOEU_S", "MASS=NOEU_S", "XFEM=XFEM480", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
...
class HM_PENTA15D_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15,
            gauss=("RIGI=NOEU_S", "MASS=NOEU_S", "XFEM=XFEM240", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
...
class HM_TETRA10D_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=NOEU_S", "MASS=NOEU_S", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
...
class HM_HEXA20S_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20,
            gauss=("RIGI=FPG8NOS", "MASS=FPG8", "NOEU_S=NOEU_S", "XFEM=XFEM480", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
...
class HM_PENTA15S_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15,
            gauss=("RIGI=FPG6NOS", "MASS=FPG6", "NOEU_S=NOEU_S", "XFEM=XFEM240", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
...
class HM_TETRA10S_XH(HM_HEXA20_XH):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG4NOS", "MASS=FPG4", "NOEU_S=NOEU_S", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
