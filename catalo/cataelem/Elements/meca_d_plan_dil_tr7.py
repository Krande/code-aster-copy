...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "GONF")), ("EN2", ("DX", "DY")), ("EN3", ("PRES",))),
)


EDEFOPG = LocatedComponents(
    phys=PHY.EPSI_R, type="ELGA", location="RIGI", components=("DEPV", "DGONFX[2]", "PRES")
)


EDEFONO = LocatedComponents(phys=PHY.EPSI_R, type="ELNO", components=("DEPV", "DGONFX[2]", "PRES"))
...
ECONTNC = LocatedComponents(phys=PHY.SIEF_C, type="ELNO", components=("PRES", "SIG[2]", "DEPV"))


ECONTPG = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("PRES", "SIG[2]", "DEPV")
)


ECONTNO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("PRES", "SIG[2]", "DEPV"))
...
class TR7_DP_2D(Element):
    ...
    meshType = MT.TRIA7
    nodes = (SetOfNodes("EN3", (7,)), SetOfNodes("EN2", (4, 5, 6)), SetOfNodes("EN1", (1, 2, 3)))
    elrefe = (
