...
DDL_MECA = LocatedComponents(
    ...
    diff=True,
    components=(
        ("EN1", ("HHO_U[3]", "HHO_V[3]", "HHO_VR[3]")),
        ("EN2", ()),
        ("EN3", ("HHO_C[12]", "HHO_VR[6]", "HHO_GV[6]")),
    ),
)
...
class MECA_DGVQ_HHO222(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU9, gauss=("RIGI=FPG9", "FPG1=FPG1", "MTGA=FPG4"), mater=("RIGI", "FPG1", "MTGA")
        ),
    )
    calculs = (
        OP.COOR_ELGA(
...
class MECA_DGVT_HHO222(MECA_DGVQ_HHO222):
    """Please document this element"""
