...
CCADISA = LocatedComponents(phys=PHY.CADISA_R, type="ELEM", components=("A[16]",))


CCADISK = LocatedComponents(phys=PHY.CADISK_R, type="ELEM", components=("K[16]",))


CCADISM = LocatedComponents(phys=PHY.CADISM, type="ELEM", components=("M[16]",))
...
EENERR = LocatedComponents(phys=PHY.ENER_R, type="ELEM", components=("TOTALE", "DX", "DY"))
...
EEFGEGC = LocatedComponents(phys=PHY.SIEF_C, type="ELGA", location="RIGI", components=("N", "VY"))


EEFGENC = LocatedComponents(phys=PHY.SIEF_C, type="ELNO", components=("N", "VY"))


EEFGEGA = LocatedComponents(phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("N", "VY"))


EEFGENO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("N", "VY"))
...
class MECA_2D_DIS_T_L(Element):
    ...
    meshType = MT.SEG2
    elrefe = (ElrefeLoc(MT.SE2, gauss=("RIGI=NOEU", "FPG1=FPG1"), mater=("RIGI", "FPG1")),)
    calculs = (
        OP.AMOR_MECA(
            te=41,
            para_in=(
        ...
        OP.REFE_FORC_NODA(
            te=39,
            para_in=((SP.PCINFDI, LC.CCINFDI), (SP.PREFCO, LC.CRESEFF)),
            para_out=((SP.PVECTUR, MVECTUR),),
        ),
