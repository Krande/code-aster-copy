...
# ------------------------------------------------------------
class MEBA2DSE2(Element):
    """Nonlinear bar element in 2D physical space for SEG2"""
...
class MEBA2DSE3(MEBA2DSE2):
    """Nonlinear bar element in 2D physical space for SEG3"""
