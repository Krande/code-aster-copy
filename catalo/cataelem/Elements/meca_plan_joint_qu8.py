...
NGEOMER = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("X", "Y")), ("EN2", ()), ("EN3", ()), ("EN4", ())),
)
...
EGNEUT_F = LocatedComponents(phys=PHY.NEUT_F, type="ELGA", location="RIGI", components=("X[3]",))
...
ECONTPG = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("SIGN", "SITX", "FH11X")
)


ECONTNO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("SIGN", "SITX", "FH11X"))
