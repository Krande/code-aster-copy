    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=118,
            para_in=((OP.CALC_G_XFEM.PCNSETO, LC.E36NEUI), (SP.PDEPLAR, DDL_MECA),
                     ...
                     (OP.CALC_G_XFEM.PPINTTO, LC.E12NEUTR), (SP.PPRESSR, EPRESNO),
                     (SP.PTHETAR, NTHETAR), (OP.CALC_G_XFEM.PPMILTO, E33NEUTR),
...
#       -- te0580 : ne resout que les cas triviaux : 0.
        ...
        OP.CALC_K_G_XFEM(te=48,
            para_in=((OP.CALC_G_XFEM.PCNSETO, LC.E36NEUI), (SP.PDEPLAR, DDL_MECA),
                     ...
                     (OP.CALC_G_XFEM.PLSN, LC.N1NEUT_R), (OP.CALC_G_XFEM.PLST, LC.N1NEUT_R),
                     (OP.CALC_G_XFEM.PPINTTO, LC.E12NEUTR), (SP.PPRESSR, EPRESNO),
                     (SP.PTHETAR, NTHETAR), (OP.CALC_K_G_XFEM.PBASLOR, LC.N9NEUT_R),
                     (SP.PMATERC, LC.CMATERC), (OP.CALC_K_G_XFEM.PSTANO, STANO_I),
