...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "PRES", "GONF", "VARI", "LAG_GV")), ("EN2", ("DX", "DY"))),
)


CEPSINF = LocatedComponents(
    phys=PHY.EPSI_F, type="ELGA", location="RIGI", components=("EPXX", "EPYY", "EPZZ", "EPXY")
)
...
EREFCO = LocatedComponents(phys=PHY.PREC, type="ELEM", components=("SIGM", "VARI", "LAG_GV"))
