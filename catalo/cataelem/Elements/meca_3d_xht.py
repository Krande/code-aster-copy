...
#       -- te0580 : ne resout que les cas triviaux : 0.
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, LC.E200NEUT), (OP.CALC_G_XFEM.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_G_XFEM.PHEAVTO, LC.E32NEUTI), (OP.CALC_G_XFEM.PHEA_NO, LC.N5NEUTI),
        ...
        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, LC.E200NEUT), (OP.CALC_G_XFEM_F.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_G_XFEM_F.PCONTRR, ECONTPG), (SP.PCOURB, LC.G27NEUTR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFFVOLU, CFORCEF),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_G_XFEM_F.PHEAVTO, LC.E32NEUTI),
        ...
        OP.CHAR_MECA_TEMP_R(te=541,
            para_in=((OP.CHAR_MECA_TEMP_R.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.CHAR_MECA_TEMP_R.PCNSETO, LC.E320NEUI), (OP.CHAR_MECA_TEMP_R.PCOMPOR, LC.CCOMPOR),
        ...
        OP.RIGI_GEOM(te=536,
            para_in=((OP.RIGI_GEOM.PBASLOR, LC.N9NEUT_R), (OP.RIGI_GEOM.PCNSETO, LC.E320NEUI),
                     ...
                     (OP.RIGI_GEOM.PHEAVTO, LC.E32NEUTI), (OP.RIGI_GEOM.PHEA_NO, LC.N5NEUTI),
                     (OP.RIGI_GEOM.PLONCHA, LC.E10NEUTI), (OP.RIGI_GEOM.PLSN, LC.N1NEUT_R),
                     (OP.RIGI_GEOM.PLST, LC.N1NEUT_R), (OP.RIGI_GEOM.PPINTTO, E33NEUTR),
                     (OP.RIGI_GEOM.PPMILTO, LC.E198NEUT), (OP.RIGI_GEOM.PSTANO, STANO_I),),
            para_out=((SP.PMATUUR, MMATUUR), ),
        ),
        ...
        OP.SIEF_ELGA(te=261,
            para_in=((OP.SIEF_ELGA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.SIEF_ELGA.PCNSETO, LC.E320NEUI), (OP.SIEF_ELGA.PCOMPOR, LC.CCOMPOR),
