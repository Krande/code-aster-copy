...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("HHO_FX[10]", "HHO_FY[10]", "HHO_FZ[10]")), ("EN2", ())),
)

CHHOBS = LocatedComponents(
    phys=PHY.N3600R, type="ELNO", diff=True, components=(("EN1", ("X[55]",)), ("EN2", ()))
)
...
# ------------------------------------------------------------
class MECA3DQU9_HHO3_F(Element):
...
# ------------------------------------------------------------
class MECA3DTR7_HHO3_F(MECA3DQU9_HHO3_F):
    """Please document this element"""
