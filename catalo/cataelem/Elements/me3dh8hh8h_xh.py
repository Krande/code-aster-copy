...
DDL_MECA = LocatedComponents(
    ...
    components=(
        ...
        ("EN3", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "K1", "K2", "K3", "LAGS_C", "LAGS_F[2]")),
        ("EN4", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "K1", "K2", "K3")),
...
STANO_I = LocatedComponents(phys=PHY.N120_I, type="ELEM", components=("X[40]",))
...
class ME3DH8T_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.HEXA8
    nodes = (SetOfNodes("EN5", (1, 2, 3, 4, 5, 6, 7, 8)),)
    elrefe = (ElrefeLoc(MT.HE8, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DP6HP6H_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.PE6PE6
    nodes = (SetOfNodes("EN2", (7, 8, 9, 10, 11, 12)), SetOfNodes("EN1", (1, 2, 3, 4, 5, 6)))
...
class ME3DP6HP6C_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.PE6PE6
    nodes = (SetOfNodes("EN4", (7, 8, 9, 10, 11, 12)), SetOfNodes("EN1", (1, 2, 3, 4, 5, 6)))
    elrefe = (ElrefeLoc(MT.PE6, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DP6CP6H_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.PE6PE6
    nodes = (SetOfNodes("EN2", (7, 8, 9, 10, 11, 12)), SetOfNodes("EN3", (1, 2, 3, 4, 5, 6)))
    elrefe = (ElrefeLoc(MT.PE6, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DP6CP6C_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.PE6PE6
    nodes = (SetOfNodes("EN4", (7, 8, 9, 10, 11, 12)), SetOfNodes("EN3", (1, 2, 3, 4, 5, 6)))
    elrefe = (ElrefeLoc(MT.PE6, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DP6T_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.PENTA6
    nodes = (SetOfNodes("EN5", (1, 2, 3, 4, 5, 6)),)
    elrefe = (ElrefeLoc(MT.PE6, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DT4HT4C_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.TE4TE4
    nodes = (SetOfNodes("EN4", (5, 6, 7, 8)), SetOfNodes("EN1", (1, 2, 3, 4)))
    elrefe = (ElrefeLoc(MT.TE4, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DT4CT4H_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.TE4TE4
    nodes = (SetOfNodes("EN2", (5, 6, 7, 8)), SetOfNodes("EN3", (1, 2, 3, 4)))
    elrefe = (ElrefeLoc(MT.TE4, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DT4CT4C_XH(ME3DH8HH8H_XH):
    ...
    meshType = MT.TE4TE4
    nodes = (SetOfNodes("EN4", (5, 6, 7, 8)), SetOfNodes("EN3", (1, 2, 3, 4)))
    elrefe = (ElrefeLoc(MT.TE4, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DHVHHVH_XH(ME3DH8HH8H_XH):
    ...
    elrefe = (ElrefeLoc(MT.H20, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DPQHPQH_XH(ME3DH8HH8H_XH):
    ...
    elrefe = (ElrefeLoc(MT.P15, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
...
class ME3DTDHTDH_XH(ME3DH8HH8H_XH):
    ...
    elrefe = (ElrefeLoc(MT.T10, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)))
