...
E90NEUTR = LocatedComponents(phys=PHY.N1360R, type="ELEM", components=("X[60]",))
...
class MECA_XH1_HEXA8(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.HE8, gauss=("RIGI=FPG8", "NOEU=NOEU", "XFEM=XFEM480", "FPG1=FPG1"), mater=("XFEM",)
        ),
    ...
    calculs = (
        ...
        OP.CHAR_MECA_PESA_R(
            te=441,
            para_in=(
                (OP.CHAR_MECA_PESA_R.PCNSETO, LC.E512NEUI),
                (SP.PGEOMER, NGEOMER),
                ...
                (SP.PMATERC, LC.CMATERC),
                (SP.PPESANR, LC.CPESANR),
                (OP.CHAR_MECA_PESA_R.PPINTTO, LC.E132NEUR),
        ...
        OP.CHAR_MECA_TEMP_R(
            ...
            para_in=(
                ...
                (SP.PGEOMER, NGEOMER),
                (OP.CHAR_MECA_TEMP_R.PHEAVTO, LC.E128NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_TEMP_R.PPINTTO, LC.E132NEUR),
        ...
        OP.RIGI_MECA(
            ...
            para_in=(
                ...
                (OP.RIGI_MECA.PCNSETO, LC.E512NEUI),
                (OP.RIGI_MECA.PFISNO, LC.FISNO_I),
                (SP.PGEOMER, NGEOMER),
                (OP.RIGI_MECA.PHEAVTO, LC.E128NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.RIGI_MECA.PPINTTO, LC.E132NEUR),
        ...
        OP.SIEF_ELGA(
            ...
            para_in=(
                ...
                (SP.PGEOMER, NGEOMER),
                (OP.SIEF_ELGA.PHEAVTO, LC.E128NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.SIEF_ELGA.PPINTTO, LC.E132NEUR),
...
class MECA_XH2_HEXA8(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.HE8, gauss=("RIGI=FPG8", "NOEU=NOEU", "XFEM=XFEM960", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH3_HEXA8(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.HE8, gauss=("RIGI=FPG8", "NOEU=NOEU", "XFEM=XFEM1440", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH4_HEXA8(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.HE8, gauss=("RIGI=FPG8", "NOEU=NOEU", "XFEM=XFEM1920", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH1_PENTA6(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PE6, gauss=("RIGI=FPG6", "NOEU=NOEU", "XFEM=XFEM240", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH2_PENTA6(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PE6, gauss=("RIGI=FPG6", "NOEU=NOEU", "XFEM=XFEM480", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH3_PENTA6(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PE6, gauss=("RIGI=FPG6", "NOEU=NOEU", "XFEM=XFEM720", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH4_PENTA6(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PE6, gauss=("RIGI=FPG6", "NOEU=NOEU", "XFEM=XFEM960", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH1_PYRAM5(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PY5, gauss=("RIGI=FPG5", "NOEU=NOEU", "XFEM=XFEM180", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH2_PYRAM5(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PY5, gauss=("RIGI=FPG5", "NOEU=NOEU", "XFEM=XFEM360", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH3_PYRAM5(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PY5, gauss=("RIGI=FPG5", "NOEU=NOEU", "XFEM=XFEM540", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH4_PYRAM5(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PY5, gauss=("RIGI=FPG5", "NOEU=NOEU", "XFEM=XFEM720", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH1_TETRA4(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH2_TETRA4(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM180", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH3_TETRA4(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM270", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH4_TETRA4(MECA_XH1_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM360", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
