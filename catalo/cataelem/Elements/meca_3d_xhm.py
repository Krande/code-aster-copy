...
class MECA_XH1_HEXA8(Element):
    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, E90NEUTR), (OP.CALC_G_XFEM.PBASECO, LC.E162NEUR),
                     (OP.CALC_G_XFEM.PBASLOR, LC.N9NEUT_R), (OP.CALC_G_XFEM.PCFACE, LC.E54NEUTI),
                     (OP.CALC_G_XFEM.PCNSETO, LC.E512NEUI), (OP.CALC_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFRVOLU, NFORCER),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_G_XFEM.PHEAVTO, LC.E128NEUI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_XFEM.PPINTER, LC.E54NEUTR),
                     (OP.CALC_G_XFEM.PPINTTO, LC.E132NEUR), (SP.PPRESSR, EPRESNO),
        ...
        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, E90NEUTR), (OP.CALC_G_XFEM_F.PBASECO, LC.E162NEUR),
                     (OP.CALC_G_XFEM_F.PBASLOR, LC.N9NEUT_R), (OP.CALC_G_XFEM_F.PCFACE, LC.E54NEUTI),
                     (OP.CALC_G_XFEM_F.PCNSETO, LC.E512NEUI), (OP.CALC_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PCOURB, LC.G27NEUTR), (SP.PDEPLAR, DDL_MECA),
                     (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
                     (OP.CALC_G_XFEM_F.PHEAVTO, LC.E128NEUI), (OP.CALC_G_XFEM_F.PHEA_NO, LC.N5NEUTI),
                     ...
                     (OP.CALC_G_XFEM_F.PPINTER, LC.E54NEUTR), (OP.CALC_G_XFEM_F.PPINTTO, LC.E132NEUR),
        ...
        OP.CALC_K_G_XFEM(te=297,
            para_in=((OP.CALC_K_G_XFEM.PAINTER, E90NEUTR), (OP.CALC_K_G_XFEM.PBASECO, LC.E162NEUR),
                     (OP.CALC_K_G_XFEM.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_XFEM.PCFACE, LC.E54NEUTI),
                     (OP.CALC_K_G_XFEM.PCNSETO, LC.E512NEUI), (OP.CALC_K_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (SP.PCOURB, LC.G27NEUTR), (SP.PDEPLAR, DDL_MECA),
                     (SP.PFRVOLU, NFORCER), (SP.PGEOMER, NGEOMER),
                     (OP.CALC_K_G_XFEM.PHEAVTO, LC.E128NEUI), (OP.CALC_K_G_XFEM.PHEA_NO, LC.N5NEUTI),
                     ...
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     (OP.CALC_K_G_XFEM.PPINTER, LC.E54NEUTR), (OP.CALC_K_G_XFEM.PPINTTO, LC.E132NEUR),
        ...
        OP.CALC_K_G_XFEM_F(te=297,
            para_in=((OP.CALC_K_G_XFEM_F.PAINTER, E90NEUTR), (OP.CALC_K_G_XFEM_F.PBASECO, LC.E162NEUR),
                     (OP.CALC_K_G_XFEM_F.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_XFEM_F.PCFACE, LC.E54NEUTI),
                     (OP.CALC_K_G_XFEM_F.PCNSETO, LC.E512NEUI), (OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PCOURB, LC.G27NEUTR), (SP.PDEPLAR, DDL_MECA),
                     (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
                     (OP.CALC_K_G_XFEM_F.PHEAVTO, LC.E128NEUI), (OP.CALC_K_G_XFEM_F.PHEA_NO, LC.N5NEUTI),
                     ...
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     (OP.CALC_K_G_XFEM_F.PPINTER, LC.E54NEUTR), (OP.CALC_K_G_XFEM_F.PPINTTO, LC.E132NEUR),
        ...
        OP.CHAR_MECA_TEMP_R(te=541,
            para_in=((OP.CHAR_MECA_TEMP_R.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.CHAR_MECA_TEMP_R.PCNSETO, LC.E512NEUI), (OP.CHAR_MECA_TEMP_R.PCOMPOR, LC.CCOMPOR),
        ...
        OP.SIEF_ELGA(te=261,
            para_in=((OP.SIEF_ELGA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.SIEF_ELGA.PCNSETO, LC.E512NEUI), (OP.SIEF_ELGA.PCOMPOR, LC.CCOMPOR),
