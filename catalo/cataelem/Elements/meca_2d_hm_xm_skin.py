...
DDL_MECA = LocatedComponents(
    ...
    components=(
        ...
        ("EN2", ("DX", "DY", "H1X", "H1Y")),
        ("EN3", ("DX", "DY", "PRE1", "H1X", "H1Y", "H1PRE1", "H2X", "H2Y", "H2PRE1")),
        ("EN4", ("DX", "DY", "H1X", "H1Y", "H2X", "H2Y")),
        (
            "EN5",
            (
                "DX",
        ...
        ("EN6", ("DX", "DY", "H1X", "H1Y", "H2X", "H2Y", "H3X", "H3Y")),
    ),
)
...
E15NEUI = LocatedComponents(phys=PHY.N1280I, type="ELEM", components=("X[15]",))


E8NEUTR = LocatedComponents(phys=PHY.N132_R, type="ELEM", components=("X[8]",))


E5NEUI = LocatedComponents(phys=PHY.N512_I, type="ELEM", components=("X[5]",))


E10NEUTR = LocatedComponents(phys=PHY.N792_R, type="ELEM", components=("X[10]",))
...
class HM_DPSE3_XH1(Element):
    ...
    calculs = (
        ...
        OP.TOPOSE(
            ...
            para_out=(
                (OP.TOPOSE.PCNSETO, E15NEUI),
                (OP.TOPOSE.PHEAVTO, E5NEUI),
        ...
        OP.TOU_INI_ELGA(
            te=99,
            para_out=(
                (OP.TOU_INI_ELGA.PGEOM_R, EGEOMER),
...
class HM_DPSE3_XH2(HM_DPSE3_XH1):
    ...
    meshType = MT.SEG3
    nodes = (SetOfNodes("EN4", (3,)), SetOfNodes("EN3", (1, 2)))
...
class HM_DPSE3_XH3(HM_DPSE3_XH1):
    ...
    meshType = MT.SEG3
    nodes = (SetOfNodes("EN6", (3,)), SetOfNodes("EN5", (1, 2)))
    elrefe = (ElrefeLoc(MT.SE3, gauss=("RIGI=FPG4",)), ElrefeLoc(MT.SE2, gauss=("RIGI=FPG4",)))
