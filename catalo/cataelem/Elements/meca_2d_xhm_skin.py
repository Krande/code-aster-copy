...
E24NEUI = LocatedComponents(phys=PHY.N1280I, type="ELEM", components=("X[24]",))


E8NEUTI = LocatedComponents(phys=PHY.N512_I, type="ELEM", components=("X[8]",))


E16NEUTR = LocatedComponents(phys=PHY.N792_R, type="ELEM", components=("X[16]",))
