...
DDL_MECA = LocatedComponents(
    phys=PHY.DEPL_R, type="ELNO", diff=True, components=(("EN1", ("PRE[2]", "TEMP")), ("EN2", ()))
)


EFLHN = LocatedComponents(
    phys=PHY.FLHN_R, type="ELGA", location="RIGI", components=("FH1[2]", "FH21")
)


CFLUXF = LocatedComponents(phys=PHY.FTHM_F, type="ELEM", components=("PFLU[2]", "PTHER"))


EFLUXE = LocatedComponents(
    phys=PHY.FTHM_R, type="ELGA", location="RIGI", components=("PFLU[2]", "PTHER")
)
...
NSIEF_R = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("FH11X", "FH11Y", "FH12X", "FH12Y", "FH21X", "FH21Y")), ("EN2", ())),
)
