...
class MEPOULI(Element):
    ...
    meshType = MT.SEG3
    elrefe = (ElrefeLoc(MT.SE3, gauss=("RIGI=FPG1", "FPG1=FPG1"), mater=("RIGI", "FPG1")),)
    calculs = (
        OP.ADD_SIGM(
            te=581,
        ...
        OP.CHAR_MECA_TEMP_R(te=99, para_out=((SP.PVECTUR, MVECTUR),)),
        OP.COOR_ELGA(
        ...
        OP.REFE_FORC_NODA(
            te=169, para_in=((SP.PREFCO, EREFCO),), para_out=((SP.PVECTUR, MVECTUR),)
        ),
        OP.RIGI_MECA_HYST(
            te=50,
            para_in=(
