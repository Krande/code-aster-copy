...
DDL_THER = LocatedComponents(
    phys=PHY.TEMP_R, type="ELNO", diff=True, components=(("EN1", ("HHO_FT[15]",)), ("EN2", ()))
)
...
# --------------------------------------------------------------------------------------------------
class THER3DQU9_HHO4_F(Element):
    """Thermics - Skin element 3D_HHO_QUAD - QUAD"""
...
# --------------------------------------------------------------------------------------------------
class THER3DTR7_HHO4_F(THER3DQU9_HHO4_F):
    """Thermics - Skin element 3D_HHO_QUAD - TRIA"""
