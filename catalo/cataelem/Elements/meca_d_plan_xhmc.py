...
E8NEUTI = LocatedComponents(phys=PHY.N240_I, type="ELEM", components=("X[8]",))
...
class MEDPTR3_XH2C(Element):
    ...
    calculs = (
        ...
        OP.CHAR_MECA_CONT(
            te=534,
            para_in=(
                (OP.CHAR_MECA_CONT.PAINTER, LC.E40NEUTR),
                (OP.CHAR_MECA_CONT.PBASECO, LC.E32NEUTR),
                (OP.CHAR_MECA_CONT.PCFACE, E14NEUTI),
                ...
                (OP.CHAR_MECA_CONT.PHEA_FA, E8NEUTI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_CONT.PPINTER, E16NEUTR),
        ...
        OP.RIGI_CONT(
            te=533,
            para_in=(
                (OP.RIGI_CONT.PAINTER, LC.E40NEUTR),
                (OP.RIGI_CONT.PBASECO, LC.E32NEUTR),
                (OP.RIGI_CONT.PCFACE, E14NEUTI),
                (SP.PCOHES, LC.E1NEUTR),
                (SP.PDEPL_M, DDL_MECA),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
        ...
        OP.XCVBCA(
            te=532,
            para_in=(
                (OP.XCVBCA.PAINTER, LC.E40NEUTR),
                (OP.XCVBCA.PBASECO, LC.E32NEUTR),
                (OP.XCVBCA.PCFACE, E14NEUTI),
                (SP.PCOHES, LC.E1NEUTR),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
        ...
        OP.XREACL(
            te=548,
            para_in=(
                (OP.XREACL.PAINTER, LC.E40NEUTR),
                (OP.XREACL.PBASECO, LC.E32NEUTR),
                (OP.XREACL.PCFACE, E14NEUTI),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                (SP.PGEOMER, NGEOMER),
