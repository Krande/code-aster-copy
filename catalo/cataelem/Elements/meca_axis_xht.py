...
class MEAXTR3_XHT(Element):
    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, LC.E35NEUTR), (OP.CALC_G_XFEM.PBASECO, LC.E28NEUTR),
                     (OP.CALC_G_XFEM.PBASLOR, LC.N6NEUT_R), (OP.CALC_G_XFEM.PCFACE, LC.E9NEUTI),
                     (OP.CALC_G_XFEM.PCNSETO, LC.E36NEUI), (OP.CALC_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (OP.CALC_G_XFEM.PCONTRR, ECONTPG), (SP.PDEPLAR, DDL_MECA),
                     (SP.PFRVOLU, NFORCER), (SP.PGEOMER, NGEOMER),
                     (OP.CALC_G_XFEM.PHEAVTO, E6NEUTI), (OP.CALC_G_XFEM.PHEA_NO, LC.N5NEUTI),
                     (OP.CALC_G_XFEM.PLONCHA, LC.E10NEUTI), (OP.CALC_G_XFEM.PLONGCO, LC.E3NEUTI),
                     (OP.CALC_G_XFEM.PLSN, LC.N1NEUT_R), (OP.CALC_G_XFEM.PLST, LC.N1NEUT_R),
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     (OP.CALC_G_XFEM.PPINTER, LC.E14NEUTR), (OP.CALC_G_XFEM.PPINTTO, LC.E6NEUTR),
                     (OP.CALC_G_XFEM.PPMILTO, LC.E22NEUTR), (SP.PPRESSR, EPRESNO),
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGISE, ECONTSE),
                     (SP.PTHETAR, DDL_MECC), (OP.CALC_G_XFEM.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_G_XFEM.PSTANO, STANO_I),),
            para_out=((SP.PGTHETA, LC.EGTHETA), ),
        ),

        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, LC.E35NEUTR), (OP.CALC_G_XFEM_F.PBASECO, LC.E28NEUTR),
                     (OP.CALC_G_XFEM_F.PBASLOR, LC.N6NEUT_R), (OP.CALC_G_XFEM_F.PCFACE, LC.E9NEUTI),
                     (OP.CALC_G_XFEM_F.PCNSETO, LC.E36NEUI), (OP.CALC_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (OP.CALC_G_XFEM_F.PCONTRR, ECONTPG), (SP.PDEPLAR, DDL_MECA),
                     (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
                     (OP.CALC_G_XFEM_F.PHEAVTO, E6NEUTI), (OP.CALC_G_XFEM_F.PHEA_NO, LC.N5NEUTI),
                     ...
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     (OP.CALC_G_XFEM_F.PPINTER, LC.E14NEUTR), (OP.CALC_G_XFEM_F.PPINTTO, LC.E6NEUTR),
                     (OP.CALC_G_XFEM_F.PPMILTO, LC.E22NEUTR), (SP.PPRESSF, CPRESSF),
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGISE, ECONTSE),
        ...
        OP.CALC_K_G_XFEM(te=297,
            para_in=((OP.CALC_K_G_XFEM.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_XFEM.PBASECO, LC.E28NEUTR),
                     (OP.CALC_K_G_XFEM.PBASLOR, LC.N6NEUT_R), (OP.CALC_K_G_XFEM.PCFACE, LC.E9NEUTI),
                     (OP.CALC_K_G_XFEM.PCNSETO, LC.E36NEUI), (OP.CALC_K_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFRVOLU, NFORCER),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_K_G_XFEM.PHEAVTO, E6NEUTI),
                     (OP.CALC_K_G_XFEM.PHEA_NO, LC.N5NEUTI), (OP.CALC_K_G_XFEM.PLONCHA, LC.E10NEUTI),
                     (OP.CALC_K_G_XFEM.PLONGCO, LC.E3NEUTI), (OP.CALC_K_G_XFEM.PLSN, LC.N1NEUT_R),
                     (OP.CALC_K_G_XFEM.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_K_G_XFEM.PPINTER, LC.E14NEUTR),
                     (OP.CALC_K_G_XFEM.PPINTTO, LC.E6NEUTR), (OP.CALC_K_G_XFEM.PPMILTO, LC.E22NEUTR),
                     (SP.PPRESSR, EPRESNO), (SP.PPULPRO, LC.CFREQR),
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGISE, ECONTSE),
                     (SP.PTHETAR, DDL_MECC), (OP.CALC_K_G_XFEM.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_K_G_XFEM.PSTANO, STANO_I),),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),

        OP.CALC_K_G_XFEM_F(te=297,
            para_in=((OP.CALC_K_G_XFEM_F.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_XFEM_F.PBASECO, LC.E28NEUTR),
                     (OP.CALC_K_G_XFEM_F.PBASLOR, LC.N6NEUT_R), (OP.CALC_K_G_XFEM_F.PCFACE, LC.E9NEUTI),
                     (OP.CALC_K_G_XFEM_F.PCNSETO, LC.E36NEUI), (OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFFVOLU, CFORCEF),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_K_G_XFEM_F.PHEAVTO, E6NEUTI),
                     (OP.CALC_K_G_XFEM_F.PHEA_NO, LC.N5NEUTI), (OP.CALC_K_G_XFEM_F.PLONCHA, LC.E10NEUTI),
                     (OP.CALC_K_G_XFEM_F.PLONGCO, LC.E3NEUTI), (OP.CALC_K_G_XFEM_F.PLSN, LC.N1NEUT_R),
                     (OP.CALC_K_G_XFEM_F.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_K_G_XFEM_F.PPINTER, LC.E14NEUTR),
                     (OP.CALC_K_G_XFEM_F.PPINTTO, LC.E6NEUTR), (OP.CALC_K_G_XFEM_F.PPMILTO, LC.E22NEUTR),
                     (SP.PPRESSF, CPRESSF), (SP.PPULPRO, LC.CFREQR),
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGISE, ECONTSE),
                     (SP.PTEMPSR, CTEMPSR), (SP.PTHETAR, DDL_MECC), (OP.CALC_K_G_XFEM_F.PSTANO, STANO_I),
        ...
        OP.CHAR_MECA_TEMP_R(te=541,
            para_in=((OP.CHAR_MECA_TEMP_R.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.CHAR_MECA_TEMP_R.PCNSETO, LC.E36NEUI), (OP.CHAR_MECA_TEMP_R.PCOMPOR, LC.CCOMPOR),
        ...
        OP.RAPH_MECA(te=539,
            para_in=((OP.RAPH_MECA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.RAPH_MECA.PCNSETO, LC.E36NEUI),
        ...
        OP.RIGI_GEOM(te=536,
            para_in=((OP.RIGI_GEOM.PBASLOR, LC.N6NEUT_R), (OP.RIGI_GEOM.PCNSETO, LC.E36NEUI),
                     (OP.RIGI_GEOM.PCONTRR, ECONTPG), (SP.PGEOMER, NGEOMER),
                     (OP.RIGI_GEOM.PHEAVTO, E6NEUTI), (OP.RIGI_GEOM.PHEA_NO, LC.N5NEUTI),
                     (OP.RIGI_GEOM.PLONCHA, LC.E10NEUTI), (OP.RIGI_GEOM.PLSN, LC.N1NEUT_R),
                     (OP.RIGI_GEOM.PLST, LC.N1NEUT_R), (OP.RIGI_GEOM.PPINTTO, LC.E6NEUTR),
                     (OP.RIGI_GEOM.PPMILTO, LC.E22NEUTR), (OP.RIGI_GEOM.PSTANO, STANO_I),
                     ),
            para_out=((SP.PMATUUR, MMATUUR), ),
        ),
        ...
        OP.SIEF_ELGA(te=261,
            para_in=((OP.SIEF_ELGA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.SIEF_ELGA.PCNSETO, LC.E36NEUI), (OP.SIEF_ELGA.PCOMPOR, LC.CCOMPOR),
