...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "H1X", "H1Y", "K1", "K2")),),
)


EDEPLPG = LocatedComponents(
    phys=PHY.DEPL_R, type="ELGA", location="XFEM", components=("DX", "DY", "H1X", "H1Y", "K1", "K2")
)
...
ETEMXPG = LocatedComponents(
    phys=PHY.TEMP_R, type="ELGA", location="MATER", components=("TEMP", "DTX", "DTY")
)
    ...
    calculs = (
        ...
        OP.CHAR_MECA_FR2D2D(
            ...
            para_in=(
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_FR2D2D.PBASLOR, LC.N6NEUT_R),
            ),
            para_out=((SP.PVECTUR, MVECTUR),),
        ),
        OP.CHAR_MECA_PESA_R(
        ...
        OP.CHAR_MECA_TEMP_R(
            ...
            para_in=(
                ...
                (SP.PGEOMER, NGEOMER),
                (OP.CHAR_MECA_TEMP_R.PHEAVTO, E6NEUTI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_TEMP_R.PPINTTO, LC.E6NEUTR),
        ...
        OP.ERME_ELEM(
            te=382,
            para_in=(
                (OP.ERME_ELEM.PCNSETO, LC.E36NEUI),
                (SP.PCONTNO, ECONTNO),
                (OP.ERME_ELEM.PCONTSER, ECONTSE),
                (OP.ERME_ELEM.PCVOISX, LC.E18NEUI),
                (SP.PFFVOLU, CFORCEF),
                (SP.PFORCE, LC.CREFERI),
                (SP.PFRVOLU, EFORCER),
                (SP.PGEOMER, NGEOMER),
                (OP.ERME_ELEM.PLONCHA, LC.E10NEUTI),
                (SP.PMATERC, LC.CMATERC),
                (SP.PPESANR, LC.CPESANR),
                (OP.ERME_ELEM.PPINTTO, LC.E6NEUTR),
                (OP.ERME_ELEM.PPMILTO, LC.E22NEUTR),
        ...
        OP.RIGI_MECA(
            ...
            para_in=(
                ...
                (OP.RIGI_MECA.PCNSETO, LC.E36NEUI),
                (SP.PGEOMER, NGEOMER),
                (OP.RIGI_MECA.PHEAVTO, E6NEUTI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.RIGI_MECA.PPINTTO, LC.E6NEUTR),
        ...
        OP.RIGI_GEOM(
            te=536,
            para_in=(
                (OP.RIGI_GEOM.PBASLOR, LC.N6NEUT_R),
                (OP.RIGI_GEOM.PCNSETO, LC.E36NEUI),
                (OP.RIGI_GEOM.PCONTRR, ECONTPG),
                (SP.PGEOMER, NGEOMER),
                (OP.RIGI_GEOM.PHEAVTO, E6NEUTI),
                ...
                (OP.RIGI_GEOM.PPINTTO, LC.E6NEUTR),
                (OP.RIGI_GEOM.PPMILTO, LC.E22NEUTR),
        ...
        OP.SIEF_ELGA(
            ...
            para_in=(
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.SIEF_ELGA.PPINTTO, LC.E6NEUTR),
        ...
        OP.SIEF_ELNO(
            te=289,
            para_in=(
                (OP.SIEF_ELNO.PCNSETO, LC.E36NEUI),
        ...
        OP.SIGM_ELNO(
            te=289,
            para_in=(
                (OP.SIGM_ELNO.PCNSETO, LC.E36NEUI),
...
class MEAXQU8_XHT(MEAXTR3_XHT):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU8,
            gauss=("RIGI=FPG9", "NOEU_S=NOEU_S", "NOEU=NOEU", "XFEM=XFEM72", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
