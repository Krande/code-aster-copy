...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY")), ("EN2", ("DX", "DY")), ("EN3", ("SIGN", "SITX"))),
)
...
ECONTNO = LocatedComponents(
    phys=PHY.SIEF_R, type="ELNO", components=("SIGN", "SITX", "CONT_X", "CONT_Y")
)
...
class EIPLQU8(Element):
    ...
    meshType = MT.QUAD8
    nodes = (SetOfNodes("EN1", (1, 2, 5)), SetOfNodes("EN2", (3, 4, 7)), SetOfNodes("EN3", (6, 8)))
    ...
    calculs = (
        ...
        OP.REFE_FORC_NODA(
            te=361,
            para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER), (SP.PREFCO, EREFCO)),
            para_out=((SP.PVECTUR, MVECTUR),),
        ),
        OP.RIGI_MECA_ELAS(
            te=360,
