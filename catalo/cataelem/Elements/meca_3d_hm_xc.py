...
class HM_HEXA20_XHC(TemplateElement):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20, gauss=("RIGI=FPG27", "MASS=FPG27", "XFEM=XFEM480", "FPG1=FPG1"), mater=("XFEM",)
        ),
...
class HM_PENTA15_XHC(TemplateElement):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15, gauss=("RIGI=FPG21", "MASS=FPG21", "XFEM=XFEM240", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.T10, gauss=("XINT=FPG15", "NOEU=NOEU")),
...
class HM_PYRAM13_XHC(TemplateElement):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P13, gauss=("RIGI=FPG10", "MASS=FPG10", "XFEM=XFEM180", "FPG1=FPG1"), mater=("XFEM",)
        ),
        ElrefeLoc(MT.T10, gauss=("XINT=FPG15", "NOEU=NOEU")),
...
class HM_TETRA10_XHC(TemplateElement):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG5", "MASS=FPG5", "XINT=FPG15", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("XFEM",),
        ),
...
class HM_PYRAM13_XHC3(TemplateElement):
    ...
    meshType = MT.PYRAM13
    nodes = (SetOfNodes("EN2", (6, 7, 8, 9, 10, 11, 12, 13)), SetOfNodes("EN3", (1, 2, 3, 4, 5)))
    elrefe = (
        ElrefeLoc(
            MT.P13, gauss=("RIGI=FPG10", "MASS=FPG10", "XFEM=XFEM180", "FPG1=FPG1"), mater=("XFEM",)
        ),
...
class HM_TETRA10_XHC3(TemplateElement):
    ...
    meshType = MT.TETRA10
    nodes = (SetOfNodes("EN2", (5, 6, 7, 8, 9, 10)), SetOfNodes("EN3", (1, 2, 3, 4)))
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG5", "MASS=FPG5", "XINT=FPG15", "XFEM=XFEM90", "FPG1=FPG1"),
