...
MFORCEF = LocatedComponents(
    phys=PHY.FORC_F, type="ELEM", components=("FX", "FY", "FZ", "MX", "MY", "MZ")
)


MFORCER = LocatedComponents(
    phys=PHY.FORC_R, type="ELEM", components=("FX", "FY", "FZ", "MX", "MY", "MZ")
)
...
class MEBOCQ3(Element):
    ...
    calculs = (
        ...
        OP.CARA_SECT_POUT5(
            ...
            para_out=((SP.PVECTU1, MVECTUR), (SP.PVECTU2, MVECTUR), (SP.PVECTU3, MVECTUR)),
        ),
        OP.CHAR_MECA_FF1D3D(
            te=418,
            para_in=((SP.PFF1D3D, MFORCEF), (SP.PGEOMER, MGEOMER), (SP.PINSTR, LC.MTEMPSR)),
        ...
        OP.TOU_INI_ELNO(te=99, para_out=((OP.TOU_INI_ELNO.PGEOM_R, MGEOMER),)),
    )
