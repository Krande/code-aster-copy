...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "DZ", "GLIS", "SITY")), ("EN2", ("DX", "DY", "DZ", "GLIS"))),
)
...
EREFCO = LocatedComponents(
    phys=PHY.PREC, type="ELEM", components=("SIGM", "EFFORT", "MOMENT", "DEPL")
)
...
ECONTPG = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("N", "CONT_X", "CONT_Y")
)


ECONTNO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("N", "CONT_X", "CONT_Y"))
...
class MECGSEG3(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.SE3,
            gauss=("RIGI=FPG2", "MASS=FPG2", "NOEU=NOEU", "FPG1=FPG1", "GANO=FPG2"),
            mater=("RIGI", "GANO", "FPG1"),
        ),
