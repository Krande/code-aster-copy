...
from cataelem.Elements.meca_d_plan_hho444 import MECA_DPQ9_HHO444
from cataelem.Tools.base_objects import ElrefeLoc, SetOfNodes

# ------------------------------------------------------------


class MECA_AXQ9_HHO444(MECA_DPQ9_HHO444):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU9,
            gauss=("RIGI=FPG25", "FPG1=FPG1", "MTGA=FPG25", "MASS=FPG25"),
...
class MECA_AXT7_HHO444(MECA_AXQ9_HHO444):
    """Please document this element"""
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR7,
            gauss=("RIGI=FPG19", "FPG1=FPG1", "MTGA=FPG19", "MASS=FPG19"),
            mater=("RIGI", "FPG1", "MTGA", "MASS"),
        ),
    )
