...
class LCS2S2C(Element):
    ...
    meshType = MT.SEG22
    nodes = (SetOfNodes("EN1", (2,)), SetOfNodes("EN2", (1, 3, 4)))
    calculs = (
        OP.RIGI_CONT(
            te=567,
            para_in=(
...
class LCS2S3C(LCS2S2C):
    ...
    meshType = MT.SEG23
    nodes = (SetOfNodes("EN1", (2,)), SetOfNodes("EN2", (1, 3, 4, 5)))
...
class LCS3S2C(LCS2S2C):
    ...
    meshType = MT.SEG32
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5)))
...
class LCS2S2D(LCS2S2C):
    ...
    meshType = MT.SEG22
    nodes = (SetOfNodes("EN1", (1,)), SetOfNodes("EN2", (2, 3, 4)))
...
class LCS2S3D(LCS2S2C):
    ...
    meshType = MT.SEG23
    nodes = (SetOfNodes("EN1", (1,)), SetOfNodes("EN2", (2, 3, 4, 5)))
