...
MFORCEF = LocatedComponents(
    phys=PHY.FORC_F, type="ELEM", components=("FX", "FY", "MZ", "REP", "ALPHA", "BETA", "GAMMA")
)


MFORCER = LocatedComponents(
    phys=PHY.FORC_R, type="ELEM", components=("FX", "FY", "MZ", "REP", "ALPHA", "BETA", "GAMMA")
)
...
class FORCE_NOD_COQ2D(Element):
    ...
    calculs = (
        OP.CHAR_MECA_FORC_F(
            te=1,
            para_in=((SP.PFORNOF, MFORCEF), (SP.PGEOMER, MGEOMER), (SP.PINSTR, LC.MTEMPSR)),
