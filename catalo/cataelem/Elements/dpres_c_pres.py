...
DDL_ACOU = LocatedComponents(
    phys=PHY.PRES_C, type="ELNO", diff=True, components=(("EN1", ("LAGR",)), ("EN2", ("PRES",)))
)
...
class DPRES_C_PRES(Element):
    ...
    calculs = (
        OP.ACOU_DDLI_C(
            te=2, para_in=((SP.PDDLIMC, LC.MDDLIMC),), para_out=((SP.PVECTTC, MVECTTC),)
        ),
        OP.ACOU_DDLI_F(
            te=2,
        ...
        OP.ACOU_DDLM_C(te=2, para_in=((SP.PDDLMUC, MDDLMUC),), para_out=((SP.PMATTTC, MMATTTC),)),
    )
