...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "DZ", "PRE1")), ("EN2", ("DX", "DY", "DZ"))),
)
...
class HM_HEXA20(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20,
            gauss=("RIGI=FPG27", "MASS=FPG27", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
...
class HM_PENTA15(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15,
            gauss=("RIGI=FPG21", "MASS=FPG21", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
...
class HM_PYRAM13(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P13,
            gauss=("RIGI=FPG10", "MASS=FPG10", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
...
class HM_TETRA10(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG15", "MASS=FPG15", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
...
class HM_HEXA20S(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20,
            gauss=("RIGI=FPG8NOS", "MASS=FPG8", "NOEU_S=NOEU_S", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
...
class HM_PENTA15S(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15,
            gauss=("RIGI=FPG6NOS", "MASS=FPG6", "NOEU_S=NOEU_S", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
...
class HM_TETRA10S(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG4NOS", "MASS=FPG4", "NOEU_S=NOEU_S", "FPG1=FPG1", "NOEU=NOEU"),
            mater=("RIGI", "FPG1"),
        ),
