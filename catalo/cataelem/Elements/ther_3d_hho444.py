...
# --------------------------------------------------------------------------------------------------
class THER3DH27_HHO444(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H27,
            gauss=("RIGI=FPG125", "FPG1=FPG1", "MASS=FPG125", "MTGA=FPG125"),
...
# --------------------------------------------------------------------------------------------------
class THER3DT15_HHO444(THER3DH27_HHO444):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T15,
            gauss=("RIGI=FPG46", "FPG1=FPG1", "MASS=FPG46", "MTGA=FPG46"),
            mater=("RIGI", "FPG1", "MTGA", "MASS"),
        ),
    )
...
# --------------------------------------------------------------------------------------------------
class THER3DP21_HHO444(THER3DH27_HHO444):
...
# --------------------------------------------------------------------------------------------------
class THER3DP19_HHO444(THER3DH27_HHO444):
