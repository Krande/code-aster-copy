...
CCACOQU  = LocatedComponents(phys=PHY.CACOQU_R, type='ELEM',
    ...
    calculs = (
        ...
        OP.CHAR_MECA_EPSI_F(te=35,
            para_in =( (SP.PCACOQU, CCACOQU), (SP.PEPSINF, CEPSINF),
                       (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
                       (OP.CHAR_MECA_EPSI_F.PNBSP_I, ENBSP_I), (OP.CHAR_MECA_EPSI_F.PVARCPR, LC.ZVARCPG),
                       (SP.PTEMPSR, CTEMPSR), ),
            para_out=( (SP.PVECTUR, MVECTUR), ),
        ),
        ...
        OP.ENEL_ELEM(te=412,
            para_in =( (SP.PCACOQU, CCACOQU), (OP.ENEL_ELEM.PCOMPOR, LC.CCOMPOR),
        ...
        OP.ENEL_ELGA(te=412,
            para_in =( (SP.PCACOQU, CCACOQU), (OP.ENEL_ELGA.PCOMPOR, LC.CCOMPOR),
        ...
        OP.REPERE_LOCAL(te=134,
            para_in =( (SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER), ),
            para_out=( (OP.REPERE_LOCAL.PMATPASS, ECHGREP), (SP.PREPLO1, LC.CGEOM3D),
        ...
        OP.RIGI_GEOM(te=428,
            para_in =( (SP.PCACOQU, CCACOQU), (OP.RIGI_GEOM.PCONTRR, ECONTPG),
        ...
        OP.RIGI_MECA_TANG(te=31,
            para_in =( (SP.PCACOQU, CCACOQU), (SP.PCARCRI, LC.CCARCRI),
                       ...
                       (OP.RIGI_MECA_TANG.PNBSP_I, ENBSP_I), (OP.RIGI_MECA_TANG.PVARIMR, ZVARIPG), ),
        ...
        OP.TOU_INI_ELEM(te=99,
            para_out=( (OP.TOU_INI_ELEM.PNEUT_F, ELNEUT_F), (SP.PNEU1_R, ENEU1_R),
                       (OP.TOU_INI_ELEM.PGEOM_R, LC.CGEOM3D), (OP.TOU_INI_ELEM.PNBSP_I, ENBSP_I),
