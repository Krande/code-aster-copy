...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "DZ", "DAMG")), ("EN2", ("DX", "DY", "DZ"))),
)
...
EREFCO = LocatedComponents(phys=PHY.PREC, type="ELEM", components=("SIGM", "VARI"))
...
ECONTNC = LocatedComponents(
    phys=PHY.SIEF_C,
    type="ELNO",
    components=("SIXX", "SIYY", "SIZZ", "SIXY", "SIXZ", "SIYZ", "DISS"),
)
