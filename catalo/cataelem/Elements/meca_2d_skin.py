...
class MEPLSE2(Element):
    ...
    calculs = (
        ...
        OP.CALC_K_G(te=147,
            para_in  = ((SP.PDEPLAR, DDL_MECA),(OP.CALC_K_G.PBASLOR, LC.N6NEUT_R),
                        (SP.PFR1D2D, LC.NFOR2DR), (SP.PGEOMER, LC.EGEOM2D),
                        (SP.PPRESSR, LC.EPRE2DR),
        ...
        OP.CALC_K_G_F(te=147,
            para_in  = ((SP.PDEPLAR, DDL_MECA), (SP.PFF1D2D, LC.CFOR2DF),
                        (SP.PGEOMER, LC.EGEOM2D),(OP.CALC_K_G_F.PBASLOR, LC.N6NEUT_R),
