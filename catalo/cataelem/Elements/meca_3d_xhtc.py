...
DDL_MECA = LocatedComponents(
    ...
    diff=True,
    components=(
        ("EN1", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "K1", "K2", "K3", "LAGS_C", "LAGS_F[2]")),
        ("EN3", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "K1", "K2", "K3")),
    ),
)
...
EDEPLPG = LocatedComponents(
    ...
    type="ELGA",
    location="XFEM",
    components=("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "K1", "K2", "K3", "LAGS_C", "LAGS_F[2]"),
)
...
DDL_MECC = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "DZ")), ("EN3", ("DX", "DY", "DZ"))),
)
...
class MECA_XHTC_TETRA4(MECA_XHTC_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "NOEU=NOEU", "XINT=FPG15", "XGEO=FPG5", "FPG1=FPG1", "XFEM=XFEM90"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(
            MT.TR3,
...
class MECA_XHTC_PY13(MECA_XHTC_HEXA8):
    ...
    meshType = MT.PYRAM13
    nodes = (SetOfNodes("EN1", (1, 2, 3, 4, 5)), SetOfNodes("EN3", (6, 7, 8, 9, 10, 11, 12, 13)))
    elrefe = (
        ElrefeLoc(
            MT.P13,
...
class MECA_XHTC_TE10(MECA_XHTC_HEXA8):
    ...
    meshType = MT.TETRA10
    nodes = (SetOfNodes("EN1", (1, 2, 3, 4)), SetOfNodes("EN3", (5, 6, 7, 8, 9, 10)))
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG5", "NOEU=NOEU", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG15", "XGEO=FPG5", "NOEU=NOEU")),
        ElrefeLoc(MT.T10, gauss=("XINT=FPG15", "XGEO=FPG5", "NOEU=NOEU")),
