...
# ------------------------------------------------------------
class MEDPQU8(Element):
    """Mechanics - Plane strain - QUAD8"""
...
# ------------------------------------------------------------
class MEDPQU4(MEDPQU8):
    """Mechanics - Plane strain - QUAD4"""
...
# ------------------------------------------------------------
class MEDPTR3(MEDPQU8):
    """Mechanics - Plane strain - TRIA3"""
...
# ------------------------------------------------------------
class MEDPTR6(MEDPQU8):
    """Mechanics - Plane strain - TRIA6"""
