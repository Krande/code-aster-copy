...
#                     (SP.PFFVOLU, CFORCEF),
        ...
        OP.INDL_ELGA(te=30,
            para_in=((OP.INDL_ELGA.PCOMPOR, LC.CCOMPOR), (OP.INDL_ELGA.PCONTPR, ECONTPG),
        ...
        OP.PDIL_ELGA(te=511,
            para_in=((OP.PDIL_ELGA.PCOMPOR, LC.CCOMPOR), (OP.PDIL_ELGA.PCONTPR, ECONTPG),
