...
class MECA_POU_D_T(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.SE2,
            gauss=("RIGI=FPG3", "NOEU=NOEU", "FPG1=FPG1", "ARLQ_1=FPG3"),
    ...
    calculs = (
        ...
        OP.REFE_FORC_NODA(
            te=347, para_in=((SP.PREFCO, EREFCO),), para_out=((SP.PVECTUR, MVECTUR),)
        ),
        OP.REPERE_LOCAL(
            te=135,
