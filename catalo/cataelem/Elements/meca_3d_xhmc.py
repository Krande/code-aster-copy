...
DDL_MECC = LocatedComponents(phys=PHY.DEPL_R, type="ELNO", components=("DX", "DY", "DZ"))
...
EGGEOP_R = LocatedComponents(
    phys=PHY.GEOM_R, type="ELGA", location="XFEM", components=("X", "Y", "Z", "W")
)

NGEOMER = LocatedComponents(phys=PHY.GEOM_R, type="ELNO", components=("X", "Y", "Z"))

XFGEOM_R = LocatedComponents(
    phys=PHY.GEOM_R, type="ELGA", location="XFEM", components=("X", "Y", "Z")
)
...
E90NEUTR = LocatedComponents(phys=PHY.N1360R, type="ELEM", components=("X[90]",))


E24NEUTI = LocatedComponents(phys=PHY.N240_I, type="ELEM", components=("X[24]",))


E24NEUI = LocatedComponents(phys=PHY.N960_I, type="ELEM", components=("X[24]",))
...
class MECA_XH2C_HEXA8(Element):
    ...
    meshType = MT.HEXA8
    nodes = (SetOfNodes("EN2", (1, 2, 3, 4, 5, 6, 7, 8)),)
    elrefe = (
        ElrefeLoc(
            MT.HE8,
            gauss=("RIGI=FPG8", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM960"),
            mater=("RIGI", "XFEM"),
        ),
    ...
    calculs = (
        OP.CALC_G_XFEM(
            te=288,
            para_in=(
                (OP.CALC_G_XFEM.PAINTER, E90NEUTR),
                (OP.CALC_G_XFEM.PBASECO, LC.E162NEUR),
                (OP.CALC_G_XFEM.PBASLOR, LC.N9NEUT_R),
                (OP.CALC_G_XFEM.PCFACE, LC.E54NEUTI),
                (OP.CALC_G_XFEM.PCNSETO, LC.E512NEUI),
                (OP.CALC_G_XFEM.PCOMPOR, LC.CCOMPOR),
                (SP.PDEPLAR, DDL_MECA),
                (SP.PFRVOLU, NFORCER),
                (SP.PGEOMER, NGEOMER),
                (OP.CALC_G_XFEM.PHEAVTO, LC.E128NEUI),
                ...
                (OP.CALC_G_XFEM.PPINTER, LC.E54NEUTR),
                (OP.CALC_G_XFEM.PPINTTO, LC.E132NEUR),
                (SP.PPRESSR, EPRESNO),
        ...
        OP.CALC_G_XFEM_F(
            te=288,
            para_in=(
                (OP.CALC_G_XFEM_F.PAINTER, E90NEUTR),
                (OP.CALC_G_XFEM_F.PBASECO, LC.E162NEUR),
                (OP.CALC_G_XFEM_F.PBASLOR, LC.N9NEUT_R),
                (OP.CALC_G_XFEM_F.PCFACE, LC.E54NEUTI),
                (OP.CALC_G_XFEM_F.PCNSETO, LC.E512NEUI),
                (OP.CALC_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                (SP.PCOURB, LC.G27NEUTR),
                (SP.PDEPLAR, DDL_MECA),
                (SP.PFFVOLU, CFORCEF),
                (SP.PGEOMER, NGEOMER),
                (OP.CALC_G_XFEM_F.PHEAVTO, LC.E128NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (SP.PPESANR, LC.CPESANR),
                (OP.CALC_G_XFEM_F.PPINTER, LC.E54NEUTR),
                (OP.CALC_G_XFEM_F.PPINTTO, LC.E132NEUR),
                (SP.PPRESSF, CPRESSF),
                (SP.PROTATR, LC.CROTATR),
                (SP.PINSTR, CTEMPSR),
                (SP.PTHETAR, DDL_MECC),
        ...
        OP.CALC_K_G_XFEM(
            te=297,
            para_in=(
                (OP.CALC_K_G_XFEM.PAINTER, E90NEUTR),
                (OP.CALC_K_G_XFEM.PBASECO, LC.E162NEUR),
                (OP.CALC_K_G_XFEM.PBASLOR, LC.N9NEUT_R),
                (OP.CALC_K_G_XFEM.PCFACE, LC.E54NEUTI),
                (OP.CALC_K_G_XFEM.PCNSETO, LC.E512NEUI),
                (OP.CALC_K_G_XFEM.PCOMPOR, LC.CCOMPOR),
                (SP.PCOURB, LC.G27NEUTR),
                (SP.PDEPLAR, DDL_MECA),
                (SP.PFRVOLU, NFORCER),
                (SP.PGEOMER, NGEOMER),
                (OP.CALC_K_G_XFEM.PHEAVTO, LC.E128NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (SP.PPESANR, LC.CPESANR),
                (OP.CALC_K_G_XFEM.PPINTER, LC.E54NEUTR),
                (OP.CALC_K_G_XFEM.PPINTTO, LC.E132NEUR),
                (SP.PPRESSR, EPRESNO),
        ...
        OP.CALC_K_G_XFEM_F(
            te=297,
            para_in=(
                (OP.CALC_K_G_XFEM_F.PAINTER, E90NEUTR),
                (OP.CALC_K_G_XFEM_F.PBASECO, LC.E162NEUR),
                (OP.CALC_K_G_XFEM_F.PBASLOR, LC.N9NEUT_R),
                (OP.CALC_K_G_XFEM_F.PCFACE, LC.E54NEUTI),
                (OP.CALC_K_G_XFEM_F.PCNSETO, LC.E512NEUI),
                (OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                (SP.PCOURB, LC.G27NEUTR),
                (SP.PDEPLAR, DDL_MECA),
                (SP.PFFVOLU, CFORCEF),
                (SP.PGEOMER, NGEOMER),
                (OP.CALC_K_G_XFEM_F.PHEAVTO, LC.E128NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (SP.PPESANR, LC.CPESANR),
                (OP.CALC_K_G_XFEM_F.PPINTER, LC.E54NEUTR),
                (OP.CALC_K_G_XFEM_F.PPINTTO, LC.E132NEUR),
                (SP.PPRESSF, CPRESSF),
                (SP.PPULPRO, LC.CFREQR),
                (SP.PROTATR, LC.CROTATR),
                (SP.PINSTR, CTEMPSR),
        ...
        OP.CHAR_MECA_CONT(
            te=534,
            para_in=(
                (OP.CHAR_MECA_CONT.PAINTER, E90NEUTR),
                (OP.CHAR_MECA_CONT.PBASECO, LC.E162NEUR),
                (OP.CHAR_MECA_CONT.PCFACE, LC.E54NEUTI),
                (SP.PCOHES, LC.E1NEUTR),
                (SP.PDEPL_M, DDL_MECA),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                ...
                (OP.CHAR_MECA_CONT.PHEA_FA, E24NEUTI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_CONT.PPINTER, LC.E54NEUTR),
        ...
        OP.CHAR_MECA_ROTA_R(
            te=441,
            para_in=(
                (OP.CHAR_MECA_ROTA_R.PCNSETO, LC.E512NEUI),
                (SP.PDEPLMR, DDL_MECA),
                (SP.PDEPLPR, DDL_MECA),
                (SP.PGEOMER, NGEOMER),
                (OP.CHAR_MECA_ROTA_R.PHEAVTO, LC.E128NEUI),
                (OP.CHAR_MECA_ROTA_R.PLONCHA, LC.E10NEUTI),
                (OP.CHAR_MECA_ROTA_R.PLSN, LC.N1NEUT_R),
                (OP.CHAR_MECA_ROTA_R.PLST, LC.N1NEUT_R),
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_ROTA_R.PPINTTO, LC.E132NEUR),
                (SP.PROTATR, LC.CROTATR),
        ...
        OP.COOR_ELGA(
            te=481,
            para_in=(
                (OP.COOR_ELGA.PCNSETO, LC.E512NEUI),
                (SP.PGEOMER, NGEOMER),
                (OP.COOR_ELGA.PLONCHA, LC.E10NEUTI),
                (OP.COOR_ELGA.PPINTTO, LC.E132NEUR),
            ),
        ...
        OP.DEPL_XPG(
            ...
            para_in=(
                ...
                (SP.PDEPLNO, DDL_MECA),
                (OP.DEPL_XPG.PHEAVTO, LC.E128NEUI),
        ...
        OP.ENEL_ELEM(
            te=565,
            para_in=(
                (OP.ENEL_ELEM.PCNSETO, LC.E512NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.ENEL_ELEM.PPINTTO, LC.E132NEUR),
        ...
        OP.FORC_NODA(
            ...
            para_in=(
                ...
                (OP.FORC_NODA.PCNSETO, LC.E512NEUI),
                ...
                (OP.FORC_NODA.PPINTTO, LC.E132NEUR),
        ...
        OP.FULL_MECA(
            ...
            para_in=(
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.FULL_MECA.PPINTTO, LC.E132NEUR),
        ...
        OP.RAPH_MECA(
            ...
            para_in=(
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.RAPH_MECA.PPINTTO, LC.E132NEUR),
        ...
        OP.RIGI_CONT(
            te=533,
            para_in=(
                (OP.RIGI_CONT.PAINTER, E90NEUTR),
                (OP.RIGI_CONT.PBASECO, LC.E162NEUR),
                (OP.RIGI_CONT.PCFACE, LC.E54NEUTI),
                (SP.PCOHES, LC.E1NEUTR),
                (SP.PDEPL_M, DDL_MECA),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.RIGI_CONT.PPINTER, LC.E54NEUTR),
        ...
        OP.RIGI_MECA_TANG(
            ...
            para_in=(
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.RIGI_MECA_TANG.PPINTTO, LC.E132NEUR),
        ...
        OP.TOPOFA(
            te=510,
            para_in=(
                (OP.TOPOFA.PAINTTO, LC.E220NEUR),
                (OP.TOPOFA.PCNSETO, LC.E512NEUI),
                (SP.PDECOU, E1NEUTK),
            ...
            para_out=(
                (OP.TOPOFA.PAINTER, E90NEUTR),
                (OP.TOPOFA.PBASECO, LC.E162NEUR),
                (OP.TOPOFA.PCFACE, LC.E54NEUTI),
                (SP.PGESCLA, LC.E54NEUTR),
                (OP.TOPOFA.PHEAVFA, E24NEUI),
        ...
        OP.TOPONO(
            te=120,
            para_in=(
                (OP.TOPONO.PCNSETO, LC.E512NEUI),
                (SP.PFISCO, LC.FISCO_I),
                (OP.TOPONO.PFISNO, LC.FISNO_I),
                (OP.TOPONO.PHEAVFA, E24NEUI),
        ...
        OP.TOPOSE(
            ...
            para_out=(
                (OP.TOPOSE.PAINTTO, LC.E220NEUR),
                (OP.TOPOSE.PCNSETO, LC.E512NEUI),
        ...
        OP.XCVBCA(
            te=532,
            para_in=(
                (OP.XCVBCA.PAINTER, E90NEUTR),
                (OP.XCVBCA.PBASECO, LC.E162NEUR),
                (OP.XCVBCA.PCFACE, LC.E54NEUTI),
                (SP.PCOHES, LC.E1NEUTR),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                ...
                (OP.XCVBCA.PPINTER, LC.E54NEUTR),
            ),
            para_out=(
                (OP.XCVBCA.PCOHESO, LC.E1NEUTR),
        ...
        OP.XFEM_XPG(
            te=46,
            para_in=(
                (OP.XFEM_XPG.PCNSETO, LC.E512NEUI),
                (SP.PGEOMER, NGEOMER),
                (OP.XFEM_XPG.PHEAVTO, LC.E128NEUI),
        ...
        OP.XREACL(
            te=548,
            para_in=(
                (OP.XREACL.PAINTER, E90NEUTR),
                (OP.XREACL.PBASECO, LC.E162NEUR),
                (OP.XREACL.PCFACE, LC.E54NEUTI),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                (SP.PGEOMER, NGEOMER),
...
class MECA_XH3C_HEXA8(MECA_XH2C_HEXA8):
    ...
    meshType = MT.HEXA8
    nodes = (SetOfNodes("EN3", (1, 2, 3, 4, 5, 6, 7, 8)),)
    elrefe = (
        ElrefeLoc(
            MT.HE8,
            gauss=("RIGI=FPG8", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM1440"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH4C_HEXA8(MECA_XH2C_HEXA8):
    ...
    meshType = MT.HEXA8
    nodes = (SetOfNodes("EN4", (1, 2, 3, 4, 5, 6, 7, 8)),)
    elrefe = (
        ElrefeLoc(
            MT.HE8,
            gauss=("RIGI=FPG8", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM1920"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH2C_PENTA6(MECA_XH2C_HEXA8):
    ...
    meshType = MT.PENTA6
    nodes = (SetOfNodes("EN2", (1, 2, 3, 4, 5, 6)),)
    elrefe = (
        ElrefeLoc(
            MT.PE6,
            gauss=("RIGI=FPG6", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM480"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH3C_PENTA6(MECA_XH2C_HEXA8):
    ...
    meshType = MT.PENTA6
    nodes = (SetOfNodes("EN3", (1, 2, 3, 4, 5, 6)),)
    elrefe = (
        ElrefeLoc(
            MT.PE6,
            gauss=("RIGI=FPG6", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM720"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH4C_PENTA6(MECA_XH2C_HEXA8):
    ...
    meshType = MT.PENTA6
    nodes = (SetOfNodes("EN4", (1, 2, 3, 4, 5, 6)),)
    elrefe = (
        ElrefeLoc(
            MT.PE6,
            gauss=("RIGI=FPG6", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM960"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH2C_PYRAM5(MECA_XH2C_HEXA8):
    ...
    meshType = MT.PYRAM5
    nodes = (SetOfNodes("EN2", (1, 2, 3, 4, 5)),)
    elrefe = (
        ElrefeLoc(
            MT.PY5,
            gauss=("RIGI=FPG5", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM360"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH3C_PYRAM5(MECA_XH2C_HEXA8):
    ...
    meshType = MT.PYRAM5
    nodes = (SetOfNodes("EN3", (1, 2, 3, 4, 5)),)
    elrefe = (
        ElrefeLoc(
            MT.PY5,
            gauss=("RIGI=FPG5", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM540"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH4C_PYRAM5(MECA_XH2C_HEXA8):
    ...
    meshType = MT.PYRAM5
    nodes = (SetOfNodes("EN4", (1, 2, 3, 4, 5)),)
    elrefe = (
        ElrefeLoc(
            MT.PY5,
            gauss=("RIGI=FPG5", "FPG1=FPG1", "NOEU=NOEU", "XFEM=XFEM720"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG5", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH2C_TETRA4(MECA_XH2C_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "FPG1=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM180"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(
            MT.TR3,
...
class MECA_XH3C_TETRA4(MECA_XH2C_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "FPG1=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM270"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(
            MT.TR3,
...
class MECA_XH4C_TETRA4(MECA_XH2C_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "FPG1=FPG1", "NOEU=NOEU", "XINT=FPG5", "XFEM=XFEM360"),
            mater=("RIGI", "XFEM"),
        ),
        ElrefeLoc(
            MT.TR3,
