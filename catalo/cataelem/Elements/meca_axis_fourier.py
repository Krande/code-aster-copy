...
class MEFOQU4(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU4,
            gauss=("RIGI=FPG4", "MASS=FPG4", "NOEU_S=NOEU_S", "FPG1=FPG1"),
            mater=("RIGI", "FPG1"),
        ),
    ...
    calculs = (
        ...
        OP.EPSI_ELGA(
            te=114,
            para_in=((SP.PDEPLAR, DDL_MECA), (SP.PGEOMER, NGEOMER), (SP.PHARMON, LC.CHARMON)),
...
class MEFOQU8(MEFOQU4):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU8,
            gauss=("RIGI=FPG9", "MASS=FPG9", "NOEU_S=NOEU_S", "FPG1=FPG1"),
            mater=("RIGI", "FPG1"),
        ),
...
class MEFOTR3(MEFOQU4):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR3,
            gauss=("RIGI=FPG1", "MASS=FPG3", "NOEU_S=NOEU_S", "FPG1=FPG1"),
            mater=("RIGI", "FPG1"),
        ),
        ElrefeLoc(MT.SE2, gauss=("RIGI=FPG2",)),
    )
...
class MEFOTR6(MEFOQU4):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR6,
            gauss=("RIGI=FPG3", "MASS=FPG6", "NOEU_S=NOEU_S", "FPG1=FPG1"),
            mater=("RIGI", "FPG1"),
        ),
        ElrefeLoc(MT.SE3, gauss=("RIGI=FPG4",)),
    )
