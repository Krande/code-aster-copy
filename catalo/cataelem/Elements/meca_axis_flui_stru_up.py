...
# ----------------------------------------------------------------------------------------------
class MEAXFSS2P(Element):
    """Element for FSI interaction (U,P) - Axisymmetric - On SE2"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFSS3P(MEAXFSS2P):
    """Element for FSI interaction (U,P) - Axisymmetric - On SE3"""
