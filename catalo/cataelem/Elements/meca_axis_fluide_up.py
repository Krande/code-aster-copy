...
# ----------------------------------------------------------------------------------------------
class MEAXFLQ4P(Element):
    """Element for fluid (U,P) - Axisymmetric - On QU4"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLQ8P(MEAXFLQ4P):
    """Element for fluid (U,P) - Axisymmetric - On QU8"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLQ9P(MEAXFLQ4P):
    """Element for fluid (U,P) - Axisymmetric - On QU9"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLT3P(MEAXFLQ4P):
    """Element for fluid (U,P) - Axisymmetric - On TR3"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLT6P(MEAXFLQ4P):
    """Element for fluid (U,P) - Axisymmetric - On TR6"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLS2P(Element):
    """Element for fluid (U,P) - Axisymmetric/Boundary - On SE2"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLS3P(MEAXFLS2P):
    """Element for fluid (U,P) - Axisymmetric/Boundary - On SE3"""
