...
DDL_MECA = LocatedComponents(
    ...
    components=(
        ...
        # Master nodes - HHO
        ("EN2", ()),
        ("EN3", ("HHO_FX[3]", "HHO_FY[3]", "HHO_FZ[3]")),
    ),
)
...
# ------------------------------------------------------------
class CP_Q8Q9_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_Q9Q9_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_T3Q9_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_T6Q9_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_Q4T7_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_Q8T7_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_Q9T7_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_T3T7_HHO1(CP_Q4Q9_HHO1):
    """
...
# ------------------------------------------------------------
class CP_T6T9_HHO1(CP_Q4Q9_HHO1):
    """
