...
NDEPLAC = LocatedComponents(phys=PHY.DEPL_C, type="ELNO", components=("PRES", "PHI"))
...
class MEFLQU4(Element):
    """Element for fluid (U,P,PHI) - 2D - On QU4"""
...
class MEFLQU8(MEFLQU4):
    """Element for fluid (U,P,PHI) - 2D - On QU8"""
...
class MEFLQU9(MEFLQU4):
    """Element for fluid (U,P,PHI) - 2D - On QU9"""
...
class MEFLTR3(MEFLQU4):
    """Element for fluid (U,P,PHI) - 2D - On TR3"""
...
class MEFLTR6(MEFLQU4):
    """Element for fluid (U,P,PHI) - 2D - On TR6"""
...
class MEFLSE3(MEFLSE2):
    """Element for fluid (U,P,PHI) - 2D/Boundary - On SE3"""
