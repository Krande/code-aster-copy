...
CEPSINO  = LocatedComponents(phys=PHY.EPSI_R, type='ELEM',
    components=('EPXX','EPYY','EPZZ','EPXY','EPXZ',
          'EPYZ',))
    ...
    calculs = (
        ...
        OP.CALC_G(te=222,
            para_in=((SP.PACCELE, NDEPLAR), (OP.CALC_G.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PSIGINR, ESIGMNO), (OP.CALC_G.PTHETAR, LC.ETHETA),
        ...
        OP.CALC_G_F(te=222,
            para_in=((SP.PACCELE, NDEPLAR), (OP.CALC_G_F.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PVITESS, NDEPLAR), (OP.CALC_G_F.PDEG, LC.E1NEUTI),
        ...
        OP.CALC_K_G(te=222,
            para_in=((OP.CALC_K_G.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PSIGINR, ESIGMNO), (OP.CALC_K_G.PTHETAR, LC.ETHETA),
        ...
        OP.CALC_G_XFEM(te=27,
            para_in=((SP.PACCELE, NDEPLAR), (OP.CALC_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (SP.PCONTGR, ESIGMPG), (OP.CALC_G_XFEM.PCONTRR, ESIGMPG),
                     (SP.PDEFOPL, EDEFONO), (SP.PDEPINR, NDEPLAR),
                     (SP.PDEPLAR, NDEPLAR), (SP.PEPSINR, CEPSINO),
                     (SP.PFRVOLU, NFORCER), (SP.PGEOMER, NGEOMER),
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGINR, ESIGMNO),
                     (SP.PTHETAR, NDEPLAR), (OP.CALC_G_XFEM.PVARCPR, LC.ZVARCPG),
        ...
        OP.CALC_G_XFEM_F(te=27,
            para_in=((SP.PACCELE, NDEPLAR), (OP.CALC_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PCONTGR, ESIGMPG), (OP.CALC_G_XFEM_F.PCONTRR, ESIGMPG),
                     (SP.PDEFOPL, EDEFONO), (SP.PDEPINR, NDEPLAR),
                     (SP.PDEPLAR, NDEPLAR), (SP.PEPSINF, CEPSINF),
                     (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     ...
                     (OP.CALC_G_XFEM_F.PVARIPR, LC.ZVARINO), (SP.PVITESS, NDEPLAR),
                     ),
            para_out=((SP.PGTHETA, LC.EGTHETA), ),
        ),
        ...
        OP.CALC_K_G_XFEM_F(te=295,
            para_in=((OP.CALC_K_G_XFEM_F.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     ...
                     (SP.PPULPRO, LC.CFREQR), (SP.PROTATR, LC.CROTATR),
                     (SP.PSIGINR, ESIGMNO), (SP.PTEMPSR, CTEMPSR),
                     (SP.PTHETAR, NDEPLAR), (OP.CALC_K_G_XFEM_F.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), ),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),
