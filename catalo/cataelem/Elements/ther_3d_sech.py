...
# --------------------------------------------------------------------------------------------------
class SECH_PENTA15(SECH_HEXA20):
    """Drying - 3D - PENTA15"""
...
# --------------------------------------------------------------------------------------------------
class SECH_PYRAM13(SECH_HEXA20):
    """Drying - 3D - PYRAM13"""
    ...
    calculs = (OP.CHAR_THER_GRAI_F(te=-1), OP.CHAR_THER_GRAI_R(te=-1))


# --------------------------------------------------------------------------------------------------
class SECH_PYRAM5(SECH_HEXA20):
    """Drying - 3D - PYRAM5"""
...
# --------------------------------------------------------------------------------------------------
class SECH_TETRA10(SECH_HEXA20):
    """Drying - 3D - TETRA10"""
