...
# Ce catalogue correspondant aux elements fluides lineaires massifs en 2D
...
# ----------------------------------------------------------------------------------------------
class MEFLQU4PSI(Element):
    """Element for fluid (U,PSI) - 2D - On QU4"""
...
# ----------------------------------------------------------------------------------------------
class MEFLQU8PSI(MEFLQU4PSI):
    """Element for fluid (U,PSI) - 2D - On QU8"""
...
# ----------------------------------------------------------------------------------------------
class MEFLQU9PSI(MEFLQU4PSI):
    """Element for fluid (U,PSI) - 2D - On QU9"""
...
# ----------------------------------------------------------------------------------------------
class MEFLTR3PSI(MEFLQU4PSI):
    """Element for fluid (U,PSI) - 2D - On TR3"""
...
# ----------------------------------------------------------------------------------------------
class MEFLTR6PSI(MEFLQU4PSI):
    """Element for fluid (U,PSI) - 2D - On TR6"""
...
# ----------------------------------------------------------------------------------------------
class MEFLSE2PSI(Element):
    """Element for fluid (U,PSI) - 2D/Boundary - On SE2"""
...
# ----------------------------------------------------------------------------------------------
class MEFLSE3PSI(MEFLSE2PSI):
    """Element for fluid (U,PSI) - 2D/Boundary - On SE3"""
