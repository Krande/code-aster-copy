...
class PR_G_QUAD8(Element):
    ...
    meshType = MT.QUAD8
    elrefe = (ElrefeLoc(MT.QU8, gauss=("NOEU=NOEU", "RIGI=FPG9")),)
    calculs = (
        OP.GRAD_NEUT_R(
            te=24,
...
class PR_G_QUAD4(PR_G_QUAD8):
    ...
    meshType = MT.QUAD4
    elrefe = (ElrefeLoc(MT.QU4, gauss=("NOEU=NOEU", "RIGI=FPG4")),)
...
class PR_G_TRIA6(PR_G_QUAD8):
    ...
    meshType = MT.TRIA6
    elrefe = (ElrefeLoc(MT.TR6, gauss=("NOEU=NOEU", "RIGI=FPG3")),)
...
class PR_G_TRIA3(PR_G_QUAD8):
    ...
    meshType = MT.TRIA3
    elrefe = (ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU", "RIGI=FPG3")),)
