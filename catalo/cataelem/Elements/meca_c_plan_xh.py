...
DDL_MECA = LocatedComponents(
    phys=PHY.DEPL_R, type="ELNO", diff=True, components=(("EN1", ("DX", "DY", "H1X", "H1Y")),)
)


EDEPLPG = LocatedComponents(
    phys=PHY.DEPL_R, type="ELGA", location="XFEM", components=("DX", "DY", "H1X", "H1Y")
)
...
class MECPQU4_XH(MECPTR3_XH):
    ...
    elrefe = (
        ...
        ElrefeLoc(
            MT.TR3, gauss=("RIGI=FPG3", "MASS=FPG3", "XINT=FPG12", "NOEU_S=NOEU_S", "NOEU=NOEU")
        ),
        ElrefeLoc(MT.SE2, gauss=("RIGI=FPG2", "MASS=FPG3")),
    )
