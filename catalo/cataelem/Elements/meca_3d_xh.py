...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z")),),
)
...
EDEPLPG = LocatedComponents(
    ...
    type="ELGA",
    location="XFEM",
    components=("DX", "DY", "DZ", "H1X", "H1Y", "H1Z"),
)
...
ECONTSE = LocatedComponents(phys=PHY.N1920R, type="ELEM", components=("X[1920]",))
...
ETEMXPG = LocatedComponents(
    phys=PHY.TEMP_R, type="ELGA", location="MATER", components=("TEMP", "DTX", "DTY", "DTZ")
)
...
class MECA_XH_HEXA8(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.HE8,
            gauss=("RIGI=FPG8", "MASS=FPG8", "NOEU=NOEU", "XFEM=XFEM480", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
...
class MECA_XH_PENTA6(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PE6,
            gauss=("RIGI=FPG6", "MASS=FPG6", "NOEU=NOEU", "XFEM=XFEM240", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG15", "NOEU=NOEU")),
        ElrefeLoc(
            MT.TR3,
            gauss=("FPG4=FPG4", "MASS=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12"),
        ),
    )
...
class MECA_XH_PYRAM5(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.PY5,
            gauss=("RIGI=FPG5", "MASS=FPG5", "NOEU=NOEU", "XFEM=XFEM180", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG15", "NOEU=NOEU")),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
...
class MECA_XH_TETRA4(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TE4,
            gauss=("RIGI=FPG1", "MASS=FPG1", "NOEU=NOEU", "XINT=FPG15", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH_HEXA20(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H20,
            gauss=("RIGI=FPG27", "MASS=FPG27", "NOEU=NOEU", "XFEM=XFEM480", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
        ElrefeLoc(MT.T10, gauss=("XINT=FPG15", "NOEU=NOEU")),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG15", "NOEU=NOEU")),
        ElrefeLoc(
            MT.TR6, gauss=("XINT=FPG12", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")
        ),
        ElrefeLoc(MT.TR3, gauss=("FPG4=FPG4", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")),
    )
...
class MECA_XH_PENTA15(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P15,
            gauss=("RIGI=FPG21", "MASS=FPG21", "NOEU=NOEU", "XFEM=XFEM240", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
...
class MECA_XH_PYRAM13(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P13,
            gauss=("RIGI=FPG10", "MASS=FPG10", "NOEU=NOEU", "XFEM=XFEM180", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
        ElrefeLoc(MT.T10, gauss=("XINT=FPG15", "NOEU=NOEU")),
        ElrefeLoc(
...
class MECA_XH_TETRA10(MECA_XH_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG5", "MASS=FPG5", "NOEU=NOEU", "XINT=FPG15", "XFEM=XFEM90", "FPG1=FPG1"),
            mater=("XFEM", "NOEU"),
        ),
        ElrefeLoc(MT.TE4, gauss=("XINT=FPG15", "NOEU=NOEU")),
        ElrefeLoc(
