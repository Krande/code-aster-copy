...
CEPSINF = LocatedComponents(phys=PHY.EPSI_F, type="ELEM", components=("EPXX",))
...
CFORCEF = LocatedComponents(phys=PHY.FORC_F, type="ELEM", components=("FX", "FY", "FZ", "REP"))
...
# ------------------------------------------------------------
class MEBA3DSE2(Element):
    """Nonlinear bar element in 3D physical space for SEG2"""
...
class MEBA3DSE3(MEBA3DSE2):
    """Nonlinear bar element in 3D physical space for SEG3"""

    meshType = MT.SEG3
    elrefe = (ElrefeLoc(MT.SE3, gauss=("RIGI=FPG2", "FPG1=FPG1"), mater=("RIGI", "FPG1")),)
