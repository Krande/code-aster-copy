...
CCADISA = LocatedComponents(phys=PHY.CADISA, type="ELEM", components=("A[36]",))
...
EENERR = LocatedComponents(phys=PHY.ENER_R, type="ELEM", components=("TOTALE", "DX", "DY", "DZ"))
...
EEFGEGC = LocatedComponents(
    phys=PHY.SIEF_C, type="ELGA", location="RIGI", components=("N", "VY", "VZ")
)


EEFGENC = LocatedComponents(phys=PHY.SIEF_C, type="ELNO", components=("N", "VY", "VZ"))


EEFGEGA = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("N", "VY", "VZ")
)


EEFGENO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("N", "VY", "VZ"))
