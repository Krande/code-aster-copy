...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("HHO_U[6]", "HHO_V[6]", "HHO_W[6]")), ("EN2", ()), ("EN3", ("HHO_C[30]"))),
)
...
CHHOGTH = LocatedComponents(phys=PHY.N1920R, type="ELEM", components=("X[1380]",))

CHHOGTT = LocatedComponents(phys=PHY.N1920R, type="ELEM", components=("X[1020]",))

CHHOSTH = LocatedComponents(phys=PHY.N2448R, type="ELEM", components=("X[2116]",))

CHHOSTT = LocatedComponents(phys=PHY.N2448R, type="ELEM", components=("X[1156]",))
...
class MECA3DH27_HHO222(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H27, gauss=("RIGI=FPG27", "FPG1=FPG1", "MTGA=FPG27"), mater=("RIGI", "FPG1", "MTGA")
        ),
    ...
    calculs = (
        ...
        OP.EPSI_ELGA(
            te=448,
            para_in=((SP.PCAMASS, CCAMASS), (SP.PDEPLAR, DDL_MECA), (SP.PGEOMER, NGEOMER)),
...
class MECA3DT15_HHO222(MECA3DH27_HHO222):
    ...
    elrefe = (
        ElrefeLoc(
            MT.T15, gauss=("RIGI=FPG11", "FPG1=FPG1", "MTGA=FPG11"), mater=("RIGI", "FPG1", "MTGA")
        ),
    ...
    calculs = (
        OP.FULL_MECA(
            ...
            para_in=(
                ...
                (SP.PVARIMP, ZVARIPG),
                (OP.FULL_MECA.PVARIMR, ZVARIPG),
                (OP.FULL_MECA.PCHHOGT, CHHOGTT),
                (OP.FULL_MECA.PCHHOST, CHHOSTT),
            ),
            para_out=(
                (SP.PCODRET, LC.ECODRET),
                (OP.FULL_MECA.PCONTPR, ECONTPG),
        ...
        OP.RAPH_MECA(
            ...
            para_in=(
                ...
                (SP.PVARCRR, LC.ZVARCPG),
                (OP.RAPH_MECA.PVARIMR, ZVARIPG),
                (OP.RAPH_MECA.PCHHOGT, CHHOGTT),
                (OP.RAPH_MECA.PCHHOST, CHHOSTT),
            ),
            para_out=(
                (SP.PCODRET, LC.ECODRET),
                (OP.RAPH_MECA.PCONTPR, ECONTPG),
        ...
        OP.RIGI_MECA_TANG(
            ...
            para_in=(
                ...
                (SP.PVARCRR, LC.ZVARCPG),
                (OP.RIGI_MECA_TANG.PVARIMR, ZVARIPG),
                (OP.RIGI_MECA_TANG.PCHHOGT, CHHOGTT),
                (OP.RIGI_MECA_TANG.PCHHOST, CHHOSTT),
            ),
            para_out=(
                (SP.PMATUNS, MMATUNS),
                (SP.PMATUUR, MMATUUR),
