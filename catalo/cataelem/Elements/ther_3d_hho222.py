...
class THER3DH27_HHO222(Element):
    ...
    elrefe = (
        ElrefeLoc(MT.H27, gauss=('RIGI=FPG27', 'FPG1=FPG1', 'MASS=FPG27',
                  'MTGA=FPG27',), mater=('RIGI', 'FPG1', 'MTGA', 'MASS'),),
...
class THER3DT15_HHO222(THER3DH27_HHO222):
    ...
    elrefe = (
        ElrefeLoc(MT.T15, gauss=('RIGI=FPG11', 'FPG1=FPG1', 'MASS=FPG11',
                  'MTGA=FPG11',), mater=('RIGI', 'FPG1', 'MTGA', 'MASS'),),
