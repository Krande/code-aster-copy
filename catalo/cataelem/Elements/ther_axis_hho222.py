...
from cataelem.Elements.ther_plan_hho222 import THER2DQ9_HHO222
import cataelem.Commons.mesh_types as MT


# --------------------------------------------------------------------------------------------------
class THERAXQ9_HHO222(THER2DQ9_HHO222):
...
class THERAXT7_HHO222(THERAXQ9_HHO222):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR7, gauss=("RIGI=FPG7", "FPG1=FPG1", "MASS=FPG7"), mater=("RIGI", "FPG1", "MASS")
        ),
    )
