...
ECONTNC = LocatedComponents(
    phys=PHY.SIEF_C, type="ELNO", components=("M11", "FH11X", "FH11Y", "FH11Z")
)


ECONTPG = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("M11", "FH11X", "FH11Y", "FH11Z")
)


ECONTNO = LocatedComponents(
    phys=PHY.SIEF_R, type="ELNO", components=("M11", "FH11X", "FH11Y", "FH11Z")
)
