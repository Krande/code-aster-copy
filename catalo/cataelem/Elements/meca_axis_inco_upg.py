...
class MIAXQU8(Element):
    ...
    calculs = (
        ...
        OP.CALC_K_G_XFEM(te=299,
            para_in=((OP.CALC_K_G_XFEM.PCOMPOR, LC.CCOMPOR), (SP.PDEPLAR, NDEPLAR),
                     (SP.PFISSR, LC.CFISSR), (SP.PFRVOLU, NFORCER),
                     (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
                     (SP.PPESANR, LC.CPESANR), (SP.PPULPRO, LC.CFREQR),
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGINR, ESIGMNO),
                     (SP.PTHETAR, NDEPLAR), (OP.CALC_K_G_XFEM.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), ),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),

        OP.CALC_K_G_XFEM_F(te=299,
            para_in=((OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR), (SP.PDEPLAR, NDEPLAR),
