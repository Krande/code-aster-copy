...
EGNEUT_F = LocatedComponents(phys=PHY.NEUT_F, type="ELGA", location="RIGI", components=("X[8]",))


EGNEUT_R = LocatedComponents(phys=PHY.NEUT_R, type="ELGA", location="RIGI", components=("X[8]",))
...
ECONTPG = LocatedComponents(
    ...
    type="ELGA",
    location="FPGCONT",
    components=("M11", "FH11", "M12", "FH12", "M21", "FH21", "M22", "FH22"),
)


ZVARIPG = LocatedComponents(phys=PHY.VARI_R, type="ELGA", location="FPGVARI", components=("VARI",))
...
class DHH2Q9_SUDA(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU9,
            gauss=("RIGI=NOEU_S", "FPGVARI=FPG5", "FPGCONT=FPG5", "FPG1=FPG1"),
            mater=("FPG1",),
        ),
...
class DHH2T7_SUDA(DHH2Q9_SUDA):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR7,
            gauss=("RIGI=NOEU_S", "FPGVARI=FPG4", "FPGCONT=FPG4", "FPG1=FPG1"),
            mater=("FPG1",),
        ),
