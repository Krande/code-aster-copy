...
class MECA_FACE3(Element):
    ...
    elrefe = (ElrefeLoc(MT.TR3, gauss=("RIGI=FPG3",), mater=("RIGI",)),)
    calculs = (
        OP.ACCEPTANCE(
            te=329,
            para_in=((SP.PACCELR, DDL_MECA), (SP.PGEOMER, LC.EGEOM3D), (SP.PNUMMOD, LC.CNUMMOD)),
        ...
        OP.CARA_SECT_POUT3(
            te=337, para_in=((SP.PGEOMER, LC.EGEOM3D),), para_out=((SP.PCASECT, LC.CSECT3D),)
        ),
        OP.CARA_SECT_POUT4(
            te=337,
            para_in=((SP.PGEOMER, LC.EGEOM3D), (SP.PORIGIN, LC.CGEOM3D)),
        ...
        OP.CHAR_MECA_EFON_R(
            te=18,
            para_in=((SP.PEFOND, LC.CEFOND), (SP.PGEOMER, LC.EGEOM3D), (SP.PPREFFR, LC.EPRE3DR)),
            para_out=((SP.PVECTUR, MVECTUR),),
        ),
        OP.CHAR_MECA_EFSU_F(
            te=424,
        ...
        OP.CHAR_MECA_FF2D3D(
            te=29,
            para_in=((SP.PFF2D3D, LC.CFOR3DF), (SP.PGEOMER, LC.EGEOM3D), (SP.PTEMPSR, LC.MTEMPSR)),
            para_out=((SP.PVECTUR, MVECTUR),),
        ),
        OP.CHAR_MECA_FR2D3D(
            te=28,
...
class MECA_FACE4(MECA_FACE3):
    ...
    meshType = MT.QUAD4
    attrs = ((AT.BORD_ISO, "OUI"),)
    elrefe = (ElrefeLoc(MT.QU4, gauss=("RIGI=FPG4",), mater=("RIGI",)),)
...
class MECA_FACE8(MECA_FACE3):
    ...
    meshType = MT.QUAD8
    attrs = ((AT.BORD_ISO, "OUI"),)
    elrefe = (ElrefeLoc(MT.QU8, gauss=("RIGI=FPG9",), mater=("RIGI",)),)
...
class MECA_FACE9(MECA_FACE3):
    ...
    meshType = MT.QUAD9
    attrs = ((AT.BORD_ISO, "OUI"),)
    elrefe = (ElrefeLoc(MT.QU9, gauss=("RIGI=FPG9",), mater=("RIGI",)),)
