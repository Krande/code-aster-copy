    ...
    calculs = (
        ...
        OP.CALC_G_XFEM_F(te=280,
            para_in  = ((SP.PACCELE, DDL_MECA), (SP.PDEPLAR, DDL_MECA),
                        ...
                        (OP.CALC_G_XFEM_F.PVARCPR, LC.ZVARCPG), (SP.PVITESS, DDL_MECA),),
            para_out = ((SP.PGTHETA, LC.EGTHETA),),
        ),
        ...
        OP.CALC_G(te=147,
            para_in  = ((SP.PACCELE, DDL_MECA), (SP.PDEPLAR, DDL_MECA),
                        (SP.PFR2D3D, LC.NFOR3DR), (SP.PGEOMER, LC.EGEOM3D),
                        (SP.PPRESSR, LC.EPRE3DR), (OP.CALC_G.PDEG, LC.E1NEUTI),
                        (OP.CALC_G.PTHETAR, LC.ETHETA), (OP.CALC_G.PVARCPR, LC.ZVARCPG),
        ...
        OP.CALC_G_F(te=147,
            para_in  = ((SP.PACCELE, DDL_MECA), (SP.PDEPLAR, DDL_MECA),
                        ...
                        (SP.PGEOMER, LC.EGEOM3D),(OP.CALC_G_F.PDEG, LC.E1NEUTI),
                        (SP.PTEMPSR, LC.MTEMPSR), (OP.CALC_G_F.PTHETAR, LC.ETHETA),
        ...
        OP.CALC_K_G(te=147,
            para_in  = ((OP.CALC_K_G.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G.PCOMPOR, LC.CCOMPOR),
                        ...
                        (SP.PVARCRR, LC.ZVARCPG),(OP.CALC_K_G.PDEG, LC.E1NEUTI),
                        (OP.CALC_K_G.PLAG, LC.E3NEUT_R)),
            para_out = ((SP.PGTHETA, NEWTHETA),),
        ),

        OP.CALC_K_G_F(te=147,
            para_in  = ((OP.CALC_K_G_F.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_F.PCOMPOR, LC.CCOMPOR),
                        ...
                        (SP.PROTATR, LC.CROTATR), (SP.PSIGINR, LC.ESIG3DR),
                        (SP.PTEMPSR, LC.MTEMPSR), (OP.CALC_K_G_F.PTHETAR, LC.ETHETA),
                        (OP.CALC_K_G_F.PVARCPR, LC.ZVARCPG), (SP.PVARCRR, LC.ZVARCPG),
                        (OP.CALC_K_G_F.PDEG, LC.E1NEUTI),(OP.CALC_K_G_F.PLAG, LC.E3NEUT_R)),
            para_out = ((SP.PGTHETA, NEWTHETA),),
        ),

        OP.CALC_K_G_XFEM(te=311,
