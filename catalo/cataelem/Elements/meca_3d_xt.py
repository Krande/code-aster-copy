...
DDL_MECA = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("DX", "DY", "DZ", "K1", "K2", "K3")),),
)


EDEPLPG = LocatedComponents(
    phys=PHY.DEPL_R, type="ELGA", location="XFEM", components=("DX", "DY", "DZ", "K1", "K2", "K3")
)
    ...
    calculs = (
        ...
        OP.CALC_K_G_XFEM_F(
            ...
            para_in=(
                ...
                (SP.PVARCRR, LC.ZVARCPG),
                (OP.CALC_K_G_XFEM_F.PSTANO, STANO_I),
            ),
            para_out=((SP.PGTHETA, LC.CKGTX3D),),
        ),
        OP.CHAR_MECA_FF3D3D(
        ...
        OP.CHAR_MECA_FR3D3D(
            ...
            para_in=(
                ...
                (OP.CHAR_MECA_FR3D3D.PBASLOR, LC.N9NEUT_R),
                (SP.PMATERC, LC.CMATERC),
            ),
            para_out=((SP.PVECTUR, MVECTUR),),
        ),
...
class MECA_XT_HEXA20(MECA_XT_HEXA8):
    ...
    elrefe = (
        ...
        ElrefeLoc(
            MT.TR3, gauss=("XINT=FPG12", "NOEU=NOEU", "FPG6=FPG6", "FPG7=FPG7", "XCON=FPG12")
        ),
    )
