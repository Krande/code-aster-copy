    ...
    calculs = (
        ...
        OP.FULL_MECA(te=588,
            para_in=((OP.FULL_MECA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.FULL_MECA.PCNSETO, E1280NEI),
        ...
        OP.RAPH_MECA(te=588,
            para_in=((OP.RAPH_MECA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.RAPH_MECA.PCNSETO, E1280NEI),
...
class HM_PYRAM13_XH2C(TemplateElement):
    ...
    elrefe =(
            ElrefeLoc(MT.P13, gauss = ('RIGI=FPG10','MASS=FPG10','XFEM=XFEM1080','FPG1=FPG1',), mater=('XFEM',),),
            ElrefeLoc(MT.T10, gauss = ('XINT=FPG15','NOEU=NOEU',),),
...
class HM_PYRAM13_XH3C(TemplateElement):
    ...
    elrefe =(
            ElrefeLoc(MT.P13, gauss = ('RIGI=FPG10','MASS=FPG10','XFEM=XFEM1620','FPG1=FPG1',), mater=('XFEM',),),
            ElrefeLoc(MT.T10, gauss = ('XINT=FPG15','NOEU=NOEU',),),
            ElrefeLoc(MT.PY5, gauss = ('RIGI=FPG10','MASS=FPG10',),),
            ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9',),),
            ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','MASS=FPG6','FPG4=FPG4','FPG6=FPG6','FPG3=FPG3','XCON=FPG12',),),
