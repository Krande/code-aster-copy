...
DDL_MECA = LocatedComponents(
    ...
    diff=True,
    components=(
        ("EN1", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "H2X", "H2Y", "H2Z")),
        ("EN2", ("DX", "DY", "DZ", "H1X", "H1Y", "H1Z", "H2X", "H2Y", "H2Z", "H3X", "H3Y", "H3Z")),
        (
            "EN3",
            (
                "DX",
...
class TemplateElement(Element):
    ...
    calculs = (
        ...
        OP.CHAR_MECA_CONT(
            te=557,
            para_in=(
                (OP.CHAR_MECA_CONT.PAINTER, E340NEUT),
                (OP.CHAR_MECA_CONT.PBASECO, E612NEUT),
                (OP.CHAR_MECA_CONT.PCFACE, E180NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_CONT.PPINTER, E204NEUT),
                ...
                (OP.CHAR_MECA_CONT.PHEA_FA, E60NEUTI),
                (SP.PHEAVNO, LC.FISNO_I),
        ...
        OP.CHAR_MECA_CONT_M(
            te=557,
            para_in=(
                (OP.CHAR_MECA_CONT_M.PAINTER, E340NEUT),
                (OP.CHAR_MECA_CONT_M.PBASECO, E612NEUT),
                (OP.CHAR_MECA_CONT_M.PCFACE, E180NEUI),
                ...
                (SP.PMATERC, LC.CMATERC),
                (OP.CHAR_MECA_CONT_M.PPINTER, E204NEUT),
                ...
                (OP.CHAR_MECA_CONT_M.PHEA_FA, E60NEUTI),
                (SP.PHEAVNO, LC.FISNO_I),
                (SP.PFISCO, LC.FISCO_I),
        ...
        OP.RIGI_CONT(
            te=556,
            para_in=(
                (OP.RIGI_CONT.PAINTER, E340NEUT),
                (OP.RIGI_CONT.PBASECO, E612NEUT),
                (OP.RIGI_CONT.PCFACE, E180NEUI),
                (SP.PCOHES, LC.E5NEUTR),
                (SP.PDEPL_M, DDL_MECA),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
        ...
        OP.RIGI_CONT_M(
            te=556,
            para_in=(
                (OP.RIGI_CONT_M.PAINTER, E340NEUT),
                (OP.RIGI_CONT_M.PBASECO, E612NEUT),
                (OP.RIGI_CONT_M.PCFACE, E180NEUI),
                (SP.PCOHES, LC.N5NEUTR),
                (SP.PDEPL_M, DDL_MECA),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                ...
                (OP.RIGI_CONT_M.PPINTER, E204NEUT),
        ...
        OP.TOU_INI_ELEM(
            te=99,
            para_out=((OP.TOU_INI_ELEM.PGEOM_R, LC.CGEOM3D), (OP.TOU_INI_ELEM.PNEUT_K8, E2NEUTK)),
        ),
        OP.TOU_INI_ELGA(
            te=99,
            para_out=(
        ...
        OP.XCVBCA(
            te=558,
            para_in=(
                (OP.XCVBCA.PAINTER, E340NEUT),
                (OP.XCVBCA.PBASECO, E612NEUT),
                (OP.XCVBCA.PCFACE, E180NEUI),
                (SP.PCOHES, LC.E5NEUTR),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                (SP.PGEOMER, NGEOMER),
        ...
        OP.XCVBCA_MORTAR(
            te=558,
            para_in=(
                (OP.XCVBCA_MORTAR.PAINTER, E340NEUT),
                (OP.XCVBCA_MORTAR.PBASECO, E612NEUT),
                (OP.XCVBCA_MORTAR.PCFACE, E180NEUI),
                (SP.PCOHES, LC.N5NEUTR),
                (SP.PDEPL_P, DDL_MECA),
                (SP.PDONCO, CONTX_R),
                (SP.PGEOMER, NGEOMER),
...
class HM_HEXA20_XH2C(TemplateElement):
    ...
    elrefe = (
        ...
        ElrefeLoc(
            MT.TR6,
            gauss=("RIGI=FPG6", "MASS=FPG6", "FPG4=FPG4", "FPG6=FPG6", "FPG3=FPG3", "XCON=FPG12"),
        ),
...
class HM_PYRAM13_XH2C(TemplateElement):
    ...
    meshType = MT.PYRAM13
    nodes = (SetOfNodes("EN1", (6, 7, 8, 9, 10, 11, 12, 13)), SetOfNodes("EN3", (1, 2, 3, 4, 5)))
    elrefe = (
        ElrefeLoc(
            MT.P13,
...
class HM_TETRA10_XH2C(TemplateElement):
    ...
    meshType = MT.TETRA10
    nodes = (SetOfNodes("EN1", (5, 6, 7, 8, 9, 10)), SetOfNodes("EN3", (1, 2, 3, 4)))
    elrefe = (
        ElrefeLoc(
            MT.T10,
...
class HM_PYRAM13_XH3C(TemplateElement):
    ...
    meshType = MT.PYRAM13
    nodes = (SetOfNodes("EN2", (6, 7, 8, 9, 10, 11, 12, 13)), SetOfNodes("EN4", (1, 2, 3, 4, 5)))
    elrefe = (
        ElrefeLoc(
            MT.P13,
...
class HM_TETRA10_XH3C(TemplateElement):
    ...
    meshType = MT.TETRA10
    nodes = (SetOfNodes("EN2", (5, 6, 7, 8, 9, 10)), SetOfNodes("EN4", (1, 2, 3, 4)))
    elrefe = (
        ElrefeLoc(
            MT.T10,
...
class HM_PYRAM13_XH2C3(TemplateElement):
    ...
    meshType = MT.PYRAM13
    nodes = (SetOfNodes("EN1", (6, 7, 8, 9, 10, 11, 12, 13)), SetOfNodes("EN5", (1, 2, 3, 4, 5)))
    elrefe = (
        ElrefeLoc(
            MT.P13,
            gauss=("RIGI=FPG10", "MASS=FPG10", "XFEM=XFEM1080", "FPG1=FPG1"),
...
class HM_TETRA10_XH2C3(TemplateElement):
    ...
    meshType = MT.TETRA10
    nodes = (SetOfNodes("EN1", (5, 6, 7, 8, 9, 10)), SetOfNodes("EN5", (1, 2, 3, 4)))
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG5", "MASS=FPG5", "XINT=FPG15", "XFEM=XFEM540", "FPG1=FPG1"),
...
class HM_PYRAM13_XH3C3(TemplateElement):
    ...
    meshType = MT.PYRAM13
    nodes = (SetOfNodes("EN2", (6, 7, 8, 9, 10, 11, 12, 13)), SetOfNodes("EN6", (1, 2, 3, 4, 5)))
    elrefe = (
        ElrefeLoc(
            MT.P13,
            gauss=("RIGI=FPG10", "MASS=FPG10", "XFEM=XFEM1620", "FPG1=FPG1"),
...
class HM_TETRA10_XH3C3(TemplateElement):
    ...
    meshType = MT.TETRA10
    nodes = (SetOfNodes("EN2", (5, 6, 7, 8, 9, 10)), SetOfNodes("EN6", (1, 2, 3, 4)))
    elrefe = (
        ElrefeLoc(
            MT.T10,
            gauss=("RIGI=FPG5", "MASS=FPG5", "XINT=FPG15", "XFEM=XFEM810", "FPG1=FPG1"),
