...
# ----------------------------------------------------------------------------------------------
class MEAXFLQ4PSI(Element):
    """Element for fluid (U,PSI) - Axisymmetric - On QU4"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLQ8PSI(MEAXFLQ4PSI):
    """Element for fluid (U,PSI) - Axisymmetric - On QU8"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLQ9PSI(MEAXFLQ4PSI):
    """Element for fluid (U,PSI) - Axisymmetric - On QU9"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLT3PSI(MEAXFLQ4PSI):
    """Element for fluid (U,PSI) - Axisymmetric - On TR3"""

    meshType = MT.TRIA3
    elrefe = (ElrefeLoc(MT.TR3, gauss=("RIGI=FPG3", "FPG1=FPG1"), mater=("FPG1",)),)


# ----------------------------------------------------------------------------------------------
class MEAXFLT6PSI(MEAXFLQ4PSI):
    """Element for fluid (U,PSI) - Axisymmetric - On TR6"""

    meshType = MT.TRIA6
    elrefe = (ElrefeLoc(MT.TR6, gauss=("RIGI=FPG6", "FPG1=FPG1"), mater=("FPG1",)),)


# ----------------------------------------------------------------------------------------------
class MEAXFLS2PSI(Element):
    """Element for fluid (U,PSI) - Axisymmetric/Boundary - On SE2"""
...
# ----------------------------------------------------------------------------------------------
class MEAXFLS3PSI(MEAXFLS2PSI):
    """Element for fluid (U,PSI) - Axisymmetric/Boundary - On SE3"""
