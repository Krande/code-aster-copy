...
class PR_G_HEXA20(Element):
    ...
    meshType = MT.HEXA20
    elrefe = (ElrefeLoc(MT.H20, gauss=("NOEU=NOEU", "RIGI=FPG27")),)
    calculs = (
        OP.GRAD_NEUT_R(
            te=24,
...
class PR_G_HEXA8(PR_G_HEXA20):
    ...
    meshType = MT.HEXA8
    elrefe = (ElrefeLoc(MT.HE8, gauss=("NOEU=NOEU", "RIGI=FPG8")),)
...
class PR_G_PENTA15(PR_G_HEXA20):
    ...
    meshType = MT.PENTA15
    elrefe = (ElrefeLoc(MT.P15, gauss=("NOEU=NOEU", "RIGI=FPG21")),)
...
class PR_G_PENTA6(PR_G_HEXA20):
    ...
    meshType = MT.PENTA6
    elrefe = (ElrefeLoc(MT.PE6, gauss=("NOEU=NOEU", "RIGI=FPG6")),)
...
class PR_G_TETRA10(PR_G_HEXA20):
    ...
    meshType = MT.TETRA10
    elrefe = (ElrefeLoc(MT.T10, gauss=("NOEU=NOEU", "RIGI=FPG5")),)
...
class PR_G_TETRA4(PR_G_HEXA20):
    ...
    meshType = MT.TETRA4
    elrefe = (ElrefeLoc(MT.TE4, gauss=("NOEU=NOEU", "RIGI=FPG1")),)
...
class PR_G_PYRAM13(PR_G_HEXA20):
    ...
    meshType = MT.PYRAM13
    elrefe = (ElrefeLoc(MT.P13, gauss=("NOEU=NOEU", "RIGI=FPG10")),)
...
class PR_G_PYRAM5(PR_G_HEXA20):
    ...
    meshType = MT.PYRAM5
    elrefe = (ElrefeLoc(MT.PY5, gauss=("NOEU=NOEU", "RIGI=FPG5")),)
