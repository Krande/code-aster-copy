...
ECONTNC = LocatedComponents(phys=PHY.SIEF_C, type="ELNO", components=("SIGN", "SITX", "SITY"))


ECONTPG = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("SIGN", "SITX", "SITY")
)


ECONTNO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("SIGN", "SITX", "SITY"))
...
class MEFI_HEXA8(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU4,
            gauss=("RIGI=FPG4", "MASS=FPG4", "NOEU_S=NOEU_S", "NOEU=NOEU", "FPG1=FPG1"),
            mater=("RIGI", "FPG1"),
        ),
    )
    calculs = (
...
class MEFI_PENTA6(MEFI_HEXA8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR3,
            gauss=("RIGI=FPG1", "MASS=FPG1", "NOEU_S=NOEU_S", "NOEU=NOEU", "FPG1=FPG1"),
            mater=("RIGI", "FPG1"),
        ),
    )
