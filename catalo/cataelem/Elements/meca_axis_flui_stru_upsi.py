...
DDL_MECA = LocatedComponents(phys=PHY.DEPL_R, type="ELNO", components=("DX", "DY", "PSI"))
...
# ----------------------------------------------------------------------------------------------
class MEAXFSS2PSI(Element):
    """Element for FSI interaction (U,PSI) - Axisymmetric - On SE2"""
    ...
    calculs = (
        ...
        OP.TOU_INI_ELGA(
            te=99,
            para_out=(
                (OP.TOU_INI_ELGA.PGEOM_R, LC.EGGAU2D),
...
# ----------------------------------------------------------------------------------------------
class MEAXFSS3PSI(MEAXFSS2PSI):
    """Element for FSI interaction (U,PSI) - Axisymmetric - On SE3"""
