    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, LC.E35NEUTR), (OP.CALC_G_XFEM.PBASECO, LC.E28NEUTR),
                     ...
                     (SP.PGEOMER, NGEOMER), (OP.CALC_G_XFEM.PHEAVTO, E6NEUTI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_XFEM.PPINTER, LC.E14NEUTR),
                     (OP.CALC_G_XFEM.PPINTTO, LC.E6NEUTR), (OP.CALC_G_XFEM.PPMILTO, LC.E22NEUTR),
        ...
        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, LC.E35NEUTR), (OP.CALC_G_XFEM_F.PBASECO, LC.E28NEUTR),
                     ...
                     (SP.PGEOMER, NGEOMER), (OP.CALC_G_XFEM_F.PHEAVTO, E6NEUTI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_XFEM_F.PPINTER, LC.E14NEUTR),
                     (OP.CALC_G_XFEM_F.PPINTTO, LC.E6NEUTR), (OP.CALC_G_XFEM_F.PPMILTO, LC.E22NEUTR),
        ...
        OP.REFE_FORC_NODA(te=542,
            para_in=((OP.REFE_FORC_NODA.PAINTER, LC.E35NEUTR), (OP.REFE_FORC_NODA.PBASECO, LC.E28NEUTR),
                     ...
                     (OP.REFE_FORC_NODA.PCNSETO, LC.E36NEUI), (OP.REFE_FORC_NODA.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLMR, DDL_MECA), (SP.PGEOMER, NGEOMER),
