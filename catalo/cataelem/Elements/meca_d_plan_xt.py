    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, LC.E35NEUTR), (OP.CALC_G_XFEM.PBASECO, LC.E28NEUTR),
                     ...
                     (OP.CALC_G_XFEM.PHEAVTO, E6NEUTI), (OP.CALC_G_XFEM.PLONCHA, LC.E10NEUTI),
        ...
        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, LC.E35NEUTR), (OP.CALC_G_XFEM_F.PBASECO, LC.E28NEUTR),
                     ...
                     (OP.CALC_G_XFEM_F.PHEAVTO, E6NEUTI), (OP.CALC_G_XFEM_F.PLONCHA, LC.E10NEUTI),
                     ...
                     (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_G_XFEM_F.PSTANO, STANO_I),),
            para_out=((SP.PGTHETA, LC.EGTHETA), ),
        ),
        ...
        OP.CALC_K_G_XFEM(te=297,
            para_in=((OP.CALC_K_G_XFEM.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_XFEM.PBASECO, LC.E28NEUTR),
                     ...
                     (OP.CALC_K_G_XFEM.PPINTER, LC.E14NEUTR), (OP.CALC_K_G_XFEM.PPINTTO, LC.E6NEUTR),
                     (OP.CALC_K_G_XFEM.PPMILTO, LC.E22NEUTR), (SP.PPRESSR, EPRESNO),
        ...
        OP.CALC_K_G_XFEM_F(te=297,
            para_in=((OP.CALC_K_G_XFEM_F.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_XFEM_F.PBASECO, LC.E28NEUTR),
                     ...
                     (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
                     (OP.CALC_K_G_XFEM_F.PPINTER, LC.E14NEUTR), (OP.CALC_K_G_XFEM_F.PPINTTO, LC.E6NEUTR),
                     (OP.CALC_K_G_XFEM_F.PPMILTO, LC.E22NEUTR), (SP.PPRESSF, CPRESSF),
                     (SP.PPULPRO, LC.CFREQR), (SP.PROTATR, LC.CROTATR),
                     (SP.PSIGISE, ECONTSE), (SP.PTEMPSR, CTEMPSR),
                     (SP.PTHETAR, DDL_MECC), (OP.CALC_K_G_XFEM_F.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_K_G_XFEM_F.PSTANO, STANO_I),),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),
