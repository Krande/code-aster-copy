...
EENERR = LocatedComponents(phys=PHY.ENER_R, type="ELEM", components=("TOTALE", "DX", "DY", "DRZ"))
...
EEFGEGC = LocatedComponents(
    phys=PHY.SIEF_C, type="ELGA", location="RIGI", components=("N", "VY", "MFZ")
)


EEFGENC = LocatedComponents(phys=PHY.SIEF_C, type="ELNO", components=("N", "VY", "MFZ"))


EEFGEGA = LocatedComponents(
    phys=PHY.SIEF_R, type="ELGA", location="RIGI", components=("N", "VY", "MFZ")
)


EEFGENO = LocatedComponents(phys=PHY.SIEF_R, type="ELNO", components=("N", "VY", "MFZ"))
