    ...
    calculs = (
        ...
        OP.CALC_ESTI_ERRE(
            ...
            para_in=(
                (SP.PGEOMER, NGEOMER),
                (SP.PMATERC, LC.CMATERC),
                (OP.CALC_ESTI_ERRE.PSIEF_R, ECONRPG),
                (SP.PSIGMA, ECONTNO),
        ...
        OP.CALC_G_XFEM(
            ...
            para_in=(
                ...
                (SP.PCONTGR, ECONRPG),
                (OP.CALC_G_XFEM.PCONTRR, ECONRPG),
        ...
        OP.CALC_G_XFEM_F(
            ...
            para_in=(
                ...
                (SP.PCONTGR, ECONRPG),
                (OP.CALC_G_XFEM_F.PCONTRR, ECONRPG),
                (SP.PDEFOPL, LC.EDEFPNO),
                (SP.PDEPLAR, DDL_MECA),
                (SP.PEPSINF, CEPSINF),
                (SP.PFFVOLU, CFORCEF),
        ...
        OP.CHAR_MECA_META_Z(
            ...
            para_in=(
                ...
                (OP.CHAR_MECA_META_Z.PCONTMR, ECONRPG),
                (SP.PGEOMER, NGEOMER),
                (SP.PMATERC, LC.CMATERC),
        ...
        OP.DERA_ELGA(
            ...
            para_in=(
                ...
                (OP.DERA_ELGA.PCONTMR, ECONRPG),
                (OP.DERA_ELGA.PCONTPR, ECONRPG),
        ...
        OP.ENER_TOTALE(
            ...
            para_in=(
                ...
                (OP.ENER_TOTALE.PCONTMR, ECONRPG),
                (OP.ENER_TOTALE.PCONTPR, ECONRPG),
                (SP.PDEPLM, DDL_MECA),
                (SP.PDEPLR, DDL_MECA),
                (SP.PGEOMER, NGEOMER),
                (SP.PMATERC, LC.CMATERC),
        ...
        OP.ETOT_ELEM(
            te=575,
            para_in=(
                (OP.ETOT_ELEM.PCONTMR, ECONRPG),
                (OP.ETOT_ELEM.PCONTPR, ECONRPG),
                (SP.PDEPLM, DDL_MECA),
                (SP.PDEPLR, DDL_MECA),
        ...
        OP.ETOT_ELGA(
            te=575,
            para_in=(
                (OP.ETOT_ELGA.PCONTMR, ECONRPG),
                (OP.ETOT_ELGA.PCONTPR, ECONRPG),
                (SP.PDEPLM, DDL_MECA),
                (SP.PDEPLR, DDL_MECA),
        ...
        OP.FULL_MECA_ELAS(
            ...
            para_in=(
                ...
                (OP.FULL_MECA_ELAS.PCONTMR, ECONRPG),
                (SP.PDEPLMR, DDL_MECA),
                (SP.PDEPLPR, DDL_MECA),
                (SP.PGEOMER, NGEOMER),
                (SP.PINSTMR, CTEMPSR),
            ...
            para_out=(
                (SP.PCODRET, LC.ECODRET),
                (OP.FULL_MECA_ELAS.PCONTPR, ECONRPG),
                (SP.PMATUUR, MMATUUR),
        ...
        OP.INDIC_SEUIL(
            ...
            para_in=(
                ...
                (OP.INDIC_SEUIL.PCONTPR, ECONRPG),
                (SP.PDEPLR, DDL_MECA),
                (SP.PGEOMER, NGEOMER),
                (SP.PMATERC, LC.CMATERC),
        ...
        OP.PILO_PRED_DEFO(
            ...
            para_in=(
                ...
                (OP.PILO_PRED_DEFO.PCONTMR, ECONRPG),
                (SP.PDDEPLR, DDL_MECA),
                (SP.PDEPL0R, DDL_MECA),
                (SP.PCARCRI, LC.CCARCRI),
                (SP.PDEPL1R, DDL_MECA),
        ...
        OP.PILO_PRED_ELAS(
            ...
            para_in=(
                ...
                (OP.PILO_PRED_ELAS.PCONTMR, ECONRPG),
                (SP.PDDEPLR, DDL_MECA),
                (SP.PDEPL0R, DDL_MECA),
                (SP.PCARCRI, LC.CCARCRI),
                (SP.PDEPL1R, DDL_MECA),
        ...
        OP.RICE_TRACEY(
            ...
            para_in=(
                ...
                (OP.RICE_TRACEY.PCONTPR, ECONRPG),
                (SP.PGEOMER, NGEOMER),
        ...
        OP.RIGI_MECA_ELAS(
            ...
            para_in=(
                ...
                (OP.RIGI_MECA_ELAS.PCONTMR, ECONRPG),
                (SP.PDEPLMR, DDL_MECA),
                (SP.PDEPLPR, DDL_MECA),
                (SP.PGEOMER, NGEOMER),
                (SP.PINSTMR, CTEMPSR),
        ...
        OP.RIGI_MECA_TANG(
            ...
            para_in=(
                ...
                (OP.RIGI_MECA_TANG.PCONTMR, ECONRPG),
                (SP.PDEPLMR, DDL_MECA),
                (SP.PDEPLPR, DDL_MECA),
                (SP.PGEOMER, NGEOMER),
                (SP.PINSTMR, CTEMPSR),
            ...
            para_out=(
                ...
                (SP.PMATUUR, MMATUUR),
                (SP.PVECTUR, MVECTUR),
                (OP.RIGI_MECA_TANG.PCONTPR, ECONRPG),
        ...
        OP.TOU_INI_ELGA(
            ...
            para_out=(
                ...
                (OP.TOU_INI_ELGA.PSIEF_R, ECONRPG),
...
class MECPQS8(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.QU8,
            gauss=("RIGI=FPG4", "FPG1=FPG1", "MASS=FPG9", "NOEU_S=NOEU_S", "NOEU=NOEU"),
            mater=("RIGI", "NOEU", "FPG1"),
        ),
    ...
    calculs = (
        ...
        OP.RIGI_MECA_IMPLEX(
            ...
            para_out=((SP.PCONTXR, ECONTPG), (SP.PMATUNS, MMATUNS), (SP.PMATUUR, MMATUUR)),
        ),
        OP.RIGI_MECA_TANG(
            te=100,
            para_in=(
