...
class MEDPTR3_XH1(Element):
    ...
    calculs = (
        ...
        OP.CALC_G_XFEM(te=288,
            para_in=((OP.CALC_G_XFEM.PAINTER, LC.E40NEUTR), (OP.CALC_G_XFEM.PBASECO, LC.E32NEUTR),
                     (OP.CALC_G_XFEM.PBASLOR, LC.N6NEUT_R), (OP.CALC_G_XFEM.PCFACE, E14NEUTI),
                     (OP.CALC_G_XFEM.PCNSETO, LC.E72NEUI), (OP.CALC_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFRVOLU, NFORCER),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_G_XFEM.PHEAVTO, E24NEUI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_XFEM.PPINTER, E16NEUTR),
                     (OP.CALC_G_XFEM.PPINTTO, LC.E24NEUTR), (OP.CALC_G_XFEM.PPMILTO, LC.E22NEUTR),
        ...
        OP.CALC_G_XFEM_F(te=288,
            para_in=((OP.CALC_G_XFEM_F.PAINTER, LC.E40NEUTR), (OP.CALC_G_XFEM_F.PBASECO, LC.E32NEUTR),
                     (OP.CALC_G_XFEM_F.PBASLOR, LC.N6NEUT_R), (OP.CALC_G_XFEM_F.PCFACE, E14NEUTI),
                     (OP.CALC_G_XFEM_F.PCNSETO, LC.E72NEUI), (OP.CALC_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFFVOLU, CFORCEF),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_G_XFEM_F.PHEAVTO, E24NEUI),
                     (OP.CALC_G_XFEM_F.PHEA_NO, LC.N5NEUTI), (OP.CALC_G_XFEM_F.PLONCHA, LC.E10NEUTI),
                     (OP.CALC_G_XFEM_F.PLONGCO, LC.E3NEUTI), (OP.CALC_G_XFEM_F.PLSN, LC.N1NEUT_R),
                     (OP.CALC_G_XFEM_F.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_XFEM_F.PPINTER, E16NEUTR),
                     (OP.CALC_G_XFEM_F.PPINTTO, LC.E24NEUTR), (OP.CALC_G_XFEM_F.PPMILTO, LC.E22NEUTR),
        ...
        OP.CALC_K_G_XFEM(te=297,
            para_in=((OP.CALC_K_G_XFEM.PAINTER, LC.E40NEUTR), (OP.CALC_K_G_XFEM.PBASECO, LC.E32NEUTR),
                     (OP.CALC_K_G_XFEM.PBASLOR, LC.N6NEUT_R), (OP.CALC_K_G_XFEM.PCFACE, E14NEUTI),
                     (OP.CALC_K_G_XFEM.PCNSETO, LC.E72NEUI), (OP.CALC_K_G_XFEM.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFRVOLU, NFORCER),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_K_G_XFEM.PHEAVTO, E24NEUI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_K_G_XFEM.PPINTER, E16NEUTR),
                     (OP.CALC_K_G_XFEM.PPINTTO, LC.E24NEUTR), (OP.CALC_K_G_XFEM.PPMILTO, LC.E22NEUTR),
        ...
        OP.CALC_K_G_XFEM_F(te=297,
            para_in=((OP.CALC_K_G_XFEM_F.PAINTER, LC.E40NEUTR), (OP.CALC_K_G_XFEM_F.PBASECO, LC.E32NEUTR),
                     (OP.CALC_K_G_XFEM_F.PBASLOR, LC.N6NEUT_R), (OP.CALC_K_G_XFEM_F.PCFACE, E14NEUTI),
                     (OP.CALC_K_G_XFEM_F.PCNSETO, LC.E72NEUI), (OP.CALC_K_G_XFEM_F.PCOMPOR, LC.CCOMPOR),
                     (SP.PDEPLAR, DDL_MECA), (SP.PFFVOLU, CFORCEF),
                     (SP.PGEOMER, NGEOMER), (OP.CALC_K_G_XFEM_F.PHEAVTO, E24NEUI),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_K_G_XFEM_F.PPINTER, E16NEUTR),
                     (OP.CALC_K_G_XFEM_F.PPINTTO, LC.E24NEUTR), (OP.CALC_K_G_XFEM_F.PPMILTO, LC.E22NEUTR),
                     (SP.PPRESSF, CPRESSF), (SP.PPULPRO, LC.CFREQR),
                     (SP.PROTATR, LC.CROTATR), (SP.PTEMPSR, CTEMPSR),
                     (SP.PTHETAR, DDL_MECC), (OP.CALC_K_G_XFEM_F.PVARCPR, LC.ZVARCPG),
                     (SP.PVARCRR, LC.ZVARCPG), ),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),
...
#       -- te0580 : ne resout que les cas triviaux : 0.
        ...
        OP.CHAR_MECA_TEMP_R(te=541,
            para_in=((OP.CHAR_MECA_TEMP_R.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.CHAR_MECA_TEMP_R.PCNSETO, LC.E72NEUI), (OP.CHAR_MECA_TEMP_R.PCOMPOR, LC.CCOMPOR),
        ...
        OP.ENEL_ELEM(te=565,
            para_in=((OP.ENEL_ELEM.PCNSETO, LC.E72NEUI), (OP.ENEL_ELEM.PCOMPOR, LC.CCOMPOR),
        ...
        OP.FULL_MECA(te=539,
            para_in=((OP.FULL_MECA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.FULL_MECA.PCNSETO, LC.E72NEUI),
        ...
        OP.RAPH_MECA(te=539,
            para_in=((OP.RAPH_MECA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.RAPH_MECA.PCNSETO, LC.E72NEUI),
        ...
        OP.RIGI_MECA_TANG(te=539,
            para_in=((OP.RIGI_MECA_TANG.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (SP.PCARCRI, LC.CCARCRI), (OP.RIGI_MECA_TANG.PCNSETO, LC.E72NEUI),
        ...
        OP.SIEF_ELGA(te=261,
            para_in=((OP.SIEF_ELGA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
                     (OP.SIEF_ELGA.PCNSETO, LC.E72NEUI), (OP.SIEF_ELGA.PCOMPOR, LC.CCOMPOR),
