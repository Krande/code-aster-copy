...
DDL_MECA = LocatedComponents(
    ...
    diff=True,
    components=(
        ("EN1", ("HHO_FX[15]", "HHO_FY[15]", "HHO_FZ[15]")),
        ("EN2", ()),
        ("EN3", ("HHO_CX[35]", "HHO_CY[35]", "HHO_CZ[35]")),
    ),
)
...
CHHOBS = LocatedComponents(
    ...
    type="ELNO",
    diff=True,
    components=(("EN1", ("X[120]",)), ("EN2", ()), ("EN3", ("X[1596]"))),
)
...
class MECA3DH27_HHO444(Element):
    ...
    elrefe = (
        ElrefeLoc(
            MT.H27,
            gauss=("RIGI=FPG125", "FPG1=FPG1", "MTGA=FPG125", "MASS=FPG125"),
...
class MECA3DT15_HHO444(MECA3DH27_HHO444):
    """Please document this element"""
    ...
    elrefe = (
        ElrefeLoc(
            MT.T15,
            gauss=("RIGI=FPG46", "FPG1=FPG1", "MTGA=FPG46", "MASS=FPG46"),
            mater=("RIGI", "FPG1", "MTGA", "MASS"),
        ),
    )


class MECA3DP21_HHO444(MECA3DH27_HHO444):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P21,
            gauss=("RIGI=FPG95", "FPG1=FPG1", "MTGA=FPG95", "MASS=FPG95"),
            mater=("RIGI", "FPG1", "MTGA", "MASS"),
        ),
    )


class MECA3DP19_HHO444(MECA3DH27_HHO444):
    ...
    elrefe = (
        ElrefeLoc(
            MT.P19,
            gauss=("RIGI=FPG47", "FPG1=FPG1", "MTGA=FPG47", "MASS=FPG47"),
            mater=("RIGI", "FPG1", "MTGA", "MASS"),
        ),
    )
