...
class THER2DQ9_HHO222(Element):
    ...
    elrefe = (
        ElrefeLoc(MT.QU9, gauss=('RIGI=FPG9', 'FPG1=FPG1',
                  'MASS=FPG9',), mater=('RIGI', 'FPG1',  'MASS'),),
        ...
        OP.TOU_INI_ELGA(te=99,
                        para_out=((OP.TOU_INI_ELGA.PFLUX_R, EFLUXPG), (OP.TOU_INI_ELGA.PGEOM_R, EGGEOM_R),
                                  (OP.TOU_INI_ELGA.PNEUT_F,
                                   EGNEUT_F), (OP.TOU_INI_ELGA.PNEUT_R, LC.EGNEUT1R),
                                  (OP.TOU_INI_ELGA.PSOUR_R,
                                   ESOURCR), (OP.TOU_INI_ELGA.PVARI_R, LC.ZVARIPG),
...
class THER2DT7_HHO222(THER2DQ9_HHO222):
    """Please document this element"""
    meshType = MT.TRIA7
    nodes = (
    ...
    elrefe = (
        ElrefeLoc(MT.TR7, gauss=('RIGI=FPG6', 'FPG1=FPG1',
                  'MASS=FPG6',), mater=('RIGI', 'FPG1', 'MASS',),),
