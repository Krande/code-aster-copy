...
STANO_I = LocatedComponents(phys=PHY.N120_I, type="ELEM", components=("X[16]",))
...
BASLO_R = LocatedComponents(phys=PHY.N480_R, type="ELEM", components=("X[96]",))
...
class MEDPT3HT3C_XH(MEDPQ4HQ4H_XH):
    ...
    meshType = MT.TR3TR3
    nodes = (SetOfNodes("EN4", (4, 5, 6)), SetOfNodes("EN1", (1, 2, 3)))
    elrefe = (ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.SE2, gauss=("NOEU=NOEU",)))
...
class MEDPT3CT3H_XH(MEDPQ4HQ4H_XH):
    ...
    meshType = MT.TR3TR3
    nodes = (SetOfNodes("EN2", (4, 5, 6)), SetOfNodes("EN3", (1, 2, 3)))
    elrefe = (ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.SE2, gauss=("NOEU=NOEU",)))
...
class MEDPT3CT3C_XH(MEDPQ4HQ4H_XH):
    ...
    meshType = MT.TR3TR3
    nodes = (SetOfNodes("EN4", (4, 5, 6)), SetOfNodes("EN3", (1, 2, 3)))
    elrefe = (ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.SE2, gauss=("NOEU=NOEU",)))
...
class MEDPQ4HT3H_XH(MEDPQ4HQ4H_XH):
    ...
    meshType = MT.QU4TR3
    nodes = (SetOfNodes("EN2", (5, 6, 7)), SetOfNodes("EN1", (1, 2, 3, 4)))
    elrefe = (
...
class MEDPT3HQ4H_XH(MEDPQ4HQ4H_XH):
    ...
    meshType = MT.TR3QU4
    nodes = (SetOfNodes("EN2", (4, 5, 6, 7)), SetOfNodes("EN1", (1, 2, 3)))
    elrefe = (
        ElrefeLoc(MT.TR3, gauss=("NOEU=NOEU",)),
        ElrefeLoc(MT.QU4, gauss=("NOEU=NOEU",)),
        ElrefeLoc(MT.SE2, gauss=("NOEU=NOEU",)),
...
class MEDPQ8HQ8H_XH(MEDPQ4HQ4H_XH):
    ...
    elrefe = (ElrefeLoc(MT.QU8, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.SE3, gauss=("NOEU=NOEU",)))
...
class MEDPT6HT6H_XH(MEDPQ4HQ4H_XH):
    ...
    meshType = MT.TR6TR6
    nodes = (SetOfNodes("EN2", (4, 5, 6, 7, 8, 9, 10, 11, 12)), SetOfNodes("EN1", (1, 2, 3)))
    elrefe = (ElrefeLoc(MT.TR6, gauss=("NOEU=NOEU",)), ElrefeLoc(MT.SE3, gauss=("NOEU=NOEU",)))
