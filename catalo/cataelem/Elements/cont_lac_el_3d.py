...
class LACQ4Q4D(Element):
    ...
    meshType = MT.QUAD44
    nodes = (SetOfNodes("EN1", (3, 4)), SetOfNodes("EN2", (1, 2, 5, 6, 7, 8)))
    calculs = (
        OP.RIGI_CONT(
            te=567,
            para_in=(
...
class LACQ4T3D(LACQ4Q4D):
    ...
    meshType = MT.QU4TR3
    nodes = (SetOfNodes("EN1", (3, 4)), SetOfNodes("EN2", (1, 2, 5, 6, 7)))
...
class LACQ4T6D(LACQ4Q4D):
    ...
    meshType = MT.QU4TR6
    nodes = (SetOfNodes("EN1", (3, 4)), SetOfNodes("EN2", (1, 2, 5, 6, 7, 8, 9, 10)))
...
class LACQ4Q8D(LACQ4Q4D):
    ...
    meshType = MT.QU4QU8
    nodes = (SetOfNodes("EN1", (3, 4)), SetOfNodes("EN2", (1, 2, 5, 6, 7, 8, 9, 10, 11, 12)))
...
class LACQ4Q9D(LACQ4Q4D):
    ...
    meshType = MT.QU4QU9
    nodes = (SetOfNodes("EN1", (3, 4)), SetOfNodes("EN2", (1, 2, 5, 6, 7, 8, 9, 10, 11, 12, 13)))
...
class LACQ8T3D(LACQ4Q4D):
    ...
    meshType = MT.QU8TR3
    nodes = (SetOfNodes("EN1", (3, 4)), SetOfNodes("EN2", (1, 2, 5, 6, 7, 8, 9, 10, 11)))
...
class LACQ8T3E(LACQ4Q4D):
    ...
    meshType = MT.QU8TR3
    nodes = (SetOfNodes("EN1", (1, 2, 3, 4)), SetOfNodes("EN2", (5, 6, 7, 8, 9, 10, 11)))
...
class LACT3T3D(LACQ4Q4D):
    ...
    meshType = MT.TRIA33
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5, 6)))
...
class LACT3T6D(LACQ4Q4D):
    ...
    meshType = MT.TR3TR6
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5, 6, 7, 8, 9)))
...
class LACT3Q4D(LACQ4Q4D):
    ...
    meshType = MT.TR3QU4
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5, 6, 7)))
...
class LACT3Q8D(LACQ4Q4D):
    ...
    meshType = MT.TR3QU8
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5, 6, 7, 8, 9, 10, 11)))
...
class LACT3Q9D(LACQ4Q4D):
    ...
    meshType = MT.TR3QU9
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5, 6, 7, 8, 9, 10, 11, 12)))
...
class LACT6Q4D(LACQ4Q4D):
    ...
    meshType = MT.TR6QU4
    nodes = (SetOfNodes("EN1", (3,)), SetOfNodes("EN2", (1, 2, 4, 5, 6, 7, 8, 9, 10)))
...
class LACQ9T3D(LACQ4Q4D):
    ...
    meshType = MT.QU9TR3
    nodes = (SetOfNodes("EN1", (9,)), SetOfNodes("EN2", (1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12)))
...
class LACQ9Q4D(LACQ4Q4D):
    ...
    meshType = MT.QU9QU4
    nodes = (SetOfNodes("EN1", (9,)), SetOfNodes("EN2", (1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13)))
