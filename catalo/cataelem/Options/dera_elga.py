...
PDERAPG = OutputParameter(
    phys=PHY.DERA_R, type="ELGA", comment="""  PDERAPG : INDICATEUR LOCAL DE DECHARGE """
)


DERA_ELGA = Option(
    para_in=(PCOMPOR, PCONTMR, PCONTPR, SP.PDERAMG, SP.PMATERC, PVARCPR, PVARIMR, PVARIPR),
    para_out=(PDERAPG,),
