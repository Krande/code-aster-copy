...
PPINTTO = InputParameter(phys=PHY.N132_R, comment="""  PPINTTO : CHAMP SPECIFIQUE XFEM  """)


PCNSETO = InputParameter(phys=PHY.N1280I, comment="""  PCNSETO : CHAMP SPECIFIQUE XFEM  """)


PHEAVTO = InputParameter(phys=PHY.N512_I, comment="""  PHEAVTO : CHAMP SPECIFIQUE XFEM  """)


PHEA_NO = InputParameter(phys=PHY.N120_I)


PLONCHA = InputParameter(phys=PHY.N120_I, comment="""  PLONCHA : CHAMP SPECIFIQUE XFEM  """)


PBASLOR = InputParameter(phys=PHY.NEUT_R, comment="""  PBASLOR : CHAMP SPECIFIQUE XFEM  """)


PLSN = InputParameter(phys=PHY.NEUT_R, comment="""  PLSN    : CHAMP SPECIFIQUE XFEM  """)


PLST = InputParameter(phys=PHY.NEUT_R, comment="""  PLST    : CHAMP SPECIFIQUE XFEM  """)


PSTANO = InputParameter(phys=PHY.N120_I, comment="""  PSTANO  : CHAMP SPECIFIQUE XFEM  """)


PPMILTO = InputParameter(phys=PHY.N792_R, comment="""  PPMILTO : CHAMP SPECIFIQUE XFEM  """)
...
CHAR_MECA_TEMP_R = Option(
    ...
    condition=(
        ...
        CondCalcul("-", ((AT.PHENO, "ME"), (AT.TYPMOD2, "JHMS"))),
        CondCalcul("-", ((AT.PHENO, "ME"), (AT.TYPMOD2, "XFEM_HM"))),
