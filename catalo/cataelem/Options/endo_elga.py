...
PVARCPR = InputParameter(
    phys=PHY.VARI_R,
    container="VOLA!&&CCPARA.VARI_INT_NM1",
...
ENDO_ELGA = Option(
    para_in=(PCOMPOR, SP.PCONTGP, SP.PMATERC, SP.PTRIAGM, SP.PVARCMR, PVARCPR, PVARIMR, PVARIPR),
    para_out=(PTRIAPG,),
