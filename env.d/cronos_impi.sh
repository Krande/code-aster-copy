...
export DEVTOOLS_COMPUTER_ID=cronos
# expected version of official prerequisites
export OFFICIAL_PLATFORM=1
export PREREQ_VERSION=20201218
export PREREQ_PATH=/software/rd/simumeca/prerequisites/${PREREQ_VERSION}/intel19-impi19

# force parallel build
export ENABLE_MPI=1

# generic environment: compilers, python
module load intel/2019.5.075
export CC=mpiicc
export FC=mpiifort
export CXX=mpiicpc

# custom configuration
export CONFIG_PARAMETERS_addmem=7000
...
export PYPATH_MED="${PREREQ_PATH}/med-4.1.0/lib64/python3.6/site-packages"
...
export PYPATH_MPI4PY="${PREREQ_PATH}/mpi4py-3.0.3/lib64/python3.6/site-packages"
