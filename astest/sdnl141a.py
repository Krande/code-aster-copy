...
def Fmor(
    ...
    eta, ux, uy, uz = cinelin(xx, yy, zz, tps, H, T, L, THETA, UC, THETAC, PROINF, dd, LSTRECH)
...
# print('FP(0) =', FP(1,1,1,0,0,-10,0,2,10,150,0,0,0,0,65,0,0,0,1,1,0,0,3,cinelin,projvect,dragquad))
