...
mater_vhyst = AFFE_MATERIAU(AFFE=(_F(GROUP_MA=('3D'), 
                                     MATER=deltane_hyst
                                    ),),
                             MODELE=model)

mater_v = AFFE_MATERIAU(AFFE=(_F(GROUP_MA=('3D'), 
                                 MATER=deltane
                                 ),),
                        MODELE=model)
...
TEST_FICHIER(FICHIER='test.txt', TYPE_TEST='SOMM_ABS', NB_VALE=576, VALE_CALC=1e-7, 
