...
f = {
    "CONSTANTE": FORMULE(VALE="-1", NOM_PARA=("X", "Y", "Z")),
    "LINEAIRE": FORMULE(VALE="Z+X-1", NOM_PARA=("X", "Y", "Z")),
    "QUADRATIQUE": FORMULE(VALE="A/H-X*Y+X+Y*Y+Z-1", NOM_PARA=("X", "Y", "Z"), A=A, H=H),
    "CUBIQUE": FORMULE(
        VALE="(A*(2*Z - 1) + H*(-X*Y + X*Z*Z  + X + Y*Y  + Z - 1))/H",
        NOM_PARA=("X", "Y", "Z"),
        A=A,
        H=H,
    ),
    "QUARTIQUE": FORMULE(
        VALE="(A*(2*Z - 1-12*X*X) + H*(-X*X*X*X -X*Y + X*Z*Z  + X + Y*Y  + Z - 1))/H",
        NOM_PARA=("X", "Y", "Z"),
        A=A,
        H=H,
    ),
