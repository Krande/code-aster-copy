...
BLOCAGE = AFFE_CHAR_CINE(MECA_IMPO=_F(DX=0.0, DY=0.0, DZ=0.0, DRX=0.0, DRY=0.0, DRZ=0.0,
                                      GROUP_NO=('ENC',)), MODELE=MODELE)
...
RES = STAT_NON_LINE(
    ...
    EXCIT=(_F(CHARGE=BLOCAGE, FONC_MULT=FOMULT),
           _F(CHARGE=CHAR, FONC_MULT=FOMULT)),
    COMPORTEMENT=(
    ...
    CONVERGENCE=_F(RESI_GLOB_RELA=1e-8,
                   ITER_GLOB_ELAS=25,
                   ITER_GLOB_MAXI=10),
    NEWTON=_F(PREDICTION='ELASTIQUE', REAC_INCR=1,
              MATRICE='TANGENTE', REAC_ITER=3, ),
...
TEST_RESU(CHAM_ELEM=(_F(CRITERE='ABSOLU',
                        ...
                        TYPE_TEST='MIN',
                        CHAM_GD=DIF_SIG,
                        VALE_CALC=5.81758504267782E-05,
                        VALE_REFE=0.0,
                        VALE_ABS='OUI', ),
                     _F(CRITERE='ABSOLU',
                        REFERENCE='ANALYTIQUE',
                        TYPE_TEST='MAX',
                        CHAM_GD=DIF_SIG,
                        VALE_CALC=7.31772743165493E-05,
                        VALE_REFE=0.0,
                        VALE_ABS='OUI', ),
                     _F(CRITERE='ABSOLU',
                        REFERENCE='ANALYTIQUE',
