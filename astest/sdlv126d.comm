...
# viscoélastique D_PLAN isotrope.
...
mater_1 = AFFE_MATERIAU(AFFE=(_F(GROUP_MA='PLAN', MATER=materiau_1)),
                        MODELE=model)
mater_2 = AFFE_MATERIAU(AFFE=(_F(GROUP_MA='PLAN', MATER=materiau_2)),
                        MODELE=model)
mater_v = AFFE_MATERIAU(AFFE=(_F(GROUP_MA='PLAN', MATER=materiau_v)),
                        MODELE=model)
