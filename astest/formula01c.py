...
dfc1 = DEFI_FONCTION(
    NOM_PARA="INST",
    NOM_RESU="FREQ",
    VALE_C=(5.0, 2.0, 4.0, 1.0, 3.0, 4.0, 0.0, 1.0, 2.0),
    VERIF="NON",
)
...
test.assertEqual(dfc1(1.0), 3 + 4j)
...
IMPR_FONCTION(COURBE=_F(FONCTION=fctcpx, LIST_PARA=labs, PARTIE="IMAG"), UNITE=6)

test.assertEqual(fctcpx(1.0), 1 + 2j)
test.assertEqual(fctcpx(3.0), 3 + 6j)
