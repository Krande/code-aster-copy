...
tab = CREA_TABLE(
    LISTE=(_F(PARA="NUMERO", LISTE_I=table1), _F(PARA="NOM_NUM", LISTE_K=table2, TYPE_K="K24")),
    TITRE="Table title",
)
...
tab2 = CALC_TABLE(TABLE=tab, ACTION=_F(OPERATION="FILTRE", NOM_PARA="NUMERO", VALE_I=1), INFO=2)
