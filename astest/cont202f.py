...
option_dict = {
    ...
    14: {  # - Visualisation of all the pairs on the two interfaces of the mesh
        "optionMesh": "interface",
        "suboptionMesh": "all",
        "optionPair": "pairs",
        "addMeshNodes": True,
    ...
    15: {  # - Visualisation of the pair of index = 0 (first pair) on the two interfaces of the mesh
        "optionMesh": "interface",
        "suboptionMesh": "givenPair",
        "optionPair": "pairs",
        "addMeshNodes": True,
    ...
    17: {  # - Visualisation of the intersection points
        # of index = 0 (first pair) on the two interfaces of the mesh
        "optionMesh": "interface",
        "suboptionMesh": "givenPair",
        "optionPair": "intePoints",
