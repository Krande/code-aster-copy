...
test.assertEqual(numeDDL.getRowsAssociatedToComponent("LAGR:DX"), [0, 4, 6, 10, 16, 20, 22, 26])
test.assertEqual(numeDDL.getRowsAssociatedToComponent("LAGR:DY"), [1, 5, 7, 11, 17, 21, 23, 27])
