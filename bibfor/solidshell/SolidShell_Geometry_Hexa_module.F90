...
! - Compute T matrix
    geomHexa%T(1, 1) = JacInv0(1,1)*JacInv0(1,1)
    geomHexa%T(1, 2) = JacInv0(2,1)*JacInv0(2,1)
    geomHexa%T(1, 3) = JacInv0(3,1)*JacInv0(3,1)
    geomHexa%T(1, 4) = JacInv0(1,1)*JacInv0(2,1)
    geomHexa%T(1, 5) = JacInv0(1,1)*JacInv0(3,1)
    geomHexa%T(1, 6) = JacInv0(2,1)*JacInv0(3,1)
    geomHexa%T(2, 1) = JacInv0(1,2)*JacInv0(1,2)
    geomHexa%T(2, 2) = JacInv0(2,2)*JacInv0(2,2)
    geomHexa%T(2, 3) = JacInv0(3,2)*JacInv0(3,2)
    geomHexa%T(2, 4) = JacInv0(1,2)*JacInv0(2,2)
    geomHexa%T(2, 5) = JacInv0(1,2)*JacInv0(3,2)
    geomHexa%T(2, 6) = JacInv0(2,2)*JacInv0(3,2)
    geomHexa%T(3, 1) = JacInv0(1,3)*JacInv0(1,3)
    geomHexa%T(3, 2) = JacInv0(2,3)*JacInv0(2,3)
    geomHexa%T(3, 3) = JacInv0(3,3)*JacInv0(3,3)
    geomHexa%T(3, 4) = JacInv0(1,3)*JacInv0(2,3)
    geomHexa%T(3, 5) = JacInv0(1,3)*JacInv0(3,3)
    geomHexa%T(3, 6) = JacInv0(2,3)*JacInv0(3,3)
    geomHexa%T(4, 1) = 2.d0*JacInv0(1,1)*JacInv0(1,2)
    geomHexa%T(4, 2) = 2.d0*JacInv0(2,1)*JacInv0(2,2)
    geomHexa%T(4, 3) = 2.d0*JacInv0(3,1)*JacInv0(3,2)
    geomHexa%T(4, 4) = JacInv0(1,1)*JacInv0(2,2)+JacInv0(2,1)*JacInv0(1,2)
    geomHexa%T(4, 5) = JacInv0(1,1)*JacInv0(3,2)+JacInv0(3,1)*JacInv0(1,2)
    geomHexa%T(4, 6) = JacInv0(2,2)*JacInv0(3,1)+JacInv0(2,1)*JacInv0(3,2)
    geomHexa%T(6, 1) = 2.d0*JacInv0(1,2)*JacInv0(1,3)
    geomHexa%T(6, 2) = 2.d0*JacInv0(2,2)*JacInv0(2,3)
    geomHexa%T(6, 3) = 2.d0*JacInv0(3,2)*JacInv0(3,3)
    geomHexa%T(6, 4) = JacInv0(1,3)*JacInv0(2,2)+JacInv0(1,2)*JacInv0(2,3)
    geomHexa%T(6, 5) = JacInv0(1,2)*JacInv0(3,3)+JacInv0(3,2)*JacInv0(1,3)
    geomHexa%T(6, 6) = JacInv0(2,2)*JacInv0(3,3)+JacInv0(3,2)*JacInv0(2,3)
    geomHexa%T(5, 1) = 2.d0*JacInv0(1,1)*JacInv0(1,3)
    geomHexa%T(5, 2) = 2.d0*JacInv0(2,1)*JacInv0(2,3)
    geomHexa%T(5, 3) = 2.d0*JacInv0(3,1)*JacInv0(3,3)
    geomHexa%T(5, 4) = JacInv0(1,3)*JacInv0(2,1)+JacInv0(1,1)*JacInv0(2,3)
    geomHexa%T(5, 5) = JacInv0(1,3)*JacInv0(3,1)+JacInv0(1,1)*JacInv0(3,3)
    geomHexa%T(5, 6) = JacInv0(2,3)*JacInv0(3,1)+JacInv0(2,1)*JacInv0(3,3)
!
!   ------------------------------------------------------------------------------------------------
end subroutine
! --------------------------------------------------------------------------------------------------
