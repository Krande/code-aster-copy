...
!
    ...
    WRITE(SSH_DBG_UNIT, *) ' *S* T    : ', sum(geomHexa%T)
...
!
    if (present(smallCstPart_)) then
        ...
        WRITE(SSH_DBG_UNIT, *) ' *S* BCartZETA     : ', sum(kineHexa%BCartZETA)
        WRITE(SSH_DBG_UNIT, *) ' *S* BCartZETAZETA : ', sum(kineHexa%BCartZETAZETA)
        WRITE(SSH_DBG_UNIT, *) ' *S* BCartXI       : ', sum(kineHexa%BCartXI)
        WRITE(SSH_DBG_UNIT, *) ' *S* BCartETA      : ', sum(kineHexa%BCartETA)
        WRITE(SSH_DBG_UNIT, *) ' *S* BCartETAZETA  : ', sum(kineHexa%BCartETAZETA)
        WRITE(SSH_DBG_UNIT, *) ' *S* BCartXIZETA   : ', sum(kineHexa%BCartXIZETA)
    endif
