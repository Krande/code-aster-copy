...
! - List of type of cells with this dimension
    if (projDime .eq. '0D') then
        ...
        cellTypeName(4) = 'TRIA10'
        cellTypeName(5) = 'QUAD4'
        cellTypeName(6) = 'QUAD8'
        cellTypeName(7) = 'QUAD9'
        cellTypeName(8) = 'QUAD12'
        cellListCode(1) = 'TR3'
        cellListCode(2) = 'TR6'
        cellListCode(3) = 'TR7'
        cellListCode(4) = 'TR1'
        ...
        cellTypeName(3) = 'TETRA20'
        cellTypeName(4) = 'PENTA6'
        cellTypeName(5) = 'PENTA15'
        cellTypeName(6) = 'PENTA18'
        cellTypeName(7) = 'HEXA8'
        cellTypeName(8) = 'HEXA20'
        cellTypeName(9) = 'HEXA27'
        cellTypeName(10) = 'PYRAM5'
        cellTypeName(11) = 'PYRAM13'
        cellTypeName(12) = 'HEXA9'
        cellListCode(1) = 'TE4'
        cellListCode(2) = 'T10'
        cellListCode(3) = 'T20'
        cellListCode(4) = 'PE6'
