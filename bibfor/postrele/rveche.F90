...
!
    ...
    integer(kind=8) :: arefe, adesc, nbcmp, i, anumnd, acmpgd, lpt
    ...
    integer(kind=8) :: vali, ilong, k, l, lnc, ncom, nspm, ier
!
    aster_logical :: trouve, lnommai, lnomnoe
!
