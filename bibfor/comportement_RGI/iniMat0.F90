...
#include "asterfort/assert.h"
    ...
    real(kind=8), optional, intent(out) :: x6(l, l), x7(l, l), x8(l, l)
    real(kind=8), optional, intent(out) :: x9(l, l), x10(l, l), x11(l, l)
    real(kind=8), optional, intent(out) :: x12(l, l), x13(l, l), x14(l, l)
    real(kind=8), optional, intent(out) :: x15(l, l), x16(l, l), x17(l, l)
    real(kind=8), optional, intent(out) :: x18(l, l), x19(l, l)
!-----------------------------------------------------------------------
!
    x1(:, :) = 0.d0
