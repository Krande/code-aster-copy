...
!-----------------------------------------------------------------------
!   récupèration de valeurs booleennes dans un tableau
!-----------------------------------------------------------------------
    implicit none
...
#include "asterfort/assert.h"
    ...
    aster_logical, optional, intent(out) :: x9, x10, x11, x12, x13, x14
    aster_logical, optional, intent(out) :: x15, x16, x17
!-----------------------------------------------------------------------
!    
    x1 = vect(1)
