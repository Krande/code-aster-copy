...
! THM
!
! Compute generalized stress and matrix for coupled quantities - 'LIQU_GAZ'
!
! --------------------------------------------------------------------------------------------------
!
...
! --------- Derivative of "reduced" heat Q' of liquid by gaz pressure
