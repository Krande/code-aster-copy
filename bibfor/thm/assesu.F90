...
! FM2ADS(MAXFA+1,NFACE) DERIVEE DE FMADS / P_K PUIS P_2,SIGMA
    ...
    integer(kind=8), parameter :: mob = 7, dmobp1 = 8, dmobp2 = 9, masse = 10
    integer(kind=8), parameter :: dmasp1 = 11, dmasp2 = 12
    integer(kind=8), parameter :: wliq = 1, wvap = 2, airdis = 3, airsec = 4, eau = 1
    integer(kind=8), parameter ::  air = 2, densit = 14
    integer(kind=8), parameter :: vkint = 13, kxx = 1, kyy = 2, kzz = 3, kxy = 4, kyz = 5, kzx = 6
    integer(kind=8), parameter :: rhoga = 1, rholq = 2, rhoga1 = 3, rhoga2 = 4
    integer(kind=8), parameter :: rholq1 = 5, rholq2 = 6
