...
!      CALCUL GLOBAL DU FERRAILLAGE DES POUTRES A L'ELU
!
...
!      I EFFRTS    VECTEUR DE SOLLICITATIONS 1D
...
!                     0 = NON, 1 = OUI
!      I FERRMIN   PRISE EN COMPTE D'UN FERRAILLAGE MINIMUN
!                     0 = NON, 1 = OUI, 2 = CODE
...
!   DEFINITION VARIABLES INTERMEDIAIRES
    real(kind=8) :: sigmsyi, sigmsys, ecyi, ecys
    real(kind=8) :: sigmszi, sigmszs, eczi, eczs
...
!        GESTION DES ALARMES EMISES POUR LES ACIERS DE FLEXION A L'ELU
    if (ierr .eq. 1) then
!            Poutre en pivot B ou C trop comprimée !
