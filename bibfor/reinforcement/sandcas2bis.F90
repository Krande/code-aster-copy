...
subroutine sandcas2bis(effrts, ht, enrobi, enrobs, facier, fbeton, gammas, gammac, &
...
99                          continue
        ...
        call wkvect(p(4), ' V V R ', N_IIbis, vr=tSUP)
        ...
        do i = 1, N1
            ...
            do j = 1, N1
                ...
                do k = 1, N2
                    ...
                    !Solve 1st equation
                    a11 = -fcSUP*cos(theta_sup)*sin(theta_sup)
                    a21 = 0.5*a11
                    a12 = -fcd*t_inf*cos(theta_inf)*sin(theta_inf)
                    a22 = 0.5*(ht-t_inf)*a12
                    ...
                    if (tSUP(indx) .ne. (-1.d0)) then
                        X_alpha_inf = (Nxy-a11*tSUP(indx))/a12
                        if (cond109 .eq. 1) then
                            a00 = X_alpha_inf+0.85*3.8
                            b00 = 2*X_alpha_inf-0.85*2.8
