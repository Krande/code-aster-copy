...
!
    if (cmp(1:2) .eq. 'FP') then
        ...
        if (ndim .eq. 3) then
            ...
            epsfm(1) = epsfm(1)+vim(16)+vim(9)+vim(22)
            epsfm(2) = epsfm(2)+vim(17)+vim(10)+vim(23)
            epsfm(3) = epsfm(3)+vim(18)+vim(11)+vim(24)
            epsfm(4) = vim(19)+vim(12)+vim(25)
            epsfm(5) = vim(20)+vim(13)+vim(27)
            epsfm(6) = vim(21)+vim(14)+vim(26)
        else if (ndim .eq. 2) then
            do i = 1, 3
                epsfm(i) = (vim(11)+vim(5))
            end do
            epsfm(1) = epsfm(1)+vim(12)+vim(7)+vim(16)
            epsfm(2) = epsfm(2)+vim(13)+vim(8)+vim(17)
            epsfm(3) = epsfm(3)+vim(14)+vim(9)+vim(18)
            epsfm(4) = vim(15)+vim(10)
            epsfm(5) = 0.
            epsfm(6) = 0.
        end if
