...
!
subroutine xxnmelNonLin(BEHInteg, &
                        option, typmod, &
                        compor, carcri, &
                        ...
                        lgpg, &
                        instam, instap, idepl, lsn, lst, idecpg, &
...
!
    ...
    integer(kind=8) :: idecpg, idepl, jvGeom, ivectu, nnops
...
!       ET CALCUL DE FF, DFDI, ET EPS
        call xcinem(axi, jvGeom, nnop, nnops, idepl, ndim, he, &
