...
!
        ...
        b_n = to_blas_int(nbstoc)
        b_incx = to_blas_int(1)
        b_incy = to_blas_int(1)
        call dcopy(b_n, zr(jdepl), b_incx, zr(allocs(4)+decal(2)), b_incy)
...
!
        ...
        b_incx = to_blas_int(1)
        b_incy = to_blas_int(1)
        call dcopy(b_n, zr(jvite), b_incx, zr(allocs(5)+decal(2)), b_incy)
...
!
        ...
        b_incx = to_blas_int(1)
        b_incy = to_blas_int(1)
        call dcopy(b_n, zr(jacce), b_incx, zr(allocs(6)+decal(2)), b_incy)
        call jedetr(nomres(i)//'           .ACCE')
!
        call jeveuo(nomres(i)//'           .DISC', 'L', jdisc)
        b_n = to_blas_int(copysize)
        b_incx = to_blas_int(1)
        b_incy = to_blas_int(1)
        call dcopy(b_n, zr(jdisc), b_incx, zr(allocs(2)+decal(1)), b_incy)
...
!
        ...
        b_incx = to_blas_int(1)
        b_incy = to_blas_int(1)
        call dcopy(b_n, zr(jptem), b_incx, zr(allocs(3)+decal(1)), b_incy)
...
!
            ...
            b_n = to_blas_int(nbvint*copysize)
            b_incx = to_blas_int(1)
            b_incy = to_blas_int(1)
            call dcopy(b_n, zr(jvint), b_incx, zr(allocs(7)+decal(3)), b_incy)
