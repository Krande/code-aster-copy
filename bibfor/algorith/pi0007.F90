...
!
subroutine pi0007(BEHInteg, typmod, ndim, epsm, epsd_cste, epsd_pilo, &
...
! --------------------------------------------------------------------------------------------------
    ...
    if (.not. lBounds) call utmess('F', 'MECANONLINE_60', sk='ENDO_ORTH_BETON')
    ...
    call pipedo(BEHInteg%materPara, ndim, typmod, dtau, &
                vim, epsm_6, epsp_6, epsd_6, etamin, etamax, &
