        ...
        do inoes = 1, ndeple
            ...
            if (nnm .ne. 0) then
                ...
                do alp = 1, ndim*nsinge
                    ...
                    pose(idim) = pose(idim) - fk_escl(inoes,alp,idim)* (zr(jdepde-1+pl)+zr(jdepm-&
                                 & 1+pl))
                end do
            else
                do alp = 1, ndim*nsinge
    ...
    do idim = 1, ndim
        do inom = 1, nnm
            ...
            do alp = 1, ndim*nsingm
                ...
                posm(idim) = posm(idim) + fk_mait(inom,alp,idim)* (zr( jdepde-1+pl)+zr(jdepm-1+pl&
                             &))
            enddo
        end do
    end do
