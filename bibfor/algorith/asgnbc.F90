...
! --------------------------------------------------------------------
!
subroutine asgnbc(ibla, nbloc, bloca, nbterm, inobl, &
                  iadbl, nomblo, numblo, fact)
    implicit none
#include "jeveux.h"
...
!
    ...
    integer(kind=8) :: nbterm, inobl(nbterm), iadbl(nbterm), ibla, numblo, nbloc
    real(kind=8) :: fact
...
!
!
    integer(kind=8) :: llblo, i, ntria, iblo
