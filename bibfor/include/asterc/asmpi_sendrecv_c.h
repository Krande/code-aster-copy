...
interface
    subroutine asmpi_sendrecv_c(buffer_send, count_send, recipient, tag_send, &
                                buffer_recv, count_recv, sender   , tag_recv, &
                                comm)
        complex(kind=8), intent(inout) :: buffer_send(*), buffer_recv(*)
    ...
    end subroutine asmpi_sendrecv_c
end interface
