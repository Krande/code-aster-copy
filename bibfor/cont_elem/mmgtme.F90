            ...
            do k = 1, ndim
                do l = 1, ndim
                    ...
                    matrme(ii, jj) = matrme(ii, jj)+ &
                                     ...
                                     mprt11(l, k)*ffe(i)*(kappa(1, 1)* &
                                                          kappa(1, 1)+ &
                                                          kappa(1, 2)*kappa(2, 1))* &
                                     (ddffm(1, j)+ddffm(3, j))+ &
                                     mprt12(l, k)*ffe(i)*(kappa(1, 1)* &
                                                          kappa(1, 1)+ &
                                                          kappa(1, 2)*kappa(2, 1))* &
                                     (ddffm(2, j)+ddffm(3, j))+ &
                                     mprt21(l, k)*ffe(i)*(kappa(1, 2)* &
                                                          kappa(1, 1)+ &
                                                          kappa(2, 2)*kappa(1, 2))* &
                                     (ddffm(1, j)+ddffm(3, j))+ &
                                     mprt22(l, k)*ffe(i)*(kappa(1, 2)* &
                                                          kappa(1, 1)+ &
                                                          kappa(2, 2)*kappa(1, 2))* &
                                     (ddffm(3, j)+ddffm(2, j)))+ &
                                     (dlagrc-coefac*jeu)*wpg*jacobi*coefff*( &
                                     mprt11(l, k)*ffe(i)*(kappa(2, 1)* &
                                                          kappa(1, 1)+ &
                                                          kappa(2, 2)*kappa(2, 1))* &
                                     (ddffm(1, j)+ddffm(3, j))+ &
                                     mprt12(l, k)*ffe(i)*(kappa(2, 1)* &
                                                          kappa(1, 1)+ &
                                                          kappa(2, 2)*kappa(2, 1))* &
                                     (ddffm(2, j)+ddffm(3, j))+ &
                                     mprt21(l, k)*ffe(i)*(kappa(1, 2)* &
