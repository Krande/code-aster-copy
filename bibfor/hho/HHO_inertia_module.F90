...
!
        type(HHO_quadrature) :: hhoQuad
        integer(kind=8) :: ipg
        real(kind=8) :: evalues(3), work(50), axes_3d(3, 3), coor(3), qp_coor(3)
        blas_int, parameter :: b_lda = to_blas_int(3), b_lwork = to_blas_int(50)
        blas_int, parameter :: b_n = to_blas_int(3)
        blas_int :: info
!
        axes = 0.d0
!
