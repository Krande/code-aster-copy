...
!
        ...
        integer :: info, mbs
        blas_int :: b_info, b_lda, b_ldb, b_n, b_nhrs
! --------------------------------------------------------------------------------------------------
!
        info = 0
...
!
        ...
        call dposv('U', b_n, b_nhrs, faceMass, b_lda, &
                   coeff_L2Proj, b_ldb, b_info)
...
!
        ...
        call dposv('U', b_n, b_nhrs, cellMass, b_lda, &
                   coeff_L2Proj, b_ldb, b_info)
        info = to_aster_int(b_info)
!
! ---- Sucess ?
