...
!===================================================================================================
!
    subroutine hhoLocalContribTher(hhoCell, hhoData, hhoQuadCellRigi, gradrec, stab, &
                                  fami, typmod, option, lhs, rhs)
!
    implicit none
!
...
!   HHO - thermics
!
!   Compute the local contribution for thermics
...
! ------- Compute rhs
!
            if(l_rhs) call hhoComputeRhsTher(hhoCell, sig_curr, weight, BSCEval, gbs, bT)
!
! ------- Compute lhs
!
            if(l_lhs) call hhoComputeLhsTher(hhoCell, module_tang, weight, BSCEval, gbs, AT)
!
        end do
!
...
!===================================================================================================
!
    subroutine hhoComputeRhsTher(hhoCell, stress, weight, BSCEval, gbs, bT)
!
    implicit none
!
        type(HHO_Cell), intent(in)      :: hhoCell
...
!===================================================================================================
!
    subroutine hhoComputeLhsTher(hhoCell, module_tang, weight, BSCEval, gbs, AT)
!
    implicit none
!
        type(HHO_Cell), intent(in)      :: hhoCell
