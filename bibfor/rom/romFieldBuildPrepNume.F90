...
!
    ...
    integer(kind=8) :: iNodeGrno, iCmpName, iEquaDom
    integer(kind=8), pointer :: grno(:) => null(), grnoInDom(:) => null()
    integer(kind=8) :: nbCmpName, nbEquaDom, nbEquaRom, nbNodeGrno
    integer(kind=8) :: nord, noeq, numeEquaRom, numeEquaDom
!
! --------------------------------------------------------------------------------------------------
!
    call infniv(ifm, niv)
