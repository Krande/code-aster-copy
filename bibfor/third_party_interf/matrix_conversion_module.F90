...
!   Local variables
        ...
        integer(kind=8) :: iret, nsmdi, nvalm, nsmhc
        character(len=32) :: syme
        logical :: lsym
        integer(kind=8) :: irow, icol, irow_csc, icol_csc
        integer(kind=8) :: pstart, pend, pass, pp
        real(kind=8) :: val
        ...
        integer(kind=8) :: nnz_half, nbeq
        integer(kind=8) :: neq, nnz
...
!
    subroutine csc2dense(a_csc, a_dense)
        ...
        !
        integer(kind=8) :: pos, ii, jj, nnz_col, ierr
        !
