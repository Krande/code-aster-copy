...
!
!     VARIABLES LOCALES
    integer(kind=8) :: nsmdi, rang, nbproc, jnequ, jnequl
    integer(kind=8) :: iloc, iglo, nloc, nglo, ndprop
    integer(kind=8) :: bs, i, neq, ieq
    integer(kind=8), dimension(:), pointer         :: nulg => null()
    integer(kind=8), dimension(:), pointer         :: nlgp => null(), pddl => null()
