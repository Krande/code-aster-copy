...
!
!     VARIABLES LOCALES
    integer(kind=8) :: jnequ, jnequl, nloc, nglo, rang
    integer(kind=8) :: nbproc, lmat, neq, bs, ieq
    integer(kind=8) :: iloc, iglo
    integer(kind=8) :: jrefn, jdeeq, numno1, nucmp1
    integer(kind=8), dimension(:), pointer :: nlgp => null(), nulg => null(), prddl => null()
    logical :: ldebug
!
