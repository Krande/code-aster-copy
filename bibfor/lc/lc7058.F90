...
! --------------------------------------------------------------------
! aslint: disable=W1306,W1504,W0104
!
...
!
    if (dbg) then
        ...
        write (6, *) "sigp_loc", (sigp_loc(i), i=1, ndim)
        write (6, *) "vi_loc", (vi_loc(i), i=1, nstatv)
        write (6, *) "stran:", (stran(i), i=1, ndim)
        write (6, *) "dstran:", (dstran(i), i=1, ndim)
        write (6, *) "dtime:", dtime
