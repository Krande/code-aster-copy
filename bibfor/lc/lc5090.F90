...
! --------------------------------------------------------------------------------------------------
!   Relation RELAX_ACIER
! --------------------------------------------------------------------------------------------------
    aster_logical :: lMatr, lSigm, lVari
    integer(kind=8) :: ndimsi
    real(kind=8) :: vi(nvi)
    real(kind=8) :: sig, deps_ther, deps_meca, dsde
! --------------------------------------------------------------------------------------------------
    ...
    call relax_acier_cable(BEHInteg%materPara%schemePara%fami, &
                           BEHInteg%materPara%schemePara%kpg, &
                           BEHInteg%materPara%schemePara%ksp, &
                           BEHInteg%materPara%jvMaterCode, &
                           sigm(1), epsm(1), deps_meca, vim, &
                           sig, vi, dsde)
    codret = 0
