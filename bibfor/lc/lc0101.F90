...
!
! --------------------------------------------------------------------------------------------------
!   RELATION='ELAS': COMPORTEMENT ELASTIQUE ENERGETIQUE (HYPERELASTIQUE)
! --------------------------------------------------------------------------------------------------
...
! --------------------------------------------------------------------------------------------------
    ...
    if (BEHInteg%behavPara%lSigm) then
        ...
        if (BEHInteg%behavPara%lPlaneStress) eps(3) = -nu*(eps(1)+eps(2))

        ! Relation hyperélastique
        sig = lambda*sum(eps(1:3))*kr+deuxmu*eps
    end if
