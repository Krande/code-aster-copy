...
! --------------------------------------------------------------------------------------------------
    ...
    call lcasym(BEHInteg%materPara, option, sigm(1), vim, deps(1), sig, vi, dsde)
    codret = 0
