...
! POUR UNE MAILLE de plaque triangle
!
! --------------------------------------------------------------------------------------------------
!
!                                                        3
...
! - First vector is edge12 => first tangent in plane
    pgl(1, 1) = x21/norm
    pgl(1, 2) = y21/norm
    pgl(1, 3) = z21/norm
...
! - Second vector is edge12 X edge13 (normal to plane)
...
! - Third vector is second tangent in plane
