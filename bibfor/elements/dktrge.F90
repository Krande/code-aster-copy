...
! --------------------------------------------------------------------------------------------------
!
!     matrice de rigiGeomidite geometrique de l'element de plaque dkt
!
! --------------------------------------------------------------------------------------------------
!
    integer(kind=8), parameter :: nbsig = 6, nbcon = 8
    integer(kind=8) :: npg, ipoids
    ...
    real(kind=8) :: effint(24), effgt(24)
    real(kind=8) :: ctor
...
! --------------------------------------------------------------------------------------------------
!
    call elrefe_info(fami='RIGI', jpoids=ipoids)
!
    flex = 0.d0
    memb = 0.d0
    mefl = 0.d0
...
! - Assemblying sub-matrix
    call dxtloc(flex, memb, mefl, ctor, rigiGeom)
!
end
