...
subroutine as_dtrsen(job, compq, select, n, t, &
                     ldt, q, ldq, wr, wi, &
                     m, s, sep, work, lwork, &
                     iwork, liwork, info)
...
#include "asterfort/as_dlacon.h"
#include "asterfort/as_dlrsyl.h"
#include "asterfort/as_dtrexc.h"
...
!
                ierr = 0
                kk = k
                if (k .ne. ks) call as_dtrexc(compq, n, t, ldt, q, &
                                              ldq, kk, ks, work, ierr)
...
!
        ...
        kase = 0
30      continue
        call as_dlacon(nn, work(nn+1), work, iwork, est, &
                       kase)
        if (kase .ne. 0) then
            if (kase .eq. 1) then
!
