...
!
   ...
   character(len=16) :: nomte, phenom, nomodl, tyvois, formul, modelization, elemTypeName
...
!
               ...
               if (lteatt('TYPMOD2', 'HHO', typel=nomte)) then
                  call teattr('C', 'FORMULATION', formul, iret, typel=nomte)
