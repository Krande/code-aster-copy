...
!   dans valm
!   -----------------------------------------------------------------------------
    call jeveuo(jexnum(matass//'.VALM', 1), 'L', jvalm)
...
!   la partie triangulaire inferieure
    if (lmnsy) then
        call jeveuo(jexnum(matass//'.VALM', 2), 'L', jvalm2)
...
!   -----------------------------------------------------------------------------
    ...
    call jelibe(jexnum(matass//'.VALM', 1))
    if (lmnsy) call jelibe(jexnum(matass//'.VALM', 2))
