...
! --------------------------------------------------------------------------------------------------
!
    integer, parameter :: mxnbn2 = 8, mxnbpi = 64, mxnbte = 8, mxnbse = 27
...
!     MXNBSE : MAX DU NOMBRE DE SOUS-ELEMENTS
    integer :: k, typeElemNume, tabno(27), iret1, jobj, numa
    ...
    integer :: npg, nbpi, iagese, nno2, nuse, nbSel
    integer :: ima, nbelgr, nupoin, npoini, iterm, ipoini
    integer :: iret, iField, nch2
    character(len=8) :: ma1, nom, elrefa, fapg, nompar
    ...
    integer :: nterm1(mxnbpi), nbno2(mxnbse), typeCellNume(mxnbse)
