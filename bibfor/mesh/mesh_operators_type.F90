...
! --------------------------------------------------------------------------------------------------
! For MODI_MAILLAGE/ ORIE_HEXA27 operator
! --------------------------------------------------------------------------------------------------
    type MESH_OPER_ORIE_HEXA27
        real(kind=8) :: orieVect(3) = 0.d0
        integer(kind=8) :: nbGroupCell = 0
        character(len=24), pointer :: listOfGroupOfCell(:) => null()
    end type MESH_OPER_ORIE_HEXA27
! --------------------------------------------------------------------------------------------------
...
! --------------------------------------------------------------------------------------------------
    type MESH_OPER_MODI_PARA
        ...
        integer(kind=8) :: orieHex = 0
        type(MESH_OPER_ORIE_HEXA27), pointer :: meshOperOrieHex(:) => null()
        integer(kind=8) :: orieSkin = 0
        integer(kind=8) :: orieLine = 0
    end type MESH_OPER_MODI_PARA
!===================================================================================================
!===================================================================================================
    public :: MESH_OPER_ORIE_SHELL, MESH_OPER_ORIE_HEXA27, MESH_OPER_MODI_PARA
contains
!===================================================================================================
!===================================================================================================
!
