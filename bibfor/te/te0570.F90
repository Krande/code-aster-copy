...
!
            do ino = 1, nno
                i = igeom+3*(ino-1)-1
!
                zr(ivect1+6*(ino-1)+1-1) = &
                    zr(ivect1+6*(ino-1)+1-1)+zr(ivf+ldec+ino-1)*(xgau-xg)*jacpoi
                zr(ivect1+6*(ino-1)+2-1) = &
                    zr(ivect1+6*(ino-1)+2-1)+zr(ivf+ldec+ino-1)*(ygau-yg)*jacpoi
                zr(ivect1+6*(ino-1)+3-1) = &
                    zr(ivect1+6*(ino-1)+3-1)+zr(ivf+ldec+ino-1)*(zgau-zg)*jacpoi
                zr(ivect1+6*(ino-1)+4-1) = &
                    zr(ivect1+6*(ino-1)+4-1)+zr(ivf+ldec+ino-1)*jacpoi
                zr(ivect1+6*(ino-1)+5-1) = &
                    zr(ivect1+6*(ino-1)+5-1)+zr(ivf+ldec+ino-1)*jacpo2
!
!            PRODUIT VECTORIEL N.(THETA.N).
!
                zr(ivect2+6*(ino-1)+1-1) = &
                    zr(ivect2+6*(ino-1)+1-1)+zr(ivf+ldec+ino-1)*(e3yy+e3zz)
                zr(ivect2+6*(ino-1)+2-1) = &
                    zr(ivect2+6*(ino-1)+2-1)-zr(ivf+ldec+ino-1)*e3xy
                zr(ivect2+6*(ino-1)+3-1) = &
                    zr(ivect2+6*(ino-1)+3-1)-zr(ivf+ldec+ino-1)*e3xz
                zr(ivect2+6*(ino-1)+4-1) = &
                    zr(ivect2+6*(ino-1)+4-1)+zr(ivf+ldec+ino-1)*(e3zz+e3xx)
                zr(ivect2+6*(ino-1)+5-1) = &
                    zr(ivect2+6*(ino-1)+5-1)-zr(ivf+ldec+ino-1)*e3yz
                zr(ivect2+6*(ino-1)+6-1) = &
                    zr(ivect2+6*(ino-1)+6-1)+zr(ivf+ldec+ino-1)*(e3yy+e3xx)
            end do
        end do
!
! ---  FIN DE LA BOUCLE SUR LES POINTS D'INTEGRATION
