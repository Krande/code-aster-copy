...
subroutine cpmcpy13_2(conloc, jmacsu, indno, indma, conneo)
!
!
    implicit none
!
...
! -------------------------------------------------------------------------------------------------
    integer :: lino(13), jconloc
! -------------------------------------------------------------------------------------------------
    call jemarq()
! -------------------------------------------------------------------------------------------------
    if (conneo(1) .ne. 0 .and. conneo(2) .ne. 0 .and. conneo(5) .ne. 0) then
! -------------------------------------------------------------------------------------------------
        lino(1) = 1
        lino(2) = 2
        lino(3) = 3
        ...
        lino(13) = 13
! -------------------------------------------------------------------------------------------------
    elseif (conneo(2) .ne. 0 .and. conneo(3) .ne. 0 .and. conneo(5) .ne. 0) then
!--------------------------------------------------------------------------------------------------
        lino(1) = 2
        lino(2) = 3
        lino(3) = 4
        ...
        lino(13) = 10
! -------------------------------------------------------------------------------------------------
    elseif (conneo(3) .ne. 0 .and. conneo(4) .ne. 0 .and. conneo(5) .ne. 0) then
!--------------------------------------------------------------------------------------------------
        lino(1) = 3
        lino(2) = 4
        lino(3) = 1
        ...
        lino(13) = 11
! -------------------------------------------------------------------------------------------------
    elseif (conneo(4) .ne. 0 .and. conneo(1) .ne. 0 .and. conneo(5) .ne. 0) then
!--------------------------------------------------------------------------------------------------
        lino(1) = 4
        lino(2) = 1
        lino(3) = 2
...
! -------------------------------------------------------------------------------------------------
    ...
    zi(jconloc+6-1) = zi(jmacsu+lino(6)-1)
    zi(jconloc+7-1) = zi(jmacsu+lino(7)-1)
    zi(jconloc+8-1) = zi(jmacsu+lino(8)-1)
    zi(jconloc+9-1) = zi(jmacsu+lino(9)-1)
    zi(jconloc+10-1) = indno+conneo(lino(1))-1
    zi(jconloc+11-1) = indno+conneo(lino(2))-1
    zi(jconloc+12-1) = indno+6-1
    zi(jconloc+13-1) = indno+5-1
    ...
    zi(jconloc+5-1) = zi(jmacsu+lino(12)-1)
    zi(jconloc+6-1) = zi(jmacsu+lino(7)-1)
    zi(jconloc+7-1) = zi(jmacsu+lino(11)-1)
    zi(jconloc+8-1) = indno+conneo(lino(5))-1
    zi(jconloc+9-1) = indno+6-1
    zi(jconloc+10-1) = indno+conneo(lino(2))-1
    ...
    zi(jconloc+5-1) = zi(jmacsu+lino(13)-1)
    zi(jconloc+6-1) = zi(jmacsu+lino(8)-1)
    zi(jconloc+7-1) = zi(jmacsu+lino(12)-1)
    zi(jconloc+8-1) = indno+conneo(lino(5))-1
    zi(jconloc+9-1) = indno+5-1
    zi(jconloc+10-1) = indno+6-1
    ...
    zi(jconloc+5-1) = zi(jmacsu+lino(10)-1)
    zi(jconloc+6-1) = zi(jmacsu+lino(9)-1)
    zi(jconloc+7-1) = zi(jmacsu+lino(13)-1)
    zi(jconloc+8-1) = indno+conneo(lino(5))-1
    zi(jconloc+9-1) = indno+conneo(lino(1))-1
    zi(jconloc+10-1) = indno+5-1
