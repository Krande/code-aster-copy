...
subroutine cppy13_1(main, maout, inc, jcoor, jcnnpa, conloc, &
...
#include "asterfort/cpmcpy13_1.h"
...
! --- CREATION DES NOEUDS DDL DANS LE VOLUME
    ...
    call cpncpy13(main, macsu, zr(jcoor), nbno+ind1+5, nomnoe, zi(jconneo))
! --- NOUVEAUX ELEMENTS DE CORPS
    call cpmcpy13_1(conloc, jmacsu, nbno+ind1, ind+4, zi(jconneo))
