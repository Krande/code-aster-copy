...
! - INSERTION DES NOUVEAUX NOEUDS
    ...
    if ( (conneo(4) .ne. 0 .and. conneo(5) .ne. 0 .and.&
          conneo(6) .ne. 0 ) .or.&
         (conneo(1) .ne. 0 .and. conneo(2) .ne. 0 .and.&
          conneo(3) .ne. 0))then
        nbno=3
    else
        nbno=2
...
! ==== NOEUDS MILIEUX 3============================================================================
        ...
        xe(2) = 1.d0/4.d0
        xe(3) = 1.d0/4.d0
        call reerel(eletyp, 15, 3, tabar, xe, xp)
        coor(1,ind+1-1) = xp(1)
        coor(2,ind+1-1) = xp(2)
        coor(3,ind+1-1) = xp(3)
    ! --- NOEUD 2
...
!==================================================================================================
!==================================================================================================
    elseif (conneo(1) .ne. 0 .and. conneo(3) .ne. 0 .and.&
            conneo(4) .ne. 0 .and. conneo(6) .ne. 0) then
! ==== NOEUDS MILIEUX 3============================================================================
        ! --- NOEUD 1
        xp(1:3) = 0.d0
        xe(1) = -1.d0/2.d0
...
!==================================================================================================
!==================================================================================================
    elseif (conneo(4) .ne. 0 .and. conneo(5) .ne. 0 .and.&
            conneo(6) .ne. 0 ) then
! ==== NOEUDS MILIEUX 3============================================================================
        ! --- NOEUD 1
        xp(1:3) = 0.d0
