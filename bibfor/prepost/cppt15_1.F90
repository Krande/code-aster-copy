...
subroutine cppt15_1(main, maout, inc, jcoor, jcnnpa, conloc, &
...
#include "asterfort/cpncpt15.h"
#include "asterfort/cpmcpt15_1.h"
...
! --- CREATION DES NOEUDS DDL DANS LE VOLUME
    ...
    call cpncpt15(main, macsu, zr(jcoor), nbno+ind1+4, nomnoe, zi(jconneo))
! --- NOUVEAUX ELEMENTS DE CORPS
    call cpmcpt15_1(conloc, jmacsu, nbno+ind1, ind+3, zi(jconneo))
