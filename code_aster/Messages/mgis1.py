...
cata_msg = {
    ...
    3: _(
        """Attention, la loi de comportement META_LEMA_ANI utilise les déformations totales et non par les déformations mécaniques comme variables d'entrée dans MFront. Le calcul en post-traitement des grandeurs de déformation EPVC_* et EPME_* est donc faux."""
    ),
    19: _(
