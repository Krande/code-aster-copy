...
cata_msg = {
    ...
    3: _(
        """On a rencontré un problème lors de la lecture de la discrétisation (instants ou fréquences )."""
    ),
    4: _(
        """La structure de données EVOL_NOLI utilisée dans REST_COND_TRAN ne contient pas les champs généralisés.
