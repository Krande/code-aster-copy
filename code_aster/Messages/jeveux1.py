...
"""
    ...
    5: _(
        """
Pour une collection contiguë, il faut définir %(k1)s dans l'ordre de création des objets.
Ce message est un message d'erreur développeur.
Contactez le support technique.
"""
    ),
...
"""
    ...
    64: _(
        """
<INFO> Écriture de %(r3).2f Mo sur la base volatile, supérieur à %(r1).2f fois le volume lu (%(r2).2f Mo).
"""
    ),
    65: _(
        """
...
La mémoire limite pour l'allocation dynamique est fixée à %(r2).2f Mo (%(r3)+.2f Mo).
