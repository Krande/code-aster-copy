...
cata_msg = {
    ...
    11: _(
        """Il y a des conditions limites dualisés (AFFE_CHAR_THER ou AFFE_CHAR_MECA) dans le champ de type %(k1)s. Ce n'est pas possible, utilisez AFFE_CHAR_CINE"""
    ),
    ...
    53: _(
        """Il y a une table des coordonnées réduites attachée à la structure de données des résultats."""
    ),
    54: _(
        """Il n'y a pas de table des coordonnées réduites attachée à la structure de données des résultats."""
    ),
}
