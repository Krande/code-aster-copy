...
"""
    ...
    59: _(
     ...
     Par exemple, il y a %(i1)d mailles de type %(k1)s dans le fichier MED,
...
"""
    ...
    61: _(
     ...
     Par exemple, on dénombre %(i1)d mailles de type %(k1)s dans le maillage
...
"""
    ...
    93: _(
        """
     Fin de l'écriture MED de  %(k1)s en %(r1)f sec
"""
    ),
    94: _(
        """
