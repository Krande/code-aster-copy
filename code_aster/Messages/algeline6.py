...
"""
    ...
    2: _(
        """  Type de la base modale : Classique
  ----------------------
...
"""
    ...
    3: _(
        """  Type de la base modale : Cyclique
  ----------------------
...
"""
    ...
    8: _(
        """  Concept %(k1)s de type %(k2)s issu de l'opérateur %(k3)s.

"""
    ),
    9: _(
        """  Il y a %(i1)d valeur(s) propre(s) dans la bande (%(r1)12.5E ,%(r2)12.5E ) .
"""
    ),
    10: _(
...
"""
    ...
    13: _(
        """  La dimension de l'espace réduit est : %(i1)d
"""
    ),
    14: _(
        """  Elle est inférieure au nombre de modes, on la prend égale à : %(i1)d
"""
    ),
    15: _(
        """  Elle est supérieure au nombre de DDL actifs, on la ramène à ce nombre : %(i1)d
"""
    ),
    16: _(
...
"""
    ...
    17: _(
        """  Les charges critiques calculées sont comprises entre :
...
"""
    ...
    18: _(
        """  La première fréquence inférieure non retenue est : %(r1)12.5E
"""
    ),
    19: _(
        """  La première fréquence supérieure non retenue est : %(r1)12.5E
"""
    ),
    20: _(
        """  La première charge critique inférieure non retenue est : %(r1)12.5E
"""
    ),
    21: _(
        """  La première charge critique supérieure non retenue est : %(r1)12.5E
"""
    ),
    22: _(
...
"""
    ...
    23: _(
        """  Dans l'intervalle (%(r1)12.5E ,%(r2)12.5E ) il y a bien %(i1)d fréquence(s).
"""
    ),
    24: _(
        """  Dans l'intervalle (%(r1)12.5E ,%(r2)12.5E ) il y a bien %(i1)d charges(s) critique(s).
"""
    ),
    25: _(
        """
...
"""
    ...
    28: _(
        """  Vérification du spectre de charges critiques (Méthode de Sturm)
...
"""
    ...
    30: _(
        """  Il n'y a pas de charge critique dans la bande numéro %(i1)d de bornes (%(r1)10.3E ,%(r2)10.3E )
"""
    ),
    31: _(
        """  Nombre de charges critiques supérieures à %(r1)10.3e Hz : %(i1)d
"""
    ),
    32: _(
        """  Nombre de charges critiques dans la bande numéro %(i1)d de bornes (%(r1)10.3E ,%(r2)10.3E ) : %(i2)d
"""
    ),
    33: _(
...
"""
    ...
    35: _(
        """  Il n'y a pas de fréquence dans la bande numéro %(i1)d de bornes (%(r1)10.3E ,%(r2)10.3E )
"""
    ),
    36: _(
        """  Nombre de fréquences propres inférieures à %(r1)10.3E Hz : %(i1)d
"""
    ),
    37: _(
        """  Nombre de fréquences dans la bande numéro %(i1)d de bornes (%(r1)10.3E ,%(r2)10.3E ) : %(i2)d
"""
    ),
    38: _(
        """  Vérification du spectre en fréquences (Méthode de l'argument principal)

"""
    ),
    39: _(
        """  Il n'y a pas de fréquence dans le disque centré en (%(r1)10.3E ,%(r2)10.3E ) et de rayon %(r3)10.3E .
"""
    ),
    40: _(
        """  Nombre de fréquences dans le disque centré en (%(r1)10.3E ,%(r2)10.3E ) et de rayon %(r3)10.3E : %(i1)d
"""
    ),
    41: _(
        """  L'option choisie est : %(k1)s
"""
    ),
    42: _(
        """  La valeur de décalage en fréquence est : %(r1)12.5E
"""
    ),
    43: _(
        """  La valeur de décalage en charge critique est : %(r1)12.5E
"""
    ),
    44: _(
        """  La valeur de décalage (pulsation au carré) est inférieure à la valeur de corps rigide.
  On la modifie et elle devient : %(r1)12.5E
"""
    ),
    45: _(
        """  On augmente la valeur de décalage de %(r2)12.5E %%.
  La valeur centrale devient : %(r1)12.5E
"""
    ),
    46: _(
        """  La valeur minimale est inférieure à la valeur de corps rigide.
  On la modifie et elle devient : %(r1)12.5E
"""
    ),
    47: _(
        """  On diminue la valeur minimale de %(r2)12.5E %%.
  La valeur minimale devient : %(r1)12.5E
"""
    ),
    48: _(
        """  La valeur maximale est inférieure à la valeur de corps rigide.
  On la modifie et elle devient : %(r1)12.5E
"""
    ),
    49: _(
        """  On augmente la valeur maximale de %(r2)12.5E %%.
...
"""
    ...
    51: _(
        """%(i1)10d   %(i2)8d   %(r1)12.5E   %(r2)12.5E   %(r5)12.5E   %(r3)12.5E   %(r6)12.5E   %(r4)12.5E   %(r7)12.5E
"""
    ),
    52: _(
        """
...
"""
    ...
    53: _(
        """%(i1)10d   %(i2)8d   %(r1)12.5E   %(r2)12.5E   %(r3)12.5E   %(r4)12.5E
"""
    ),
    54: _(
        """
...
"""
    ...
    55: _(
        """%(i1)10d   %(i2)8d   %(r1)12.5E   %(r2)12.5E   %(r3)12.5E
"""
    ),
    56: _(
        """
...
"""
    ...
    57: _(
        """%(i1)10d   %(i2)8d   %(r1)12.5E   %(r2)12.5E
"""
    ),
    58: _(
        """
...
"""
    ...
    61: _(
        """ %(i1)4d      %(r2)12.5E       %(r1)12.5E      %(i2)4d          %(i3)4d
"""
    ),
    62: _(
        """     Calcul modal : Méthode d'itération simultanée
...
"""
    ...
    72: _(
        """%(i1)4d       %(r2)12.5E      %(r1)12.5E      %(r3)12.5E
"""
    ),
    73: _(
...
"""
    ...
    77: _(
        """     Calcul modal : Méthode d'itération inverse
...
"""
    ...
    89: _(
        """Le nombre maximal d'itérations NMAX_ITER_SOREN = %(i1)d  a été atteint.
"""
    ),
    90: _(
        """Aucun shift ne peut être appliqué.
"""
    ),
    91: _(
        """
...
"""
    ...
    92: _(
        """ On modifie la valeur de décalage de %(r2)12.5E %%
 La valeur de décalage devient : %(r1)12.5E
"""
    ),
    93: _(
        """  La valeur minimale en fréquence est : %(r1)12.5E
  La valeur maximale en fréquence est : %(r2)12.5E
"""
    ),
    94: _(
        """  La valeur minimale en charge critique est : %(r1)12.5E
