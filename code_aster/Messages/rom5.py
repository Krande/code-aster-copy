...
cata_msg = {
    ...
    5: _(
        """On a %(i1)d valeurs singulières comprises entre %(r1)13.6G et %(r2)13.6G . Avec les paramètres, on a retenu %(i2)d modes empiriques."""
    ),
    6: _(
        """Le critère de sélection des valeurs singulières ne permet pas d'extraire au moins un mode empirique. Il faut changer la tolérance ou le nombre de modes."""
    ),
    ...
    41: _(
        """Lecture des paramètres pour réaliser le calcul non-linéaire avec réduction de modèle."""
    ),
    ...
    46: _(
        """Valeur du coefficient complexe pour le vecteur de nom %(k1)s : (%(r1)19.12e,%(r2)19.12e)."""
    ),
    47: _("""Valeur du coefficient réel pour la matrice de nom %(k1)s : %(r1)19.12e."""),
    48: _(
        """Valeur du coefficient complexe pour la matrice de nom %(k1)s : (%(r1)19.12e,%(r2)19.12e)."""
    ),
    49: _(
        """La base empirique ne repose pas sur le même modèle sur le calcul non-linéaire. Si vous utilisez le mode d'intégration sur domaine réduit, vérifiez que vous avez bien tronqué les bases (OPERATION='TRONCATURE' dans la commande DEFI_BASE_REDUITE)."""
    ),
