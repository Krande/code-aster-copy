...
cata_msg = {
    ...
    6: _(
        """ Initialisations pour la gestion des paramètres de l'algorithme de résolution non-linéaire."""
    ),
    ...
    13: _(""" Initialisations pour la gestion des critères de convergence (avec le contact)."""),
    ...
    29: _(
        """ Initialisations des structures de données pour la résolution des liaisons unilatérales."""
    ),
    ...
    49: _(
        """ Ajustement de la direction de descente (pilotage et recherche linéaire si ils sont activés)."""
    ),
