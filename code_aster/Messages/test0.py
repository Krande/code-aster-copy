...
"""
    ...
    13: _("""  Entiers :"""),
    14: _("""  Réels :"""),
    15: _("""  Nombre de valeurs : %(i1)-17d                       %(i2)-17d"""),
    16: _("""  Somme des valeurs : %(i1)-17d                       %(i2)-17d"""),
    17: _("""  Somme des valeurs : %(r1)17.10e                  %(r2)17.10e"""),
    18: _(
        """  Somme de contrôle : %(k1)s  %(k2)s
...
"""
    ...
    19: {
        "message": _(
            """Attention: Il s'agit d'un test de validation, on ne vérifie
pas la non régression."""
        ),
        "flags": "DECORATED",
    },
    20: _("""  Le groupe de maille %(k1)s contient %(i1)d mailles, il en faut une au maximum """),
    21: _(
        """
Valeur de TYPE_TEST non supportée en mode parallèle distribué : '%(k1)s'
"""
    ),
}
