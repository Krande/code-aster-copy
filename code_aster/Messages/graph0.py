...
cata_msg = {
    1: _(
        """'%(k1)s' doit être une liste de 2 ou 3 listes de réels de même longueur.
"""
    ),
    2: _(
        """'%(k1)s' doit être une liste de 2 ou 3 chaînes de caractères.
"""
    ),
    3: _(
        """Le format est inconnu : %(k1)s.
"""
    ),
    4: _(
        """On limite la fenêtre aux abscisses positives.
"""
    ),
    5: _(
        """On limite la fenêtre aux ordonnées positives.
"""
    ),
    6: _(
...
"""
    ...
    8: _(
        """On fixe la variable DISPLAY à %(k1)s.
"""
    ),
    9: _(
        """Erreur lors de l'utilisation du filtre '%(k1)s'.
