...
"""
    ...
    7: _(
        """
On ne traite pas, pour l'instant, l'option PLUS_GRANDE avec une matrice de rigidité
comportant des blocages imposés avec AFFE_CHAR_CINE.

Solution:imposer ces blocages avec AFFE_CHAR_MECA.
"""
    ),
    8: _(
        """
