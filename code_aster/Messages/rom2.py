...
cata_msg = {
    ...
    29: _(
        """Le nombre de coefficients pour faire varier les fonctions n'est pas le même pour tous les paramètres."""
    ),
    31: _(
        """Le coefficient devant le second membre est une fonction et il n'y a aucune donnée sur la variation de cette fonction."""
    ),
    ...
    52: _(
        """Coefficient réduit pour le mode %(i1)d et le paramètre %(i2)d: (%(r1)19.12e,%(r2)19.12e)."""
    ),
