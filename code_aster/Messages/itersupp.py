...
cata_msg = {
    2: _(
        """          On ne peux pas tenter d'autoriser des itérations de Newton supplémentaires car on dépasse déjà le nombre
                   d'itérations maximum autorisé <%(i1)d>.
"""
    ),
    3: _("""          On estime qu'on va pouvoir converger en <%(i1)d> itérations de Newton."""),
    4: _(
    ...
    6: _(
        """ <Action><Échec> Échec dans la tentative d'autoriser des itérations de Newton supplémentaires."""
    ),
    7: _(""" <Action> On autorise des itérations de Newton supplémentaires."""),
}
