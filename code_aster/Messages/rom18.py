...
cata_msg = {
    ...
    14: _(
        """Pour les modèles linéiques, le nombre de composantes par noeud doit être constant. Vérifiez que vous n'avez pas de chargements de Dirichlet appliqués avec AFFE_CHAR_MECA."""
    ),
    15: _("""Initialisation de la base pour la méthode GLOUTON."""),
    16: _("""Initialisation de la base pour la méthode de troncature."""),
    17: _(
        """Lecture de la base à tronquer. La base tronquée aura le même nom que la base à tronquer."""
    ),
    ...
    21: _(
        """Vous avez donné le nom de la base alors que vous voulez modifier une base déjà existante."""
    ),
    22: _("""Initialisation de la base pour la méthode d'orthogonalisation."""),
    23: _(
        """Lecture de la base à orthonormaliser. La base orthonormalisée aura le même nom que la base initiale."""
    ),
    ...
    36: _(
        """On ne peut pas procéder à l'orthogonalisation d'une base avec des modes définis sur un autre support que les noeuds (ici le support est %(k1)s)."""
    ),
    ...
    40: _(
        """Le calcul d'une base réduite pour le calcul multi-paramétrique avec réduction de modèle nécessite de faire varier les coefficients."""
    ),
    41: _(
        """On ne peut pas calculer une base avec des modes définis sur un autre support que les noeuds (ici le support est %(k1)s)."""
    ),
    ...
    45: _(
        """On ne peut pas tronquer une base avec des modes définis sur un autre support que les noeuds (ici le support est %(k1)s)."""
    ),
