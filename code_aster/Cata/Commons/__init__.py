...
def compat_union(*funcs):
    """Return a function that embeds several *compat_syntax* functions.

    Arguments:
        funcs (tuple[func]): *compat_syntax* functions to be applied.
    """

    def compat_syntax_func(keywords):
        for func in funcs:
            func(keywords)

    return compat_syntax_func
