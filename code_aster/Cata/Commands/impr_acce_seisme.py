...
IMPR_ACCE_SEISME = MACRO(
    nom="IMPR_ACCE_SEISME",
    op=OPS("code_aster.MacroCommands.impr_acce_seisme_ops.impr_acce_seisme_ops"),
    reentrant="n",
    ...
    NOCI_REFE=FACT(
        ...
        AMAX=SIMP(
            statut="f", typ="R", min=3, max=3, fr=tr("Valeur moyenne et intervalle de confiance")
        ),
        VMAX=SIMP(
            statut="f", typ="R", min=3, max=3, fr=tr("Valeur moyenne et intervalle de confiance")
        ),
