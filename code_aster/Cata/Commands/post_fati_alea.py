...
POST_FATI_ALEA = OPER(
    ...
    reentrant="n",
    fr=tr(
        "Calculer le dommage de fatigue subi par une structure soumise à une sollicitation de type aléatoire"
    ),
    regles=(
        ENSEMBLE("MOMENT_SPEC_0", "MOMENT_SPEC_2"),
    ...
    DUREE=SIMP(statut="f", typ="R", defaut=1.0),
