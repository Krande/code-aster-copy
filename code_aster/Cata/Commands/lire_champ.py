...
LIRE_CHAMP = OPER(
    ...
    b_format=BLOC(
        ...
        b_precision=BLOC(
            ...
            b_prec_abso=BLOC(
                ...
                PRECISION=SIMP(
                    statut="o", typ="R", fr=tr("Précision sur le choix de l'instant associé")
                ),
            ),
        ),
        #
    ...
    b_modele=BLOC(
        condition="""exists("TYPE_CHAM") and (TYPE_CHAM[0:2] == 'EL')""",
