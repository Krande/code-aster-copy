...
# ======================================================================
     b_ze200   =BLOC(condition="""equal_to("TYPE_RESU_MECA", 'ZE200a') or equal_to("TYPE_RESU_MECA", 'ZE200b')""",
         ...
         SOUS_CYCL         =SIMP(statut='f',typ='TXM',defaut="NON",into=("OUI","NON"),
         ...
         SEISME         =FACT(statut='f',max=1,fr=tr("Situation séisme"),
     ...
     b_ze200a  =BLOC(condition="""equal_to("TYPE_RESU_MECA", 'ZE200a')""",
         ...
         SITUATION         =FACT(statut='o',max='**',fr=tr("Situation"),
              ...
              NUME_GROUPE      =SIMP(statut='o',typ='I',min=1,max=20,
                                        fr=tr("numéro du ou des groupes de la situation") ),
              NUME_PASSAGE     =SIMP(statut='f',typ='I',min=2,max=20,
                                     fr=tr("numéros des groupes de la situation de passage") ),
              NUME_PARTAGE     =SIMP(statut='f',typ='I',min=1,max=1,
                                     fr=tr("numéro du groupe de partage") ),
     ...
     b_b3200  =BLOC(condition="""equal_to("TYPE_RESU_MECA", 'B3200')""",
         ...
         SITUATION         =FACT(statut='o',max='**',fr=tr("Situation"),
              ...
              NUME_PARTAGE     =SIMP(statut='f',typ='I',min=1,max=1,
                                     fr=tr("numéro du groupe de partage") ),
              NUME_RESU_THER   =SIMP(statut='f',typ='I',max=1,fr=tr("numero du transitoire thermique") ),
              regles=(UN_PARMI('CHAR_ETAT_A','NUME_RESU_MECA'),PRESENT_ABSENT('PRES_A','NUME_RESU_PRES'),
...
# ======================================================================
     b_tuyauterie  =BLOC(condition="""equal_to("TYPE_RESU_MECA", 'B3600')""",
         ...
         b_fatigue       =BLOC(condition="""equal_to("OPTION", 'FATIGUE')""",
         ...
         b_momeq       =BLOC(condition="""equal_to("OPTION", 'MOMENT_EQUIVALENT')""",
            RESU_MECA   =FACT(statut='o',max=1,fr=tr("Chargements mécaniques"),
              regles=(UN_PARMI('CHAM_GD','RESULTAT'),),
              ...
              b_extrac        =BLOC(condition="""exists("RESULTAT")""",
                ...
                NOM_CHAM        =SIMP(statut='f',typ='TXM',default="EFGE_ELNO",into=("EFGE_ELNO",),),
                TOUT_ORDRE      =SIMP(statut='f',typ='TXM',into=("OUI",) ),
                NUME_ORDRE      =SIMP(statut='f',typ='I',),
                INST            =SIMP(statut='f',typ='R',),
                b_acce_reel     =BLOC(condition="""(exists("INST"))""",
