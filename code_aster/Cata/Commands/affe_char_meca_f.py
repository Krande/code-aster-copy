...
AFFE_CHAR_MECA_F=OPER(nom="AFFE_CHAR_MECA_F",op=7,sd_prod=char_meca,
        ...
        regles=(AU_MOINS_UN('DDL_IMPO','FACE_IMPO','LIAISON_DDL','FORCE_NODALE',
                            ...
                            'EFFE_FOND','FLUX_THM_REP','ECHANGE_THM',),),
         ...
         DDL_IMPO        =FACT(statut='f',max='**',
           ...
           regles=(AU_MOINS_UN('TOUT','GROUP_MA','MAILLE','GROUP_NO','NOEUD'),
                   AU_MOINS_UN('DX','DY','DZ','DRX','DRY','DRZ','DRGX','DRGY','DRGZ','GRX','PRES','PHI',
                               'TEMP','PRE1','PRE2','GONF','BLOCAGE','H1X',
...
#  rajout d un mot cle REPERE : / GLOBAL / LOCAL
         ...
         LIAISON_GROUP   =FACT(statut='f',max='**',
           ...
           regles=(UN_PARMI('GROUP_MA_1','GROUP_NO_1','NOEUD_1'),
...
#  rajout d un mot cle REPERE : / GLOBAL / LOCAL
           ...
           b_force = BLOC(condition = """equal_to("TYPE_CHARGE", 'FORCE')""",
                          regles=(
                    AU_MOINS_UN('FX','FY','FZ','MX','MY','MZ','MGX','MGY','MGZ','N','VY','VZ','MT','MFY','MFZ'),
...
#  rajout d un mot cle REPERE : / GLOBAL / LOCAL
         ...
         LIAISON_COQUE   =FACT(statut='f',max='**',
             ...
             regles=(AU_MOINS_UN('GROUP_MA_1','GROUP_MA_2',
         ...
         ECHANGE_THM    =FACT(statut='f',max='**',
             fr=tr("Applique à un domaine de milieu continu 2D ou 3D une condition echange dont les valeurs des coef sont des fonctions"
                  "(flux hydraulique)"),
             regles=(AU_MOINS_UN('TOUT','GROUP_MA','MAILLE'),
                     PRESENT_ABSENT('TOUT','GROUP_MA','MAILLE'),
