...
CALC_ERREUR = OPER(
    ...
    b_sing=BLOC(
        condition="""is_in('OPTION', 'SING_ELEM')""",
        PREC_ERR=SIMP(
            statut="o",
            typ="R",
            val_min=0.0,
        ...
        TYPE_ESTI=SIMP(
            statut="f",
            typ="TXM",
            into=("ERME_ELEM", "ERZ1_ELEM", "ERZ2_ELEM", "QIRE_ELEM", "QIZ1_ELEM", "QIZ2_ELEM"),
