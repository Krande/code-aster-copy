...
def macro_matr_ajou_prod(
    self, MATR_AMOR_AJOU=None, MATR_MASS_AJOU=None, MATR_RIGI_AJOU=None, FORC_AJOU=None, **args
):
    if args.get("__all__"):
        return (
            [None],
