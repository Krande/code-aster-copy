...
DEFI_PROP_ALEA = MACRO(
    ...
    regles=(
        AU_MOINS_UN("LONG_CORR_X", "LONG_CORR_Y", "LONG_CORR_Z"),
        EXCLUS("PRECISION", "NB_TERM"),
    ),
