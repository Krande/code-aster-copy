...
EXTR_MODE = OPER(
    nom="EXTR_MODE",
    op=168,
    sd_prod=extr_mode_prod,
    reentrant="n",
    fr=tr("Extraire séléctivement des modes des structures de données modales"),
    FILTRE_MODE=FACT(
        statut="o",
        max="**",
        regles=(
            UN_PARMI(
                "TOUT_ORDRE", "NUME_ORDRE", "NUME_MODE", "NUME_MODE_EXCLU", "FREQ_MIN", "CRIT_EXTR"
            ),
        ),
