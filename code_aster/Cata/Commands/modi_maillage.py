...
MODI_MAILLAGE=OPER(nom="MODI_MAILLAGE",op= 154,sd_prod=maillage_sdaster,
      ...
      regles=(AU_MOINS_UN('ORIE_FISSURE','DEFORME','ORIE_PEAU',
              ...
              PRESENT_ABSENT('ORIE_FISSURE','DEFORME','ORIE_PEAU',
                       'ORIE_NORM_COQUE','MODI_MAILLE',
                       'ORIE_LIGNE'),
              PRESENT_ABSENT('DEFORME','ORIE_FISSURE','ORIE_PEAU',
                       'ORIE_NORM_COQUE','MODI_MAILLE',
                       'ORIE_LIGNE'),
              PRESENT_ABSENT('ORIE_FISSURE','DEFORME','ORIE_PEAU',
                       'ORIE_NORM_COQUE','MODI_MAILLE',
                       'ORIE_LIGNE'),
              PRESENT_ABSENT('ORIE_PEAU','ORIE_FISSURE','DEFORME',
                       'ORIE_NORM_COQUE','MODI_MAILLE',
                       'ORIE_LIGNE'),
              PRESENT_ABSENT('ORIE_NORM_COQUE','ORIE_FISSURE','DEFORME',
                       'ORIE_PEAU','MODI_MAILLE','ORIE_LIGNE'),
              PRESENT_ABSENT('ORIE_FISSURE','DEFORME','ORIE_PEAU',
                       'ORIE_NORM_COQUE','MODI_MAILLE','ORIE_LIGNE'),
              PRESENT_ABSENT('MODI_MAILLE','ORIE_FISSURE','DEFORME','ORIE_PEAU',
                       'ORIE_NORM_COQUE','ORIE_LIGNE'),
