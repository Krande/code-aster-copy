...
#
         ...
         AFFE            =FACT(statut='f',max='**',
           ...
           PHENOMENE       =SIMP(statut='o',typ='TXM',
                ...
                b_formu_fsi =BLOC( condition = """equal_to('MODELISATION', ('2D_FLUIDE', '2D_FLUI_ABSO', '2D_FLUI_PESA', '2D_FLUI_STRU','3D_FLUIDE','3D_FLUI_ABSO', 'AXIS_FLUIDE', 'AXIS_FLUI_STRU', 'FLUI_STRU'))""",
                     ...
                     FORMULATION    =SIMP(statut='f',typ='TXM',max=1,into=("U_P_PHI","U_P","U_PSI"), defaut="U_P_PHI"),),
                ),
         ...
         DISTRIBUTION   =FACT(statut='d',
             ...
             b_partition  =BLOC(condition = """equal_to("METHODE",'SOUS_DOMAINE' )""",
