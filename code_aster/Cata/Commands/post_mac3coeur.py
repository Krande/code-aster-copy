...
POST_MAC3COEUR = MACRO(nom="POST_MAC3COEUR",
                       ...
                       LAME    = FACT(statut='f',max=1,
                                      fr=tr("Post-traitement des lames d'eau"),
                       ...
                       FORCE_CONTACT    = FACT(statut='f',max=1,
                                               fr=tr("Post-traitement des efforts de contact"),
                                               UNITE        = SIMP(statut='o',typ=UnitType(), inout='out',
                                                                   fr=tr("Numéro de l'unité logique pour le post-traitement")),
                                               FORMAT       = SIMP(statut='o',typ='TXM',into=("TABLE",)),
                       ...
                       DEFORMATION = FACT(statut='f',max=1,
                                          fr=tr("Post-traitement des deformations"),
                                          UNITE        = SIMP(statut='o',typ=UnitType(), inout='out'),
                                          FORMAT       = SIMP(statut='o',typ='TXM',into=("TABLE",)),
