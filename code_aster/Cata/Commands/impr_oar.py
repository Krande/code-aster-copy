...
IMPR_OAR = MACRO(
    ...
    b_composant=BLOC(
        condition="""equal_to("TYPE_CALC", 'COMPOSANT') """,
        ...
        RESU_MECA=FACT(
            ...
            TYPE=SIMP(
                statut="f", typ="TXM", defaut="FX", into=("FX", "FY", "FZ", "MX", "MY", "MZ", "PRE")
            ),
    ...
    b_mef=BLOC(
        condition="""equal_to("TYPE_CALC", 'MEF') """,
        regles=(AU_MOINS_UN("RESU_MECA", "RESU_THER")),
        DIAMETRE=SIMP(statut="o", typ="R"),
        ORIGINE=SIMP(statut="f", typ="TXM", defaut="INTERNE", into=("INTERNE", "EXTERNE")),
        COEF_U=SIMP(statut="f", typ="R", defaut=1.0),
    ...
    b_tuyauterie=BLOC(
        condition="""equal_to("TYPE_CALC", 'TUYAUTERIE') """,
        RESU_MECA=FACT(
            statut="o",
            max="**",
            NUM_CHAR=SIMP(statut="o", typ="I"),
