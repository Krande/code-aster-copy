...
PROJ_SPEC_BASE = OPER(
    ...
    reentrant="n",
    fr=tr(
        "Projecter un ou plusieurs spectres de turbulence sur une (ou plusieurs) base(s) modale(s) "
    ),
    regles=(
    ...
    FREQ_INIT=SIMP(statut="o", typ="R", val_min=0.0e0),
    FREQ_FIN=SIMP(statut="o", typ="R", val_min=0.0e0),
