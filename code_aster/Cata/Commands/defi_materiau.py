...
DEFI_MATERIAU = MACRO(
    ...
    FLUA_PORO_BETON=FACT(
        ...
        HYDR=SIMP(statut="o", typ=(fonction_sdaster, nappe_sdaster, formule, "R")),
        ...
        PORO=SIMP(statut="f", typ=(fonction_sdaster, nappe_sdaster, formule, "R"), defaut=1.0),
    ...
    RGI_BETON=FACT(
        ...
        BSHR=SIMP(statut="f", typ="R", defaut=0.0),
        MSHR=SIMP(statut="f", typ="R", defaut=0.0),
        PORO=SIMP(statut="o", typ=(fonction_sdaster, nappe_sdaster, formule, "R")),
        SFLD=SIMP(statut="f", typ="R", defaut=0.0),
        MVGN=SIMP(statut="f", typ="R", defaut=0.0),
        ...
        CNAD=SIMP(statut="o", typ=(fonction_sdaster, nappe_sdaster, formule, "R")),
