...
DEFI_MATERIAU = MACRO(
    ...
    ELAS=FACT(
        ...
        regles=(
            ...
            ENSEMBLE("E", "NU"),
            ENSEMBLE("K", "MU"),
            ENSEMBLE("CELE_P", "CELE_S"),
            PRESENT_PRESENT("CELE_P", "RHO"),
        ),
        E=SIMP(statut="f", typ="R", val_min=0.0),
        NU=SIMP(statut="f", typ="R", val_min=-1.0, val_max=0.5),
        K=SIMP(statut="f", typ="R", val_min=0.0),
        MU=SIMP(statut="f", typ="R", val_min=0.0),
        CELE_P=SIMP(statut="f", typ="R", val_min=0.0),
        CELE_S=SIMP(statut="f", typ="R", val_min=0.0),
    ...
    ELAS_ISTR=FACT(
        ...
        RHO=SIMP(statut="f", typ="R"),
        ALPHA_L=SIMP(statut="f", typ="R", defaut=0.0),
        ALPHA_N=SIMP(statut="f", typ="R", defaut=0.0),
    ),
    ELAS_ISTR_FO=FACT(
        statut="f",
        regles=(
    ...
    ELAS_ORTH=FACT(
        ...
        RHO=SIMP(statut="f", typ="R"),
        ALPHA_L=SIMP(statut="f", typ="R", defaut=0.0),
        ALPHA_T=SIMP(statut="f", typ="R", defaut=0.0),
        ALPHA_N=SIMP(statut="f", typ="R", defaut=0.0),
    ...
    ELAS_HYPER_VISC=FACT(
        ...
        # hidden keywords
        G1=SIMP(statut="c", defaut=0.0, typ="R"),
        G2=SIMP(statut="c", defaut=0.0, typ="R"),
        G3=SIMP(statut="c", defaut=0.0, typ="R"),
        G4=SIMP(statut="c", defaut=0.0, typ="R"),
        G5=SIMP(statut="c", defaut=0.0, typ="R"),
        G6=SIMP(statut="c", defaut=0.0, typ="R"),
        G7=SIMP(statut="c", defaut=0.0, typ="R"),
        G8=SIMP(statut="c", defaut=0.0, typ="R"),
        G9=SIMP(statut="c", defaut=0.0, typ="R"),
        G10=SIMP(statut="c", defaut=0.0, typ="R"),
        TAU1=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU2=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU3=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU4=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU5=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU6=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU7=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU8=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU9=SIMP(statut="c", defaut=1.0, typ="R"),
        TAU10=SIMP(statut="c", defaut=1.0, typ="R"),
        NV=SIMP(statut="c", typ="R"),
    ),
    ELAS_COQUE=FACT(
        statut="f",
        regles=(
    ...
    ELAS_GLRC=FACT(
        ...
        E_M=SIMP(statut="o", typ="R", val_min=0.0),
        NU_M=SIMP(statut="o", typ="R", val_min=0.0, val_max=0.5 + 0),
        E_F=SIMP(statut="f", typ="R", val_min=0.0),
        NU_F=SIMP(statut="f", typ="R", val_min=0.0, val_max=0.5 + 0),
        BT1=SIMP(statut="f", typ="R", val_min=0.0),
        BT2=SIMP(statut="f", typ="R", val_min=0.0, val_max=0.5 + 0),
        RHO=SIMP(statut="f", typ="R", val_min=0.0),
        ALPHA=SIMP(statut="f", typ="R"),
        AMOR_ALPHA=SIMP(statut="f", typ="R"),
        AMOR_BETA=SIMP(statut="f", typ="R"),
        AMOR_HYST=SIMP(statut="f", typ="R"),
    ...
    CIN1_CHAB=FACT(
        ...
        B=SIMP(statut="f", typ="R", defaut=0.0),
        C_I=SIMP(statut="o", typ="R"),
        K=SIMP(statut="f", typ="R", defaut=1.0),
        W=SIMP(statut="f", typ="R", defaut=0.0),
        G_0=SIMP(statut="o", typ="R"),
        A_I=SIMP(statut="f", typ="R", defaut=1.0),
    ),
    CIN1_CHAB_FO=FACT(
        statut="f",
        R_0=SIMP(statut="o", typ=(fonction_sdaster, nappe_sdaster, formule)),
    ...
    CIN2_NRAD=FACT(
        statut="f",
        DELTA1=SIMP(statut="f", typ="R", defaut=1.0, val_min=0.0, val_max=1.0),
        DELTA2=SIMP(statut="f", typ="R", defaut=1.0, val_min=0.0, val_max=1.0),
    ),
    MEMO_ECRO=FACT(
        statut="f",
        ...
        ETA=SIMP(statut="f", typ="R", defaut=0.5),
    ),
    MEMO_ECRO_FO=FACT(
        statut="f",
    ...
    VISCOCHAB=FACT(
        ...
        A_K=SIMP(statut="f", typ="R", defaut=0.0),
        A_R=SIMP(statut="f", typ="R", defaut=1.0),
        K=SIMP(statut="o", typ="R"),
        N=SIMP(statut="o", typ="R"),
        ALP=SIMP(statut="f", typ="R", defaut=0.0),
        B=SIMP(statut="o", typ="R"),
        M_R=SIMP(statut="f", typ="R", defaut=1.0),
        G_R=SIMP(statut="f", typ="R", defaut=0.0),
        MU=SIMP(statut="f", typ="R", defaut=0.0),
        Q_M=SIMP(statut="o", typ="R"),
        Q_0=SIMP(statut="o", typ="R"),
        QR_0=SIMP(statut="f", typ="R", defaut=0.0),
        ETA=SIMP(statut="f", typ="R", defaut=0.5),
        C1=SIMP(statut="o", typ="R"),
        M_1=SIMP(statut="f", typ="R", defaut=1.0),
        D1=SIMP(statut="f", typ="R", defaut=1.0),
        G_X1=SIMP(statut="f", typ="R", defaut=0.0),
        G1_0=SIMP(statut="o", typ="R"),
        C2=SIMP(statut="o", typ="R"),
        M_2=SIMP(statut="f", typ="R", defaut=1.0),
        D2=SIMP(statut="f", typ="R", defaut=1.0),
        G_X2=SIMP(statut="f", typ="R", defaut=0.0),
        G2_0=SIMP(statut="o", typ="R"),
        A_I=SIMP(statut="f", typ="R", defaut=1.0),
        ORDRE_PARAM=SIMP(
            statut="c",
    ...
    LEMAITRE=FACT(
        ...
        UN_SUR_M=SIMP(statut="f", typ="R", defaut=0.0),
    ),
    LEMAITRE_IRRA=FACT(
        statut="f",
        N=SIMP(statut="o", typ="R"),
    ...
    FONDA_SUPERFI=FACT(
        statut="f",
        LONG_X=SIMP(statut="o", typ="R", val_min=0.0),
        LONG_Y=SIMP(statut="o", typ="R", val_min=0.0),
        PHI=SIMP(statut="o", typ="R", val_min=0.0),
        COHESION=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        RAID_GLIS=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        GAMMA_REFE=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        CP_SERVICE=SIMP(statut="o", typ="R", val_min=0.0),
        CP_ULTIME=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        DEPL_REFE=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        RAID_CP_X=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        GAMMA_CP_X=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        RAID_CP_Y=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        GAMMA_CP_Y=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        RAID_CP_RX=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        GAMMA_CP_RX=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
    ...
    ENDO_LOCA_TC_FO=FACT(
        ...
        SEUIL_INIT_COMP=SIMP(statut="o", typ=(fonction_sdaster, nappe_sdaster, formule)),
    ...
    BETON_DOUBLE_DP=FACT(
        ...
        COEF_ELAS_COMP=SIMP(statut="o", typ="R", val_min=0.0, val_max=100.0),
        LONG_CARA=SIMP(statut="f", typ="R", val_min=0.0),
    ...
    BETON_GLRC=FACT(
        statut="f",
        FCJ=SIMP(statut="o", typ="R", val_min=0.0),
        EPSI_C=SIMP(statut="o", typ="R", val_min=0.0),
        FTJ=SIMP(statut="o", typ="R", val_min=0.0),
    ),
    MAZARS=FACT(
        statut="f",
        ...
        CHI=SIMP(statut="f", typ="R", val_min=0.0, val_max=1.0),
        SIGM_LIM=SIMP(statut="f", typ="R"),
        EPSI_LIM=SIMP(statut="f", typ="R"),
    ),
    MAZARS_FO=FACT(
    ...
    JOINT_BA=FACT(
        statut="f",
        max=1,
        HPEN=SIMP(statut="f", typ="R", defaut=1.0, val_min=0.0),
        GTT=SIMP(statut="o", typ="R", val_min=0.0),
        GAMD0=SIMP(statut="o", typ="R", val_min=1.0e-4, val_max=1.0e-1),
        AD1=SIMP(statut="o", typ="R", val_min=0.0),
        BD1=SIMP(statut="f", typ="R", defaut=5.0e-1, val_min=1.0e-1),
        GAMD2=SIMP(statut="o", typ="R", val_min=1.0e-4, val_max=1.0),
        AD2=SIMP(statut="o", typ="R", val_min=0.0),
        BD2=SIMP(statut="f", typ="R", defaut=1.0, val_min=1.0e-1),
        VIFROT=SIMP(statut="o", typ="R", val_min=0.0),
        FA=SIMP(statut="o", typ="R", val_min=0.0),
        FC=SIMP(statut="o", typ="R", val_min=0.0),
        EPSTR0=SIMP(statut="o", typ="R", val_min=1.0e-4, val_max=1.0),
        ADN=SIMP(statut="o", typ="R", val_min=0.0),
        BDN=SIMP(statut="f", typ="R", defaut=1.0, val_min=1.0e-1),
    ),
    VENDOCHAB=FACT(
        statut="f",
        SY=SIMP(statut="f", typ="R", defaut=0.0),
        ALPHA_D=SIMP(statut="f", typ="R", defaut=0.0),
        BETA_D=SIMP(statut="f", typ="R", defaut=0.0),
    ...
    POST_ROCHE=FACT(
        statut="f",
        RAMB_OSGO_FACT=SIMP(statut="o", typ="R", val_min=0.0),
        RAMB_OSGO_EXPO=SIMP(statut="o", typ="R", val_min=0.0),
        RP02_MIN=SIMP(statut="f", typ="R", val_min=0.0),
        RM_MIN=SIMP(statut="f", typ="R", val_min=0.0),
        RP02_MOY=SIMP(statut="f", typ="R", val_min=0.0),  # 1.25*RP02_MIN par défaut
    ...
    BPEL_BETON=FACT(
        statut="f",
        PERT_FLUA=SIMP(statut="f", typ="R", defaut=0.0),
        PERT_RETR=SIMP(statut="f", typ="R", defaut=0.0),
    ),
    BPEL_ACIER=FACT(
        statut="f",
        RELAX_1000=SIMP(statut="f", typ="R", defaut=0.0),
        MU0_RELAX=SIMP(statut="f", typ="R", defaut=0.0),
        F_PRG=SIMP(statut="f", typ="R", val_min=0.0),
        FROT_COURB=SIMP(statut="f", typ="R", defaut=0.0),
        FROT_LINE=SIMP(statut="f", typ="R", defaut=0.0),
    ),
    ETCC_BETON=FACT(statut="f", EP_BETON=SIMP(statut="f", typ="R", val_min=0.0, defaut=0.0)),
    ETCC_ACIER=FACT(
        statut="f",
        F_PRG=SIMP(statut="f", typ="R", val_min=0.0),
        COEF_FROT=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        PERT_LIGNE=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
        RELAX_1000=SIMP(statut="f", typ="R", defaut=0.0, val_min=0.0),
    ),
    RELAX_ACIER=FACT(
        statut="f",
    ...
    MOHR_COULOMB=FACT(
        statut="f",
        PHI=SIMP(statut="o", typ="R", val_min=0.0, val_max=60.0),
        ANGDIL=SIMP(statut="o", typ="R", val_min=0.0, val_max=60.0),
    ...
    CAM_CLAY=FACT(
        ...
        KCAM=SIMP(statut="f", typ="R", val_min=0.0),
        PTRAC=SIMP(statut="f", typ="R", val_max=0.0),
    ...
    CJS=FACT(
        ...
        N_CJS=SIMP(statut="f", typ="R", defaut=0.0),
        KP=SIMP(statut="f", typ="R", defaut=0.0),
        RC=SIMP(statut="f", typ="R", defaut=0.0),
        A_CJS=SIMP(statut="f", typ="R", defaut=0.0),
        B_CJS=SIMP(statut="f", typ="R", defaut=1.0e25),
        C_CJS=SIMP(statut="f", typ="R", defaut=0.0),
        GAMMA_CJS=SIMP(statut="o", typ="R"),
        MU_CJS=SIMP(statut="f", typ="R", defaut=0.0),
        PCO=SIMP(statut="f", typ="R", defaut=0.0),
        PA=SIMP(statut="o", typ="R"),
        Q_INIT=SIMP(statut="f", typ="R", defaut=0.0),
        R_INIT=SIMP(statut="f", typ="R", defaut=0.0),
    ),
    HUJEUX=FACT(
        statut="f",
        N=SIMP(statut="o", typ="R"),
        ...
        PTRAC=SIMP(statut="f", typ="R", defaut=0.0),
    ),
    ECRO_ASYM_LINE=FACT(
        statut="f",
    ...
    GLRC_DM=FACT(
        ...
        GAMMA_T=SIMP(statut="o", typ="R", val_min=-1.0, val_max=1.0),
        GAMMA_C=SIMP(statut="o", typ="R", val_min=-1.0, val_max=1.0),
        GAMMA_F=SIMP(statut="o", typ="R", val_min=-1.0, val_max=1.0),
        NYT=SIMP(statut="o", typ="R", val_min=0.0),
        NYC=SIMP(statut="o", typ="R"),
        MYF=SIMP(statut="o", typ="R", val_min=0.0),
        ALPHA_C=SIMP(statut="o", typ="R", val_min=0.0),
        EPSI_C=SIMP(statut="f", typ="R", defaut=1.0),
        EPSI_ELS=SIMP(statut="f", typ="R", defaut=1.0),
        EPSI_LIM=SIMP(statut="f", typ="R", defaut=1.0),
    ...
    CABLE_GAINE_FROT=FACT(
        ...
        PENA_LAGR=SIMP(statut="o", typ="R", val_min=0.0),
    ),
    ...
    DOMMA_LEMAITRE=FACT(
        ...
        EXP_S=SIMP(statut="f", typ="R", val_min=0.0, defaut=1.0),
    ),
    CISA_PLAN_CRIT=FACT(
        statut="f",
        CRITERE=SIMP(
        ...
        b_critere_matake=BLOC(
            ...
            COEF_FLEX_TORS=SIMP(statut="o", typ="R", val_min=1.0, val_max=1.7321),
        ),
        b_critere_dang_van=BLOC(
            ...
            COEF_CISA_TRAC=SIMP(statut="o", typ="R", val_min=1.0, val_max=1.7321),
        ),
    ...
    RUPT_FRAG=FACT(
        ...
        PENA_ADHERENCE=SIMP(statut="f", typ="R", val_min=1.0e-12, val_max=1.0),
        PENA_CONTACT=SIMP(statut="f", typ="R", defaut=1.0),
        PENA_LAGR=SIMP(statut="f", typ="R", defaut=1.0e2, val_min=1.01),
    ...
    CZM_LAB_MIX=FACT(
        ...
        PENA_LAGR=SIMP(statut="f", typ="R", defaut=100.0, val_min=1.01),
        CINEMATIQUE=SIMP(
            statut="f",
            typ="TXM",
            defaut="GLIS_1D",
    ...
    RUPT_DUCT=FACT(
        ...
        COEF_EXTR=SIMP(statut="o", typ="R", val_min=0.0, val_max=9.99e-1),
        COEF_PLAS=SIMP(statut="o", typ="R", val_min=0.0, val_max=9.99e-1),
        PENA_LAGR=SIMP(statut="f", typ="R", defaut=1.0e2, val_min=1.01),
        RIGI_GLIS=SIMP(statut="f", typ="R", defaut=1.0e1),
    ),
    JOINT_MECA_RUPT=FACT(
        ...
        PENA_RUPTURE=SIMP(statut="f", typ="R", val_min=1.0e-12, val_max=10.0),
    ...
    MONO_DD_CFC_IRRA=FACT(
        ...
        H4=SIMP(statut="f", typ="R", defaut=0.122, fr=tr("matrice d'interaction, terme a_Lomer")),
        H5=SIMP(statut="f", typ="R", defaut=0.07, fr=tr("matrice d'interaction, terme a_Hirth")),
        DZ_IRRA=SIMP(statut="o", typ="R", val_min=0.0, fr=tr("Parametre dzeta pour irradiation")),
        XI_IRRA=SIMP(statut="o", typ="R", val_min=0.0, fr=tr("Parametre xi pour irradiation")),
    ...
    Iwan=FACT(
        ...
        YoungModulus=SIMP(statut="o", typ="R"),
        PoissonRatio=SIMP(statut="o", typ="R"),
        HypDistortion=SIMP(statut="o", typ="R"),
        HypExponent=SIMP(statut="o", typ="R"),
    ),
    Iwan_FO=FACT(
        statut="f",
        YoungModulus=SIMP(statut="o", typ=fonction_sdaster),
        PoissonRatio=SIMP(statut="o", typ=fonction_sdaster),
        HypDistortion=SIMP(statut="o", typ=fonction_sdaster),
        HypExponent=SIMP(statut="o", typ=fonction_sdaster),
    ),
    META_LEMA_ANI=FACT(
        statut="f",
        YoungModulus=SIMP(statut="o", typ="R"),
    ...
    MCC=FACT(
        ...
        InitCritPress=SIMP(statut="o", typ="R"),
        CritStateSlope=SIMP(statut="o", typ="R"),
        TensileYieldStress=SIMP(statut="o", typ="R"),
        IncoPlastIndex=SIMP(statut="o", typ="R"),
    ),
    MCC_FO=FACT(
        statut="f",
        ...
        InitCritPress=SIMP(statut="o", typ=fonction_sdaster),
        CritStateSlope=SIMP(statut="o", typ=fonction_sdaster),
        TensileYieldStress=SIMP(statut="o", typ=fonction_sdaster),
        IncoPlastIndex=SIMP(statut="o", typ=fonction_sdaster),
    ),
    CSSM=FACT(
        statut="f",
        BulkModulus=SIMP(statut="o", typ="R"),
        ...
        HypExponent=SIMP(statut="o", typ="R"),
        HypDistortion=SIMP(statut="o", typ="R"),
        MinCritPress=SIMP(statut="o", typ="R"),
        ShearModulusRatio=SIMP(statut="o", typ="R"),
        IsoHardRatio=SIMP(statut="o", typ="R"),
        IsoHardIndex=SIMP(statut="o", typ="R"),
    ),
    CSSM_FO=FACT(
        statut="f",
        BulkModulus=SIMP(statut="o", typ=fonction_sdaster),
        ...
        HypExponent=SIMP(statut="o", typ=fonction_sdaster),
        HypDistortion=SIMP(statut="o", typ=fonction_sdaster),
        MinCritPress=SIMP(statut="o", typ=fonction_sdaster),
        ShearModulusRatio=SIMP(statut="o", typ=fonction_sdaster),
        IsoHardRatio=SIMP(statut="o", typ=fonction_sdaster),
        IsoHardIndex=SIMP(statut="o", typ=fonction_sdaster),
    ),
    Barcelone=FACT(
        statut="f",
        BulkModulus=SIMP(statut="o", typ="R"),
        ShearModulus=SIMP(statut="o", typ="R"),
        SwellingIndex=SIMP(statut="o", typ="R"),
        SuccionIndex=SIMP(statut="o", typ="R"),
        SuccionModulus=SIMP(statut="o", typ="R"),
        CritStateSlope=SIMP(statut="o", typ="R"),
        InitConsPress=SIMP(statut="o", typ="R"),
        YieldSuccion=SIMP(statut="o", typ="R"),
        YieldTensSlope=SIMP(statut="o", typ="R"),
        PlastSuccionIndex=SIMP(statut="o", typ="R"),
        PlastStrainIndex=SIMP(statut="o", typ="R"),
        PlastStrainPara1=SIMP(statut="o", typ="R"),
        PlastStrainPara2=SIMP(statut="o", typ="R"),
        RefeConsPress=SIMP(statut="o", typ="R"),
        FlowCorrection=SIMP(statut="o", typ="R"),
        InitVoidsRatio=SIMP(statut="o", typ="R"),
    ),
    Barcelone_FO=FACT(
        statut="f",
        BulkModulus=SIMP(statut="o", typ=fonction_sdaster),
        ShearModulus=SIMP(statut="o", typ=fonction_sdaster),
        SwellingIndex=SIMP(statut="o", typ=fonction_sdaster),
        SuccionIndex=SIMP(statut="o", typ=fonction_sdaster),
        SuccionModulus=SIMP(statut="o", typ=fonction_sdaster),
        CritStateSlope=SIMP(statut="o", typ=fonction_sdaster),
        InitConsPress=SIMP(statut="o", typ=fonction_sdaster),
        YieldSuccion=SIMP(statut="o", typ=fonction_sdaster),
        YieldTensSlope=SIMP(statut="o", typ=fonction_sdaster),
        PlastSuccionIndex=SIMP(statut="o", typ=fonction_sdaster),
        PlastStrainIndex=SIMP(statut="o", typ=fonction_sdaster),
        PlastStrainPara1=SIMP(statut="o", typ=fonction_sdaster),
        PlastStrainPara2=SIMP(statut="o", typ=fonction_sdaster),
        RefeConsPress=SIMP(statut="o", typ=fonction_sdaster),
