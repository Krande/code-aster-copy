...
DEFI_MATERIAU=OPER(nom="DEFI_MATERIAU",op=5,sd_prod=mater_sdaster,
       ...
       regles=(EXCLUS('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
               ...
               AU_MOINS_UN('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
                           ...
                           'WEIBULL_FO',
                           'NON_LOCAL','RUPT_FRAG','RUPT_FRAG_FO','CZM_LAB_MIX','RUPT_DUCT',
...
#
           ...
           FLUA_PORO_BETON      =FACT(statut='f',
             ...
             VW              =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=1.0),
           ...
           RGI_BETON      =FACT(statut='f',
             ...
             VW              =SIMP(statut='o',typ=(fonction_sdaster,nappe_sdaster,formule,'R')),
             SFLD            =SIMP(statut='f',typ='R',defaut=0.0),
             MVGN            =SIMP(statut='f',typ='R',defaut=0.0),
...
#
           ...
           RUPT_TURON      =FACT(statut='f',
             ...
             C_RUPT          =SIMP(statut='o',typ='R', defaut=1.0E-3,val_max=1.0E-1),
