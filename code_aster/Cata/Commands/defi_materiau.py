...
DEFI_MATERIAU=OPER(nom="DEFI_MATERIAU",
                   op=None,
                   sd_prod=mater_sdaster,
                   fr=tr("Définition des paramètres décrivant le comportement d un matériau"),
                   reentrant='f:MATER',
       regles=(EXCLUS('ELAS','ELAS_FO','ELAS_VISCO','ELAS_FLUI',
                      'ELAS_ISTR','ELAS_ISTR_FO','ELAS_VISCO_ISTR',
                      'ELAS_ORTH', 'ELAS_ORTH_FO', 'ELAS_VISCO_ORTH',
                      'ELAS_COQUE','ELAS_COQUE_FO',
                      'ELAS_HYPER','ELAS_2NDG','ELAS_GLRC','ELAS_DHRC'),
               EXCLUS('THER','THER_FO','THER_ORTH','THER_NL_ORTH','THER_NL','THER_HYDR','THER_COQUE','THER_COQUE_FO'),
               ...
               AU_MOINS_UN('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
                           'ELAS_ORTH_FO', 'ELAS_VISCO', 'ELAS_VISCO_ISTR','ELAS_VISCO_ORTH',
                           'ELAS_COQUE','ELAS_COQUE_FO','ELAS_MEMBRANE',
                           'FONDA_SUPERFI',
                           'ELAS_HYPER','ELAS_2NDG','ELAS_GLRC','ELAS_GLRC_FO','ELAS_DHRC','CABLE',
                           'VERI_BORNE','TRACTION','ECRO_LINE','ENDO_HETEROGENE','ECRO_LINE_FO',
                           'ECRO_PUIS','ECRO_PUIS_FO', 'ECRO_NL',
                           'ECRO_COOK','ECRO_COOK_FO','BETON_ECRO_LINE','BETON_REGLE_PR',
                           'ENDO_ORTH_BETON','PRAGER','PRAGER_FO',
                           'TAHERI','TAHERI_FO','ROUSSELIER','ROUSSELIER_FO','VISC_SINH',
                           'VISC_SINH_FO','CIN1_CHAB','CIN1_CHAB_FO',
                           'CIN2_CHAB','CIN2_CHAB_FO','CIN2_NRAD','MEMO_ECRO','MEMO_ECRO_FO',
                           'VISCOCHAB','VISCOCHAB_FO','LEMAITRE','LEMAITRE_IRRA',
                           'VISC_IRRA_LOG','GRAN_IRRA_LOG','LEMA_SEUIL','LEMA_SEUIL_FO','IRRAD3M',
                           'LEMAITRE_FO',
                           'ARME','ASSE_CORN','DIS_CONTACT','ENDO_SCALAIRE','ENDO_SCALAIRE_FO',
                           'ENDO_LOCA_EXP','ENDO_LOCA_EXP_FO','ENDO_FISS_EXP','ENDO_FISS_EXP_FO',
                           'DIS_GRICRA',
                           'BETON_DOUBLE_DP','MAZARS','MAZARS_FO','JOINT_BA','VENDOCHAB',
                           'VENDOCHAB_FO','HAYHURST','HAYHURST_FO','VISC_ENDO','VISC_ENDO_FO',
                           'PINTO_MENEGOTTO',
                           'BPEL_BETON','BPEL_ACIER','ETCC_BETON','ETCC_ACIER','RELAX_ACIER',
                           'MOHR_COULOMB','RANKINE','CAM_CLAY','BARCELONE',
                           'CJS','HUJEUX','ECRO_ASYM_LINE','BETON_GRANGER','V_BETON_GRANGER',
                           'BETON_UMLV','BETON_RAG',
                           'FLUA_PORO_BETON','ENDO_PORO_BETON','FLUA_ENDO_PORO','RGI_BETON',
                           'GLRC_DM','DHRC','CORR_ACIER','CABLE_GAINE_FROT','DIS_ECRO_CINE',
                           'DIS_VISC','DIS_ECRO_TRAC','DIS_BILI_ELAS','DIS_CHOC_ENDO',
                           'JONC_ENDO_PLAS',
                           'THER_NL','THER_HYDR','THER','THER_FO','THER_ORTH','THER_NL_ORTH',
                           'THER_COQUE','THER_COQUE_FO',
                           'SECH_GRANGER','SECH_MENSI','SECH_BAZANT','SECH_NAPPE','META_ACIER',
                           'META_ZIRC', 'DURT_META','ELAS_META','ELAS_META_FO',
                           'META_ECRO_LINE','META_TRACTION','META_VISC_FO','META_PT','META_RE',
                           'FLUIDE',
                           'COMP_THM',
                           'FATIGUE','DOMMA_LEMAITRE','CISA_PLAN_CRIT','THM_RUPT','WEIBULL',
                           'WEIBULL_FO',
                           'NON_LOCAL','RUPT_FRAG','RUPT_FRAG_FO','RUPT_TURON','CZM_LAB_MIX','RUPT_DUCT',
                           'CZM_ELAS',
                           'JOINT_MECA_RUPT','JOINT_MECA_FROT','RCCM','RCCM_FO',
                           'LAIGLE','LETK','LKR','DRUCK_PRAGER','VISC_DRUC_PRAG','HOEK_BROWN',
                           'GONF_ELAS','JOINT_BANDIS',
                           'MONO_VISC1','MONO_VISC2','MONO_ISOT1','MONO_ISOT2','MONO_CINE1',
                           'MONO_CINE2','MONO_DD_KR','MONO_DD_CFC','MONO_DD_CFC_IRRA',
                           'MONO_DD_FAT','MONO_DD_CC','MONO_DD_CC_IRRA',
                           'MFRONT','MFRONT_FO','UMAT','UMAT_FO','CRIT_RUPT','REST_ECRO',
                           'BETON_GLRC',
                           'VISC_ELAS','POST_ROCHE', 'POST_ROCHE_FO','RUPT_FM',
                           'NORTON', 'NORTON_FO', 'GTN', 
                           # MFront
                           'META_LEMA_ANI', 'META_LEMA_ANI_FO',
                           'BETON_BURGER', 'BETON_BURGER_FO',
                           'MetaAcierEPIL_PT', 'MetaAcierEPIL_PT_FO',
                           'Iwan', 'Iwan_FO',
                           ),
               ),
...
# vérification du domaine de validité
           ...
           ECRO_LINE_FO    =FACT(statut='f',
             D_SIGM_EPSI     =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule)),
             SY              =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule)),
             SIGM_LIM        =SIMP(statut='f',typ=('R',fonction_sdaster,nappe_sdaster,formule)),
             EPSI_LIM        =SIMP(statut='f',typ=('R',fonction_sdaster,nappe_sdaster,formule)),
           ),
           ...
           NORTON         =FACT(statut='f',
             ...
             N               =SIMP(statut='o',typ='R',val_min=1),
           ),
           ...
           VISCOCHAB       =FACT(statut='f',
             ...
             MU              =SIMP(statut='f',typ='R',defaut= 0.E+0 ),
             Q_M             =SIMP(statut='o',typ='R'),
             Q_0             =SIMP(statut='o',typ='R'),
           ...
           FONDA_SUPERFI =FACT(statut='f',
               LONG_X       =SIMP(statut='o',typ='R',val_min=0.E+0 ),
               LONG_Y       =SIMP(statut='o',typ='R',val_min=0.E+0 ),
               PHI          =SIMP(statut='o',typ='R',val_min=0.E+0 ),
               COHESION     =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               RAID_GLIS    =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               GAMMA_REFE   =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               CP_SERVICE   =SIMP(statut='o',typ='R',val_min=0.E+0 ),
               CP_ULTIME    =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               DEPL_REFE    =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               RAID_CP_X    =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               GAMMA_CP_X   =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               RAID_CP_Y    =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               GAMMA_CP_Y   =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               RAID_CP_RX   =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               GAMMA_CP_RX  =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               RAID_CP_RY   =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               GAMMA_CP_RY  =SIMP(statut='f',typ='R',defaut= 0.E+0,val_min=0.E+0 ),
               DECOLLEMENT  =SIMP(statut='f',typ='TXM',into=("OUI","NON"),
                                  defaut="NON", enum=(1,2,)),
           ),
           ...
           JONC_ENDO_PLAS    =FACT(statut='f',
             KE              =SIMP(statut='o',typ='R',val_min=1.E-5 ),
             KP              =SIMP(statut='o',typ='R',val_min=1.E-5  ),
             KDP             =SIMP(statut='o',typ='R',val_min=1.E-5  ),
             KDM             =SIMP(statut='o',typ='R',val_min=1.E-5  ),
             RDP             =SIMP(statut='o',typ='R',val_min=1.E-9  ),
             RDM             =SIMP(statut='o',typ='R',val_max=-1.E-9  ),
             MYP             =SIMP(statut='o',typ='R',val_min=1.E-5  ),
             MYM             =SIMP(statut='o',typ='R',val_max=-1.E-5  ),
           ),
           ...
           ENDO_LOCA_EXP_FO =FACT(statut='f',
           ...
           BETON_DOUBLE_DP =FACT(statut='f',
             ...
             LONG_CARA       =SIMP(statut='f',typ='R',val_min=0.E+0),
             ECRO_COMP_P_PIC =SIMP(statut='f',typ='TXM',defaut="LINEAIRE",into=("LINEAIRE","PARABOLE"), enum=(0,1), ),
             ECRO_TRAC_P_PIC =SIMP(statut='f',typ='TXM',defaut="LINEAIRE",into=("LINEAIRE","EXPONENT"), enum=(0,1), ),
           ),
         ...
         MAZARS_FO=FACT(statut='f',
             EPSD0           =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             K               =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             AC              =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             BC              =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             AT              =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             BT              =SIMP(statut='o',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             CHI             =SIMP(statut='f',typ='R',val_min=0.0E+0,val_max=1.0E+0),
             SIGM_LIM        =SIMP(statut='f',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
             EPSI_LIM        =SIMP(statut='f',typ=('R',fonction_sdaster,nappe_sdaster,formule),),
           ),
           JOINT_BA=FACT(statut='f',max=1,
             HPEN            =SIMP(statut='f',typ='R',defaut= 1.E+0,val_min=0.E+0),
             ...
             BD1             =SIMP(statut='f',typ='R',defaut= 5.E-1,val_min=1.E-1),
             GAMD2           =SIMP(statut='o',typ='R',val_min=1.E-4,val_max=1.E+0),
             AD2             =SIMP(statut='o',typ='R',val_min=0.E+0),
             BD2             =SIMP(statut='f',typ='R',defaut= 1.E+0,val_min=1.E-1),
             ...
             BDN             =SIMP(statut='f',typ='R',defaut= 1.E+0,val_min=1.E-1),
           ),
           VENDOCHAB       =FACT(statut='f',
             SY              =SIMP(statut='f',typ='R',defaut= 0.E+0),
             ALPHA_D         =SIMP(statut='f',typ='R',defaut= 0.E+0),
             BETA_D          =SIMP(statut='f',typ='R',defaut= 0.E+0),
...
#  Uniquement pour POST_ROCHE
           POST_ROCHE      =FACT(statut='f',
             RAMB_OSGO_FACT     = SIMP(statut='o',typ='R',val_min=0.E+0),
             RAMB_OSGO_EXPO     = SIMP(statut='o',typ='R',val_min=0.E+0),
             RP02_MIN           = SIMP(statut='f',typ='R',val_min=0.E+0),
             RM_MIN             = SIMP(statut='f',typ='R',val_min=0.E+0),
             RP02_MOY           = SIMP(statut='f',typ='R',val_min=0.E+0), # 1.25*RP02_MIN par défaut
...
# Uniquement pour POST_FM
           RUPT_FM      =FACT(statut='f',
             KIC     =SIMP(statut='o',typ=(fonction_sdaster)),
           ),
# Beton Précontraint : Comportement règlementaire du béton et de l'acier
           ...
           ETCC_BETON      =FACT(statut='f',
             EP_BETON    =SIMP(statut='f',typ='R',val_min=0.E+0,defaut=0.0),
           ),
           ...
           RELAX_ACIER =FACT(statut='f',
             F_PRG       =SIMP(statut='f',typ=('R',fonction_sdaster,formule),
                          fr="Contrainte limite élastique"),
             ECOU_K      =SIMP(statut='o',typ=('R',fonction_sdaster,formule),
                          fr="Dénominateur de la fonction d'écoulement visqueux"),
             ECOU_N      =SIMP(statut='o',typ=('R',fonction_sdaster,formule),
                          fr="Puissance de la fonction d'écoulement visqueux"),
             ECRO_N      =SIMP(statut='o',typ=('R',fonction_sdaster,formule),
                          fr="Puissance de la fonction d'écrouissage"),
             ECRO_B      =SIMP(statut='o',typ=('R',fonction_sdaster,formule),
                          fr="Assymptote de la fonction d'écrouissage"),
             ECRO_C      =SIMP(statut='o',typ=('R',fonction_sdaster,formule),
...
#
           ...
           BETON_UMLV   =FACT(statut='f',
            ...
            BETON_RAG   =FACT(statut='f',
                COMP_BETON = SIMP(statut='f',typ='TXM',into=("ENDO","ENDO_FLUA","ENDO_FLUA_RAG"),
                                  defaut="ENDO", enum=(1,2,3)),
                b_endo =BLOC(condition="""equal_to("COMP_BETON", 'ENDO') or \
                                          equal_to("COMP_BETON", 'ENDO_FLUA') or \
                                          equal_to("COMP_BETON", 'ENDO_FLUA_RAG')""",
                            fr=tr("Loi BETON_RAG : mécanique endommagente seule."),
                    ENDO_MC     =SIMP(statut='o',typ='R', fr=tr("Paramètre de fragilité du béton en compression"),),
                    ENDO_MT     =SIMP(statut='o',typ='R', fr=tr("Paramètre de fragilité du béton en traction"),),
                    ENDO_SIGUC  =SIMP(statut='o',typ='R', fr=tr("Contrainte équivalente du béton en compression [Pa]"),),
                    ENDO_SIGUT  =SIMP(statut='o',typ='R', fr=tr("Contrainte équivalente du béton en traction [Pa]"),),
                    ENDO_DRUPRA =SIMP(statut='o',typ='R', fr=tr("Angle du critère de Drucker Prager [Rd]"),),
                ),
                b_endo_fluage =BLOC(condition="""equal_to("COMP_BETON", 'ENDO_FLUA') or \
                                                 equal_to("COMP_BETON", 'ENDO_FLUA_RAG')""",
                            fr=tr("Loi BETON_RAG : mécanique et fluage."),
                    FLUA_SPH_KR =SIMP(statut='o',typ='R', fr=tr("Raideur fluage sphérique réversible [Pa]."),),
                    FLUA_SPH_KI =SIMP(statut='o',typ='R', fr=tr("Raideur fluage sphérique irréversible [Pa]"),),
                    FLUA_SPH_NR =SIMP(statut='o',typ='R', fr=tr("Viscosité fluage sphérique réversible [Pa.s]."),),
                    FLUA_SPH_NI =SIMP(statut='o',typ='R', fr=tr("Viscosité fluage sphérique irréversible [Pa.s]"),),
                    FLUA_DEV_KR =SIMP(statut='o',typ='R', fr=tr("Raideur fluage déviatorique réversible [Pa]."),),
                    FLUA_DEV_KI =SIMP(statut='o',typ='R', fr=tr("Raideur fluage déviatorique irréversible [Pa]."),),
                    FLUA_DEV_NR =SIMP(statut='o',typ='R', fr=tr("Viscosité fluage déviatorique réversible [Pa.s]."),),
                    FLUA_DEV_NI =SIMP(statut='o',typ='R', fr=tr("Viscosité fluage déviatorique irréversible [Pa.s]."),),
                ),
                b_endo_fluage_rag =BLOC(condition="""equal_to("COMP_BETON", 'ENDO_FLUA_RAG')""",
                            fr=tr("Loi BETON_RAG : mécanique et fluage et RAG."),
                    GEL_ALPHA0  =SIMP(statut='o',typ='R', fr=tr("Cinétique d'avancement identifiée à Tref."),),
                    GEL_TREF    =SIMP(statut='o',typ='R', fr=tr("Température de référence pour Alpha0 [°C]."),),
                    GEL_EAR     =SIMP(statut='o',typ='R', fr=tr("Énergie d'activation / Constante gaz parfait [K°]."),),
                    ...
                    GEL_A0      =SIMP(statut='o',typ='R', fr=tr("Seuil de comblement de la porosité connectée."),),
           ...
           GLRC_DM         =FACT(statut='f',max=1,
             ...
             ALPHA_C         =SIMP(statut='o',typ='R',val_min=0.E+0),
...
# Discrets non-linéaires : début
         DIS_ECRO_CINE  =FACT(statut='f',
            ...
            regles=(NON_VIDE(),
                    PRESENT_PRESENT('LIMY_DX','KCIN_DX',),ENSEMBLE('PUIS_DX','LIMU_DX',),
                    PRESENT_PRESENT('LIMY_DY','KCIN_DY',),ENSEMBLE('PUIS_DY','LIMU_DY',),
                    PRESENT_PRESENT('LIMY_DZ','KCIN_DZ',),ENSEMBLE('PUIS_DZ','LIMU_DZ',),
                    PRESENT_PRESENT('LIMY_RX','KCIN_RX',),ENSEMBLE('PUIS_RX','LIMU_RX',),
                    PRESENT_PRESENT('LIMY_RY','KCIN_RY',),ENSEMBLE('PUIS_RY','LIMU_RY',),
                    PRESENT_PRESENT('LIMY_RZ','KCIN_RZ',),ENSEMBLE('PUIS_RZ','LIMU_RZ',),),
         ...
         DIS_VISC =FACT(statut='f',
            ...
            PUIS_ALPHA  =SIMP(statut='f',typ='R',val_min = 1.0E-08, val_max=1.0, defaut=0.5,
...
# -------------------   DONNEES OBLIGATOIRE   -------------------------------------
# ---------------------------------------------------------------------------------
                                           PRE1          = SIMP(statut='f',typ='R',defaut= 0.),
                                           PORO          = SIMP(statut='o',typ='R'),
# ---------------------------------------------------------------------------------
# -------------------   DONNEES NECESSAIRE SI THERMIQUE   -------------------------
# ---------------------------------------------------------------------------------
                                           TEMP          = SIMP(statut='f',typ='R',defaut= 0.),
# ---------------------------------------------------------------------------------
# -------------------   DONNEES INUTILES   ----------------------------------------
# ---------------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------------
                                           PRE1             = SIMP(statut='f',typ='R',defaut= 0.),
                                           PRE2             = SIMP(statut='f',typ='R',defaut= 0.),
                                           PORO             = SIMP(statut='o',typ='R'),
# ---------------------------------------------------------------------------------
# -------------------   DONNEES NECESSAIRE SI THERMIQUE   -------------------------
# ---------------------------------------------------------------------------------
...
#
           ...
           GTN             =FACT(statut='f',
             Q1        = SIMP(statut='o',typ='R',val_min=1.e-30),
             Q2        = SIMP(statut='o',typ='R',val_min=1.e-30),
             PORO_INIT = SIMP(statut='o',typ='R',val_min=1.e-30),
           ...
           RUPT_FRAG       =FACT(statut='f',
             ...
             CINEMATIQUE     =SIMP(statut='f',typ='TXM',defaut="UNILATER",into=("UNILATER","GLIS_1D","GLIS_2D"), enum=(0,1,2)),
           ),
           CZM_ELAS       =FACT(statut='f',
             RIGI_NOR        = SIMP(statut='f',typ='R'  ,defaut=0.0),
             RIGI_TAN        = SIMP(statut='f',typ='R'  ,defaut=0.0),
             ADHE_NOR        = SIMP(statut='f',typ='TXM',defaut="ELAS",into=("ELAS","UNILATER","PARFAITE"), enum=(0,1,2)),
             ADHE_TAN        = SIMP(statut='f',typ='TXM',defaut="ELAS",into=("ELAS","PARFAITE"), enum=(0,1)),
             PENA_LAGR_ABSO  = SIMP(statut='o',typ='R'  ,val_min=0.0),
           ),
           RUPT_TURON      =FACT(statut='f',
             K               =SIMP(statut='o',typ='R'),
           ...
           CZM_LAB_MIX    =FACT(statut='f',
             ...
             CINEMATIQUE     =SIMP(statut='f',typ='TXM',defaut="GLIS_1D",into=("UNILATER","GLIS_1D","GLIS_2D"), enum=(0,1,2)),
           ),
