...
DEFI_MATERIAU = MACRO(
    ...
    RGI_BETON=FACT(
        ...
        TDEF=SIMP(statut="o", typ="R"),
        NRJP=SIMP(statut="o", typ="R"),
        SRSD=SIMP(statut="o", typ="R"),
        VDEF=SIMP(statut="o", typ="R"),
        CNAD=SIMP(statut="o", typ=(fonction_sdaster, nappe_sdaster, formule)),
        SSAD=SIMP(statut="o", typ="R"),
        CNAK=SIMP(statut="o", typ="R"),
        CNAB=SIMP(statut="o", typ="R"),
        EXND=SIMP(statut="o", typ="R"),
        EXMD=SIMP(statut="o", typ="R"),
        TTDD=SIMP(statut="o", typ="R"),
        TDID=SIMP(statut="o", typ="R"),
        TFID=SIMP(statut="o", typ="R"),
        NRJD=SIMP(statut="o", typ="R"),
        TTRD=SIMP(statut="o", typ="R"),
        DIM3=SIMP(statut="o", typ="R"),
    ...
    RGI_BETON_BA=FACT(
        ...
        HPL1             =SIMP(statut='o',typ='R'),
        TMR1            =SIMP(statut='f',typ='R',defaut=0.0),
        ...
        TKR1            =SIMP(statut='o',typ='R'),
        YKY1            =SIMP(statut='f',typ='R',defaut=100.0),


        # ROA2             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # DEQ2             =SIMP(statut='f',typ='R',defaut=0.0),
        # YOR2             =SIMP(statut='f',typ='R',defaut=0.0),
        # SYR2             =SIMP(statut='f',typ='R',defaut=0.0),
        # TYR2             =SIMP(statut='f',typ='R',defaut=0.0),
        # VR21             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # VR22             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # VR23             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # HPL2             =SIMP(statut='f',typ='R',defaut=0.0),
        # TMR2            =SIMP(statut='f',typ='R',defaut=0.0),
        ...
        # TKR2            =SIMP(statut='f',typ='R'),
        # YKY2            =SIMP(statut='f',typ='R',defaut=100.0),


        # ROA3             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # DEQ3             =SIMP(statut='f',typ='R',defaut=0.0),
        # YOR3             =SIMP(statut='f',typ='R',defaut=0.0),
        # SYR3             =SIMP(statut='f',typ='R',defaut=0.0),
        # TYR3             =SIMP(statut='f',typ='R',defaut=0.0),
        # VR31             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # VR32             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # VR33             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # HPL3             =SIMP(statut='f',typ='R',defaut=0.0),
        # TMR3            =SIMP(statut='f',typ='R',defaut=0.0),
        ...
        # TKR3            =SIMP(statut='f',typ='R'),
        # YKY3            =SIMP(statut='f',typ='R',defaut=100.0),

        # ROA4             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # DEQ4             =SIMP(statut='f',typ='R',defaut=0.0),
        # YOR4             =SIMP(statut='f',typ='R',defaut=0.0),
        # SYR4             =SIMP(statut='f',typ='R',defaut=0.0),
        # TYR4             =SIMP(statut='f',typ='R',defaut=0.0),
        # VR41             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # VR42             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # VR43             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # HPL4             =SIMP(statut='f',typ='R',defaut=0.0),
        # TMR4            =SIMP(statut='f',typ='R',defaut=0.0),
        ...
        # TTR4            =SIMP(statut='f',typ='R',defaut=48.0),
        # XNR4            =SIMP(statut='f',typ='R',defaut=1.216),
        # MUS4            =SIMP(statut='f',typ='R',defaut=0.7),
        # TKR4            =SIMP(statut='f',typ='R'),
        # YKY4            =SIMP(statut='f',typ='R',defaut=100.0),

        # ROA5             =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.0),
        # DEQ5             =SIMP(statut='f',typ='R',defaut=0.0),
        # YOR5             =SIMP(statut='f',typ='R',defaut=0.0),
        # SYR5             =SIMP(statut='f',typ='R',defaut=0.0),
        # TYR5             =SIMP(statut='f',typ='R',defaut=0.0),
        # VR51             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # VR52             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # VR53             =SIMP(statut='f',typ=(formule,'R'),defaut=0.0),
        # HPL5             =SIMP(statut='f',typ='R',defaut=0.0),
        # TMR5            =SIMP(statut='f',typ='R',defaut=0.0),
        # EKR5            =SIMP(statut='f',typ='R',defaut=1e-5),
        # SKR5            =SIMP(statut='f',typ='R',defaut=1260.0),
        # ATR5            =SIMP(statut='f',typ='R',defaut=1.5e-5),
        # CTM5            =SIMP(statut='f',typ='R',defaut=5.8),
        # XFL5            =SIMP(statut='f',typ='R',defaut=2.55),
        # PRE5            =SIMP(statut='f',typ='R',defaut=0.0),
        # TTR5            =SIMP(statut='f',typ='R',defaut=58.0),
        # XNR5            =SIMP(statut='f',typ='R',defaut=1.216),
        # MUS5            =SIMP(statut='f',typ='R',defaut=0.7),
        # TKR5            =SIMP(statut='f',typ='R'),
    ...
    GTN=FACT(
        ...
        COAL_PORO=SIMP(statut="f", typ="R", defaut=0.0),
        COAL_ACCE=SIMP(statut="f", typ="R", defaut=1.0),
        NUCL_GAUSS_PORO=SIMP(statut="f", typ="R", defaut=0.00),
        NUCL_GAUSS_PLAS=SIMP(statut="f", typ="R", defaut=0.10),
        NUCL_GAUSS_DEV=SIMP(statut="f", typ="R", defaut=0.05),
        NUCL_CRAN_PORO=SIMP(statut="f", typ="R", defaut=0.00),
        NUCL_CRAN_INIT=SIMP(statut="f", typ="R", defaut=0.05),
    ...
    JOINT_MECA_ENDO=FACT(
        ...
        VISC_FLUIDE=SIMP(statut="f", typ="R", val_min=1.0e-20),
        OUV_MIN=SIMP(statut="f", typ="R", val_min=1.0e-15),
        MU=SIMP(statut="o", typ="R", val_min=0.),
        Bn=SIMP(statut="o", typ="R", val_min=0.),
        Bt=SIMP(statut="o", typ="R", val_min=0.),
        ALPHA=SIMP(statut="o", typ="R", val_min=0., val_max=1.),
    ),
    RCCM=FACT(
        statut="f",
    ...
    DRUCK_PRAGER=FACT(
        ...
        b_expo =BLOC(
            ...
            fr=tr("Loi de comportement de type Drucker Prager avec un ecrouissage exponentiel pour R et b test"),
    ...
    GONF_ELAS=FACT(statut="f", BETAM=SIMP(statut="o", typ="R"), PREF=SIMP(statut="o", typ="R")),
    JOINT_BANDIS=FACT(
        statut="f",
        K=SIMP(statut="o", typ="R"),
