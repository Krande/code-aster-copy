...
#          mot clé facteur répétable pour assigner les caractéristiques locales par zones topologiques (GROUP_MA)
           AFFE               =FACT(statut='o',max='**',
             ...
             EPURE_CISA       =SIMP(statut = 'f', typ = 'TXM', defaut='NON',
                                    into = ('OUI', 'NON',),
                                    fr=tr("Prise en compte de l'effort de traction supplémentaire du à l'effort tranchant et à la torsion?")),
             ...
             UNITE_DIMENSION  =SIMP(statut='o',typ='TXM', into=("mm","m"),
                                    fr=tr("Unité des dimensions du problème")),
             ...
             N                =SIMP(statut='f',typ='R',
                                    fr=tr("Coefficient d'équivalence acier/béton (ELS,ELS_QP)")),
             ...
             TYPE_DIAGRAMME   =SIMP(statut='f',typ = 'TXM',
                                    into = ('B1', 'B2',),
                                    fr=tr("Type du diagramme Contrainte-Deformation à utiliser: B1 (Incliné) ou B2 (Horizontal)")),
             ...
             sigc_2D          =BLOC(condition = """ equal_to("TYPE_STRUCTURE", '2D')""",
                                    fr=tr("définition des contraintes ultimes de dimensionnement du béton de la section 2D"),
                                    SIGC_INF_ELS=SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton en fibre inférieure pour la section 2D (ELS)")),
                                    SIGC_SUP_ELS=SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton en fibre supérieure pour la section 2D (ELS)")),),
             sigc_1D          =BLOC(condition = """ equal_to("TYPE_STRUCTURE", '1D')""",
                                    fr=tr("définition des contraintes ultimes de dimensionnement du béton de la section 1D"),
                                    SIGC_INF_Y_ELS=SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton en fibre inférieure suivant l'axe Y de la section 1D (ELS)")),
                                    SIGC_SUP_Y_ELS=SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton en fibre supérieure suivant l'axe Y de la section 1D (ELS)")),
                                    SIGC_INF_Z_ELS=SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton en fibre inférieure suivant l'axe Z de la section 1D (ELS)")),
                                    SIGC_SUP_Z_ELS=SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton en fibre supérieure suivant l'axe Z de la section 1D (ELS)")),),
             wmax_2D          =BLOC(condition = """ equal_to("TYPE_STRUCTURE", '2D')""",
                                    ...
                                    fr=tr("Ouverture maximale des fissures en face inférieure de la section 2D (ELS_QP)")),
                                    WMAX_SUP=SIMP(statut='f',typ='R',
                                    fr=tr("Ouverture maximale des fissures en face supérieure de la section 2D (ELS_QP)")),),
             wmax_1D          =BLOC(condition = """ equal_to("TYPE_STRUCTURE", '1D')""",
                                    ...
                                    fr=tr("Ouverture maximale des fissures en face inférieure suivant l'axe Y de la section 1D (ELS_QP)")),
                                    WMAX_SUP_Y=SIMP(statut='f',typ='R',
                                    fr=tr("Ouverture maximale des fissures en face supérieure suivant l'axe Y de la section 1D (ELS_QP)")),
                                    WMAX_INF_Z=SIMP(statut='f',typ='R',
                                    fr=tr("Ouverture maximale des fissures en face inférieure suivant l'axe Z de la section 1D (ELS_QP)")),
                                    WMAX_SUP_Z=SIMP(statut='f',typ='R',
                                    fr=tr("Ouverture maximale des fissures en face supérieure suivant l'axe Z de la section 1D (ELS_QP)")),),
             SIGC_ELS_QP      =SIMP(statut='f',typ='R',
                                    fr=tr("Contrainte ultime de dimensionnement du béton (ELS_QP)")),
             KT               =SIMP(statut='f',typ='R',
                                    fr=tr("Coefficient de durée de chargement (ELS_QP)")),
...
#          mot clé facteur répétable pour assigner les caractéristiques locales par zones topologiques (GROUP_MA)
           AFFE               =FACT(statut='o',max='**',
             ...
             b_iconst_ec2 = BLOC(condition = """ greater_than("RHO_ACIER", 0)""",
                                 fr=tr("Calcul du critère de difficulté de bétonnage si RHO_ACIER > 0"),
                ALPHA_REINF      =SIMP(statut='f',typ='R',defaut=1,
                                        fr=tr("Coefficient de pondération du ratio de densité d'acier par mètre cube de béton")),
                ALPHA_SHEAR      =SIMP(statut='f',typ='R',defaut=1,
                                        fr=tr("Coefficient de pondération du ratio de densité d'acier d'effort tranchant")),
                ALPHA_STIRRUPS   =SIMP(statut='f',typ='R',defaut=1,
                                        fr=tr("Coefficient de pondération du ratio de longueur des épingles d'acier effort tranchant")),
                RHO_CRIT         =SIMP(statut='f',typ='R',defaut=150,
                                        fr=tr("Densité volumique d'armature critique")),
                DNSTRA_CRIT      =SIMP(statut='f',typ='R',defaut=0.006,
                                        fr=tr("Ferraillage d'effort tranchant critique")),
