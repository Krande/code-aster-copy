...
RESOUDRE = OPER(
    ...
    reentrant="f:CHAM_NO",
    fr=tr(
        "Résolution par méthode directe un système d'équations linéaires préalablement factorisé par FACT_LDLT"
    ...
    ALGORITHME=SIMP(
        statut="f", typ="TXM", into=("CG", "CR", "GMRES", "GCR", "FGMRES"), defaut="FGMRES"
    ),
