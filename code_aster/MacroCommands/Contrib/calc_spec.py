...
CALC_SPEC_CATA = MACRO(
    ...
    regles=(UN_PARMI("ECHANT", "TAB_ECHANT"), UN_PARMI("INTERSPE", "TRANSFERT")),
    TAB_ECHANT=FACT(
        statut="f",
    ...
    INTERSPE=FACT(
        statut="f",
        FENETRE=SIMP(
            statut="f", typ="TXM", defaut="RECT", into=("RECT", "HAMM", "HANN", "EXPO", "PART")
        ),
        BLOC_DEFI_FENE=BLOC(
            condition="FENETRE == 'EXPO' or FENETRE == 'PART' ",
...
CALC_SPEC = UserMacro("CALC_SPEC", CALC_SPEC_CATA, calc_spec_ops)
