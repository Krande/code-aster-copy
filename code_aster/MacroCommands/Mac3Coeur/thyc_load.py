...
from ...Commands import AFFE_CHAR_MECA, AFFE_CHAR_MECA_F
...
def lire_resu_thyc(coeur, MODELE, nom_fic):
    ...
    thyc_load.chax_nodal = AFFE_CHAR_MECA(MODELE=MODELE, FORCE_NODALE=nodal_ax)
    thyc_load.chax_poutre = AFFE_CHAR_MECA_F(MODELE=MODELE, FORCE_POUTRE=linear_ax)

    logger.debug("<THYC_LOAD>: End")
