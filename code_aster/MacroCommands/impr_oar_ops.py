...
ORDRE_CONTRAINTES = {'PLAN':['SIXX','SIZZ','SIXZ','SIYY','SIXY','SIYZ'],
                        'AXIS':['SIXX','SIYY','SIXY','SIZZ','SIXZ','SIYZ'],
                        '3D':['SIXX','SIYY','SIZZ','SIXY','SIXZ','SIYZ']}

ETIQUETTES = {"PRESSION": "SIGM_P",
              "TORSION": "SIGM_T",
              "FLEXION_HP": "SIGM_HP",
              "FLEXION_P": "SIGM_FP",
              "TEMP": "TEMP",
...
class OAR_EF:
    ...
    def trouve_instants_thermomecaniques(self):
        ...
        for instant_ther in self.instants_thermiques:
            if self.contraintes_azim(self.charg["CONTRAINTE"], self.azimuts[0], instant_ther)["SIXX"].size==0:
    ...
    def contraintes_azim(self, macroc, intitule, instant):
        ...
        contraintes = {'SIXX':None, 'SIYY':None, 'SIZZ':None, 'SIXY':None, 'SIXZ':None, 'SIYZ':None}
    ...
    def ecrire_preambule(self, f):
        ...
        if self.typefic == "meca":
            ...
            f.write(f"; IMPRESSION AU FORMAT OAR - Modélisation thermo-mécanique {self.modelisation} \n")
            ...
            if self.typefic == "temp":
                ...
                for azimut in self.azimuts:
                    ...
                    for instant in self.instants_thermomecaniques:
                        ...
                        contraintes_ = self.contraintes_azim(self.charg["CONTRAINTE"], azimut, instant)
