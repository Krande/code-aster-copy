...
def prepare_mesh_syme(meshin, affe_groups, affe_all):
    ...
    if affe_all is True :
        ...
        intersection = mc.DataArrayInt.BuildIntersection([mm.getGroupArr(0, grp)
                                                          for grp in affe_groups if len(affe_groups)>1])
    ...
    preserved_groups = [mm.getGroupArr(0, grp) for grp in mm.getGroupsOnSpecifiedLev(0) if grp != group_tout]
    ...
    int_zmin_xmin = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmin'], face_nodes['face_xmin']))
    int_zmin_xmin.setName("int_zmin_xmin")
    node_groups.append(int_zmin_xmin)
    int_zmin_ymin = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmin'], face_nodes['face_ymin']))
    int_zmin_ymin.setName("int_zmin_ymin")
    node_groups.append(int_zmin_ymin)
    int_zmin_xmax = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmin'], face_nodes['face_xmax']))
    int_zmin_xmax.setName("int_zmin_xmax")
    node_groups.append(int_zmin_xmax)
    int_zmin_ymax = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmin'], face_nodes['face_ymax']))
    int_zmin_ymax.setName("int_zmin_ymax")
    node_groups.append(int_zmin_ymax)

    int_zmax_xmin = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmax'], face_nodes['face_xmin']))
    int_zmax_xmin.setName("int_zmax_xmin")
    node_groups.append(int_zmax_xmin)
    int_zmax_ymin = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmax'], face_nodes['face_ymin']))
    int_zmax_ymin.setName("int_zmax_ymin")
    node_groups.append(int_zmax_ymin)
    int_zmax_xmax = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmax'], face_nodes['face_xmax']))
    int_zmax_xmax.setName("int_zmax_xmax")
    node_groups.append(int_zmax_xmax)
    int_zmax_ymax = mc.DataArrayInt.BuildIntersection((face_nodes['face_zmax'], face_nodes['face_ymax']))
    int_zmax_ymax.setName("int_zmax_ymax")
    node_groups.append(int_zmax_ymax)

    low_edges_nodes = mc.DataArrayInt.BuildUnion((int_zmin_xmin, int_zmin_ymin, int_zmin_xmax, int_zmin_ymax))
    low_edges_nodes.setName("edges_face_zmin")
    node_groups.append(low_edges_nodes)

    up_edges_nodes = mc.DataArrayInt.BuildUnion((int_zmax_xmin, int_zmax_ymin, int_zmax_xmax, int_zmax_ymax))
