...
loi = LoiComportement(
    nom="VISC_ISOT_NL",
    lc_type=None,
    doc="""Loi de viscoplasticité de Von Mises à écrouissage non linéaire [R5.03.02]""",
    num_lc=76,
    nb_vari=8,
    nom_vari=("EPSPEQ", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ"),
    mc_mater=("ELAS", "ECRO_NL", "NONLOCAL", "NORTON"),
    modelisation=("3D", "AXIS", "D_PLAN", "GRADVARI", "1D"),
