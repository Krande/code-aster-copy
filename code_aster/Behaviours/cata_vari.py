...
DICT_NOM_VARI = {
    "ENDO_EX": _("Endommagement extrapolé"),
    "SIEQ_ERX": _("Erreur d'extrapolation en contraintes"),
    "SIEQ_ECR": ("Estimation de la part des contraintes liée à l'écrouissage local "),
    "SIEQ_VSC": ("Estimation de la part des contraintes liée à la viscosité "),
    "SIEQ_NLC": ("Estimation de la part des contraintes liée aux effets non locaux "),
    "ARRET": ("Critère d'arrêt du calcul"),
    ...
    "BR_EFR11": _("BETON_RAG : déformation déviatorique de fluage réversible, composante 1"),
    "BR_EFR12": _("BETON_RAG : déformation déviatorique de fluage réversible, composante 4"),
    "BR_EFR13": _("BETON_RAG : déformation déviatorique de fluage réversible, composante 5"),
    "BR_EFR22": _("BETON_RAG : déformation déviatorique de fluage réversible, composante 2"),
    "BR_EFR23": _("BETON_RAG : déformation déviatorique de fluage réversible, composante 6"),
    "BR_EFR33": _("BETON_RAG : déformation déviatorique de fluage réversible composante 3"),
    "BR_EFRSP": _("BETON_RAG : déformation sphérique de fluage réversible"),
    "BR_EFI11": _("BETON_RAG : déformation déviatorique de fluage irréversible, composante 1"),
    "BR_EFI12": _("BETON_RAG : déformation déviatorique de fluage irréversible, composante 4"),
    "BR_EFI13": _("BETON_RAG : déformation déviatorique de fluage irréversible, composante 5"),
    "BR_EFI22": _("BETON_RAG : déformation déviatorique de fluage irréversible, composante 2"),
    "BR_EFI23": _("BETON_RAG : déformation déviatorique de fluage irréversible, composante 6"),
    "BR_EFI33": _("BETON_RAG : déformation déviatorique de fluage irréversible, composante 3"),
    "BR_EFISP": _("BETON_RAG : déformation sphérique de fluage irréversible"),
    ...
    "BR_PRCAP": _("BETON_RAG : Pression capillaire"),
    ...
    "BR_EFEQI": _("BETON_RAG : déformation équivalente de fluage irréversible"),
    # "COHESION": _("cohésion"),
    "COMMAX": _(
    ...
    "ENDOMOIN": _("JONC_ENDO_PLAS : endmmagement en flexion négative, variable interne 8"),
    ...
    "EPCUM": ("déformation plastique cumulée"),
    ...
    "PORO_NUC": _("Porosité liée à la germination de microcavités"),
    "POROSITE": _("Porosité"),
    ...
    "SAUT_VISC_N": _("saut normal visqueux"),
    ...
    "SAUT_PLAS_T1": _("saut tangentiel plastique 1"),
    "SAUT_VISC_T1": _("saut tangentiel visqueux 1"),
    "SAUT_T2": _("saut tangentiel 2"),
    "SAUT_PLAS_T2": _("saut tangentiel plastique 2"),
    "SAUT_VISC_T2": _("saut tangentiel visqueux 2"),
    "SAUTEQUI": _("saut equivalent total"),
    "SAUTINIT": _("seuil d'initiation de l'endommagement"),
    ...
    "SIXX": _("Contrainte issue du comportement"),
    "SIYY": _("Contrainte issue du comportement"),
    "SIZZ": _("Contrainte issue du comportement"),
    "SIXY": _("Contrainte issue du comportement"),
    "SIXZ": _("Contrainte issue du comportement"),
    "SIYZ": _("Contrainte issue du comportement"),
    ...
    "VARIENDO": _("CZM  variable d'endommagement scalaire"),
    "VARSEUIL": _("CZM  variable seuil correspondant au plus grand saut équivalent de déplacement"),
    ...
    "VIT_ENDO": ("GTN: taux d'endommagement"),
    ...
    "EPSEQ1": _("RGI_BETON_BA Déformation plastique Renforcement 1"),
    "SNR1": _("RGI_BETON_BA Contrainte axiale Renforcement 1"),
    "ERM1": _("RGI_BETON_BA Déformation de Maxwell Renforcement 1"),
    "MUR1": _("RGI_BETON_BA Taux de chargement maximal Renforcement 1"),
    "ERK1": _("RGI_BETON_BA Déformation de Kelvin Renforcement 1"),
    "SPR1": _("RGI_BETON_BA Déformation de Kelvin Renforcement 1"),
    "EPSIN2": _("RGI_BETON_BA Déformation axiale Renforcement 2"),
    "EPSEQ2": _("RGI_BETON_BA Déformation plastique Renforcement 2"),
    "SNR2": _("RGI_BETON_BA Contrainte axiale Renforcement 2"),
    "ERM2": _("RGI_BETON_BA Déformation de Maxwell Renforcement 2"),
    "MUR2": _("RGI_BETON_BA Taux de chargement maximal Renforcement 2"),
    "ERK2": _("RGI_BETON_BA Déformation de Kelvin Renforcement 2"),
    "SPR2": _("RGI_BETON_BA Déformation de Kelvin Renforcement 2"),
    "EPSIN3": _("RGI_BETON_BA Déformation axiale Renforcement 3"),
    "EPSEQ3": _("RGI_BETON_BA Déformation plastique Renforcement 3"),
    "SNR3": _("RGI_BETON_BA Contrainte axiale Renforcement 3"),
    "ERM3": _("RGI_BETON_BA Déformation de Maxwell Renforcement 3"),
    "MUR3": _("RGI_BETON_BA Taux de chargement maximal Renforcement 3"),
    "ERK3": _("RGI_BETON_BA Déformation de Kelvin Renforcement 3"),
    "SPR3": _("RGI_BETON_BA Déformation de Kelvin Renforcement 3"),
    "EPSIN4": _("RGI_BETON_BA Déformation axiale Renforcement 4"),
    "EPSEQ4": _("RGI_BETON_BA Déformation plastique Renforcement 4"),
    "SNR4": _("RGI_BETON_BA Contrainte axiale Renforcement 4"),
    "ERM4": _("RGI_BETON_BA Déformation de Maxwell Renforcement 4"),
    "MUR4": _("RGI_BETON_BA Taux de chargement maximal Renforcement 4"),
    "ERK4": _("RGI_BETON_BA Déformation de Kelvin Renforcement 4"),
    "SPR4": _("RGI_BETON_BA Déformation de Kelvin Renforcement 4"),
    "EPSIN5": _("RGI_BETON_BA Déformation axiale Renforcement 5"),
    "EPSEQ5": _("RGI_BETON_BA Déformation plastique Renforcement 5"),
    "SNR5": _("RGI_BETON_BA Contrainte axiale Renforcement 5"),
    "ERM5": _("RGI_BETON_BA Déformation de Maxwell Renforcement 5"),
    "MUR5": _("RGI_BETON_BA Taux de chargement maximal Renforcement 5"),
    "ERK5": _("RGI_BETON_BA Déformation de Kelvin Renforcement 5"),
    "SPR5": _("RGI_BETON_BA Déformation de Kelvin Renforcement 5"),
    "SBE1": _("RGI_BETON_BA Contrainte dans la matrice seule"),
    "SBE2": _("RGI_BETON_BA Contrainte dans la matrice seule"),
    "SBE3": _("RGI_BETON_BA Contrainte dans la matrice seule"),
    "SBE4": _("RGI_BETON_BA Contrainte dans la matrice seule"),
    "SBE5": _("RGI_BETON_BA Contrainte dans la matrice seule"),
    "SBE6": _("RGI_BETON_BA Contrainte dans la matrice seule"),
    "SPM1": _("RGI_BETON_BA Contrainte béton princpale majeure"),
    "SPM2": _("RGI_BETON_BA Contrainte béton princpale intermédiaire"),
    "SPM3": _("RGI_BETON_BA Contrainte béton princpale mineure"),
}
