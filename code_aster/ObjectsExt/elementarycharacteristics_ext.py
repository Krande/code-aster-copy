...
"""
:py:class:`ElementaryCharacteristics` --- Assignment of elementary characteristics
**********************************************************************************
"""

import aster
from libaster import ElementaryCharacteristics

from ..Utilities import injector


@injector(ElementaryCharacteristics)
class ExtendedElementaryCharacteristics:
