...
from ..Objects import GcpcSolver, LdltSolver, MultFrontSolver, MumpsSolver, PetscSolver, getGlossary
...
def create_solver(solver_keyword):
    ...
    if not solver_type:
        return None
    solver = solver_type()
    solver.setKeywords(solver_keyword)
    return solver
