...
void DEFPPPPPPPP( SLU_FACTORIZE, slu_factorize, ASTERINTEGER4 *m, ASTERINTEGER4 *n,
                  ASTERINTEGER4 *nnz, ASTERDOUBLE *values, ASTERINTEGER4 *rowind,
                  ASTERINTEGER4 *colptr, fptr *f_factors, ASTERINTEGER4 *info ) {
    SuperMatrix A, AC, B;
    SuperMatrix *L, *U;
    ...
    dCreate_CompCol_Matrix( &A, *m, *n, *nnz, values, rowind0, colptr0, SLU_NC, SLU_D, SLU_GE );
    ...
    dgstrf( &options, &AC, relax, panel_size, etree, NULL, 0, perm_c, perm_r, L, U, &Glu, &stat,
            info );
