...
#define FUNC_CPECH(NAME) void DEF_P_PPPPSPSP(*NAME, \
        ASTERINTEGER *, ASTERINTEGER4*, ASTERFLOAT*, ASTERINTEGER4*, \
...
#define FUNC_CPLCH(NAME) void DEF_P_PPPPPSPPSP(*NAME, \
        ASTERINTEGER *, ASTERINTEGER4*, ASTERFLOAT*, ASTERFLOAT*, ASTERINTEGER4*, \
...
void DEFPPPPSPSP(CPECH,cpech,
        ASTERINTEGER *icompo, ASTERINTEGER4 *cpiter, ASTERFLOAT *tf, ASTERINTEGER4 *numpas,
...
void DEFPPPPPSPPSP(CPLCH,cplch,
        ASTERINTEGER *icompo, ASTERINTEGER4 *cpiter, ASTERFLOAT *ti,
        ASTERFLOAT *tf, ASTERINTEGER4 *numpas,
