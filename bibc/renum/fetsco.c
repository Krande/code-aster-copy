...
void DEFPPPPPPPPPP( FETSCO, fetsco, ASTERINTEGER *nbmato, ASTERINTEGER *nblien,
                    ASTERINTEGER4 *connect, ASTERINTEGER4 *idconnect, ASTERINTEGER *nbpart,
                    ASTERINTEGER4 *mapsd, ASTERINTEGER4 *edlo, ASTERINTEGER4 *velo,
    ...
    if ( err == 0 )
        err = SCOTCH_graphBuild( &grafdat, 1, (int)*nbmato, (const SCOTCH_Num *const)idconnect,
                                 NULL, (const SCOTCH_Num *const)velo, NULL, (int)*nblien,
